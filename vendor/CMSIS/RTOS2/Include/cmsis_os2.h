...
/// information.
/// \param[out]    id_buf        pointer to buffer for retrieving kernel
/// identification string.
/// \param[in]     id_size       size of buffer for kernel identification
/// string.
/// \return status code that indicates the execution status of the function.
...
/// osTimerPeriodic for periodic behavior.
...
/// \param[in]     mq_id         message queue ID obtained by \ref
/// osMessageQueueNew.
/// \param[in]     msg_ptr       pointer to buffer with message to put into a
/// queue.
...
/// \param[in]     mq_id         message queue ID obtained by \ref
/// osMessageQueueNew.
/// \param[out]    msg_ptr       pointer to buffer for message to get from a
/// queue.
