 ...
 * CFFT is calculated
 * \par
 * The parameter <code>bitReverseFlag</code> controls whether output is in
 * normal order or bit reversed order. Set(=1) bitReverseFlag for output to be
 * in normal order otherwise output is in bit reversed order.
 * \par
