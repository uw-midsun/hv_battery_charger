...
#define __NVIC_PRIO_BITS \
  4U /*!< STM32F398xx devices use 4 Bits for the Priority Levels */
...
/**
 * @brief STM32F398xx devices Interrupt Number Definition, according to the
...
typedef struct {
  ...
  __IO uint32_t CFGR4; /*!< SYSCFG configuration register 4, Address offset:
                          0x48 */
...
#define IS_TIM_CC3_INSTANCE(INSTANCE)                                      \
  (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || \
   ((INSTANCE) == TIM4) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM20))
