...
#define __NVIC_PRIO_BITS \
  4U /*!< STM32F302xE devices use 4 Bits for the Priority Levels */
...
/**
 * @brief STM32F302xE devices Interrupt Number Definition, according to the
...
typedef enum {
  ...
  COMP1_2_IRQn =
      64, /*!< COMP1 and COMP2 global Interrupt via EXTI Line21 and 22 */
  COMP4_6_IRQn =
...
#define FMC_PATTx_ATTSETx                                                     \
  FMC_PATTx_ATTSETx_Msk /*!<ATTSETx[7:0] bits (Attribute memory x setup time) \
                         */
...
#define FMC_PATTx_ATTWAITx                                                     \
  FMC_PATTx_ATTWAITx_Msk /*!<ATTWAITx[7:0] bits (Attribute memory x wait time) \
                          */
...
#define FMC_PATTx_ATTHOLDx                                                     \
  FMC_PATTx_ATTHOLDx_Msk /*!<ATTHOLDx[7:0] bits (Attribute memory x hold time) \
                          */
...
#define FMC_PATTx_ATTHIZx                                                     \
  FMC_PATTx_ATTHIZx_Msk /*!<ATTHIZx[7:0] bits (Attribute memory x databus HiZ \
                           time) */
...
#define FMC_PATT2_ATTSET2                                                     \
  FMC_PATT2_ATTSET2_Msk /*!<ATTSET2[7:0] bits (Attribute memory 2 setup time) \
                         */
...
#define FMC_PATT2_ATTWAIT2                                                     \
  FMC_PATT2_ATTWAIT2_Msk /*!<ATTWAIT2[7:0] bits (Attribute memory 2 wait time) \
                          */
...
#define FMC_PATT2_ATTHOLD2                                                     \
  FMC_PATT2_ATTHOLD2_Msk /*!<ATTHOLD2[7:0] bits (Attribute memory 2 hold time) \
                          */
...
#define FMC_PATT2_ATTHIZ2                                                     \
  FMC_PATT2_ATTHIZ2_Msk /*!<ATTHIZ2[7:0] bits (Attribute memory 2 databus HiZ \
                           time) */
...
#define FMC_PATT3_ATTSET3                                                     \
  FMC_PATT3_ATTSET3_Msk /*!<ATTSET3[7:0] bits (Attribute memory 3 setup time) \
                         */
...
#define FMC_PATT3_ATTWAIT3                                                     \
  FMC_PATT3_ATTWAIT3_Msk /*!<ATTWAIT3[7:0] bits (Attribute memory 3 wait time) \
                          */
...
#define FMC_PATT3_ATTHOLD3                                                     \
  FMC_PATT3_ATTHOLD3_Msk /*!<ATTHOLD3[7:0] bits (Attribute memory 3 hold time) \
                          */
...
#define FMC_PATT3_ATTHIZ3                                                     \
  FMC_PATT3_ATTHIZ3_Msk /*!<ATTHIZ3[7:0] bits (Attribute memory 3 databus HiZ \
                           time) */
...
#define FMC_PATT4_ATTSET4                                                     \
  FMC_PATT4_ATTSET4_Msk /*!<ATTSET4[7:0] bits (Attribute memory 4 setup time) \
                         */
...
#define FMC_PATT4_ATTWAIT4                                                     \
  FMC_PATT4_ATTWAIT4_Msk /*!<ATTWAIT4[7:0] bits (Attribute memory 4 wait time) \
                          */
...
#define FMC_PATT4_ATTHOLD4                                                     \
  FMC_PATT4_ATTHOLD4_Msk /*!<ATTHOLD4[7:0] bits (Attribute memory 4 hold time) \
                          */
...
#define FMC_PATT4_ATTHIZ4                                                     \
  FMC_PATT4_ATTHIZ4_Msk /*!<ATTHIZ4[7:0] bits (Attribute memory 4 databus HiZ \
                           time) */
...
#define RCC_AHBENR_GPIOHEN_Msk \
  (0x1UL << RCC_AHBENR_GPIOHEN_Pos)               /*!< 0x00010000 */
...
#define RCC_AHBENR_GPIOGEN_Msk \
  (0x1UL << RCC_AHBENR_GPIOGEN_Pos)               /*!< 0x00800000 */
...
#define SYSCFG_CFGR1_DMA_RMP_Msk \
  (0x39UL << SYSCFG_CFGR1_DMA_RMP_Pos)                /*!< 0x00003900 */
...
#define IS_COMP_ALL_INSTANCE(INSTANCE)                                        \
  (((INSTANCE) == COMP1) || ((INSTANCE) == COMP2) || ((INSTANCE) == COMP4) || \
   ((INSTANCE) == COMP6))
...
#define IS_TIM_INSTANCE(INSTANCE)                                           \
  (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) ||  \
   ((INSTANCE) == TIM4) || ((INSTANCE) == TIM6) || ((INSTANCE) == TIM15) || \
