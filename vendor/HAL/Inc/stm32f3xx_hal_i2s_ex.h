...
#define I2SxEXT(__INSTANCE__)                               \
  ((__INSTANCE__) == (SPI2) ? (SPI_TypeDef *)(I2S2ext_BASE) \
...
/** @brief  Checks if the specified I2SExt interrupt source is enabled or
 * disabled.
 * @param  __HANDLE__ specifies the I2S Handle.
...
/** @addtogroup I2SEx_Exported_Functions_Group1 I2S Extended IO operation
 * functions
 * @{
 */
