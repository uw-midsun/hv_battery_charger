...
#define LL_SYSCFG_REMAP_FMC \
  SYSCFG_CFGR1_MEM_MODE_2 /*<! FMC Bank (Only the first two banks) */
#endif                    /* FMC_BANK1 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_SYSCFG_SPI1RX_RMP_DMA1_CH2    \
  (SYSCFG_CFGR3_SPI1_RX_DMA_RMP << 16U | \
   (uint32_t)0x00000000U) /*!< SPI1_RX mapped on DMA1 CH2 */
#define LL_SYSCFG_SPI1RX_RMP_DMA1_CH4    \
  (SYSCFG_CFGR3_SPI1_RX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_SPI1_RX_DMA_RMP_0) /*!< SPI1_RX mapped on DMA1 CH4 */
#define LL_SYSCFG_SPI1RX_RMP_DMA1_CH6    \
  (SYSCFG_CFGR3_SPI1_RX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_SPI1_RX_DMA_RMP_1) /*!< SPI1_RX mapped on DMA1 CH6 */
#define LL_SYSCFG_SPI1TX_RMP_DMA1_CH3    \
  (SYSCFG_CFGR3_SPI1_TX_DMA_RMP << 16U | \
   (uint32_t)0x00000000U) /*!< SPI1_TX mapped on DMA1 CH3 */
#define LL_SYSCFG_SPI1TX_RMP_DMA1_CH5    \
  (SYSCFG_CFGR3_SPI1_TX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_SPI1_TX_DMA_RMP_0) /*!< SPI1_TX mapped on DMA1 CH5 */
#define LL_SYSCFG_SPI1TX_RMP_DMA1_CH7    \
  (SYSCFG_CFGR3_SPI1_TX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_SPI1_TX_DMA_RMP_1) /*!< SPI1_TX mapped on DMA1 CH7 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_SYSCFG_I2C1RX_RMP_DMA1_CH7    \
  (SYSCFG_CFGR3_I2C1_RX_DMA_RMP << 16U | \
   (uint32_t)0x00000000U) /*!< I2C1_RX mapped on DMA1 CH7 */
#define LL_SYSCFG_I2C1RX_RMP_DMA1_CH3    \
  (SYSCFG_CFGR3_I2C1_RX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_I2C1_RX_DMA_RMP_0) /*!< I2C1_RX mapped on DMA1 CH3 */
#define LL_SYSCFG_I2C1RX_RMP_DMA1_CH5    \
  (SYSCFG_CFGR3_I2C1_RX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_I2C1_RX_DMA_RMP_1) /*!< I2C1_RX mapped on DMA1 CH5 */
#define LL_SYSCFG_I2C1TX_RMP_DMA1_CH6    \
  (SYSCFG_CFGR3_I2C1_TX_DMA_RMP << 16U | \
   (uint32_t)0x00000000U) /*!< I2C1_TX mapped on DMA1 CH6 */
#define LL_SYSCFG_I2C1TX_RMP_DMA1_CH2    \
  (SYSCFG_CFGR3_I2C1_TX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_I2C1_TX_DMA_RMP_0) /*!< I2C1_TX mapped on DMA1 CH2 */
#define LL_SYSCFG_I2C1TX_RMP_DMA1_CH4    \
  (SYSCFG_CFGR3_I2C1_TX_DMA_RMP << 16U | \
   SYSCFG_CFGR3_I2C1_TX_DMA_RMP_1) /*!< I2C1_TX mapped on DMA1 CH4 */
/**
 * @}
 */
...
#define LL_SYSCFG_ADC24_RMP_DMA2_CH12                                       \
  (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_ADC24_DMA_RMP << 8U |          \
   (uint32_t)0x00000000U) /*!< ADC24 DMA requests mapped on DMA2 channels 1 \
                             and 2 */
#define LL_SYSCFG_ADC24_RMP_DMA2_CH34                                          \
  (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_ADC24_DMA_RMP << 8U |             \
   SYSCFG_CFGR1_ADC24_DMA_RMP) /*!< ADC24 DMA requests mapped on DMA2 channels \
                                  3 and 4 */
#endif                         /*SYSCFG_CFGR1_ADC24_DMA_RMP*/
#if defined(SYSCFG_CFGR3_ADC2_DMA_RMP)
#define LL_SYSCFG_ADC2_RMP_DMA1_CH2                                 \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_ADC2_DMA_RMP_0 << 8U | \
   (uint32_t)0x00000000U) /*!< ADC2 mapped on DMA1 channel 2 */
#define LL_SYSCFG_ADC2_RMP_DMA1_CH4                                 \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_ADC2_DMA_RMP_0 << 8U | \
   SYSCFG_CFGR3_ADC2_DMA_RMP_0) /*!< ADC2 mapped on DMA1 channel 4 */
#define LL_SYSCFG_ADC2_RMP_DMA2                                     \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_ADC2_DMA_RMP_1 << 8U | \
   (uint32_t)0x00000000U) /*!< ADC2 mapped on DMA2 */
#define LL_SYSCFG_ADC2_RMP_DMA1                                     \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_ADC2_DMA_RMP_1 << 8U | \
   SYSCFG_CFGR3_ADC2_DMA_RMP_1) /*!< ADC2 mapped on DMA1 */
 ...
 * @{
 */
#define LL_SYSCFG_DAC1_CH1_RMP_DMA2_CH3                                      \
  ((SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP << 8U) |                                \
   (uint32_t)0x00000000U) /*!< DAC_CH1 DMA requests mapped on DMA2 channel 3 \
                           */
#define LL_SYSCFG_DAC1_CH1_RMP_DMA1_CH3                                       \
  ((SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP << 8U) |                                 \
   SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP) /*!< DAC_CH1 DMA requests mapped on DMA1 \
                                        channel 3 */
#if defined(SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP)
#define LL_SYSCFG_DAC1_OUT2_RMP_DMA2_CH4                                       \
  ((SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP << 8U) |                                  \
   (uint32_t)0x00000000U) /*!< DAC1_OUT2 DMA requests mapped on DMA2 channel 4 \
                           */
#define LL_SYSCFG_DAC1_OUT2_RMP_DMA1_CH4                                   \
  ((SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP << 8U) |                              \
   SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP) /*!< DAC1_OUT2 DMA requests mapped on \
                                        DMA1 channel 4 */
#endif                               /*SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP*/
#if defined(SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP)
#define LL_SYSCFG_DAC2_OUT1_RMP_DMA2_CH5                                       \
  ((SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP << 8U) |                                 \
   (uint32_t)0x00000000U) /*!< DAC2_OUT1 DMA requests mapped on DMA2 channel 5 \
                           */
#define LL_SYSCFG_DAC2_OUT1_RMP_DMA1_CH5                                    \
  ((SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP << 8U) |                              \
   SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP) /*!< DAC2_OUT1 DMA requests mapped on \
                                         DMA1 channel 5 */
#endif                                /*SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP*/
#if defined(SYSCFG_CFGR1_DAC2Ch1_DMA_RMP)
#define LL_SYSCFG_DAC2_CH1_RMP_NO         \
  ((SYSCFG_CFGR1_DAC2Ch1_DMA_RMP << 8U) | \
   (uint32_t)0x00000000U) /*!< No remap */
#define LL_SYSCFG_DAC2_CH1_RMP_DMA1_CH5                                    \
  ((SYSCFG_CFGR1_DAC2Ch1_DMA_RMP << 8U) |                                  \
   SYSCFG_CFGR1_DAC2Ch1_DMA_RMP) /*!< DAC2_CH1 DMA requests mapped on DMA1 \
                                    channel 5 */
...
#define LL_SYSCFG_TIM16_RMP_DMA1_CH3                                         \
  ((SYSCFG_CFGR1_TIM16_DMA_RMP << 8U) |                                      \
   (uint32_t)0x00000000U) /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on \
                             DMA1 channel 3 */
#define LL_SYSCFG_TIM16_RMP_DMA1_CH6                                           \
  ((SYSCFG_CFGR1_TIM16_DMA_RMP << 8U) |                                        \
   SYSCFG_CFGR1_TIM16_DMA_RMP) /*!< TIM16_CH1 and TIM16_UP DMA requests mapped \
                                  on DMA1 channel 6 */
#define LL_SYSCFG_TIM17_RMP_DMA1_CH1                                         \
  ((SYSCFG_CFGR1_TIM17_DMA_RMP << 8U) |                                      \
   (uint32_t)0x00000000U) /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on \
                             DMA1 channel 1 */
#define LL_SYSCFG_TIM17_RMP_DMA1_CH7                                           \
  ((SYSCFG_CFGR1_TIM17_DMA_RMP << 8U) |                                        \
   SYSCFG_CFGR1_TIM17_DMA_RMP) /*!< TIM17_CH1 and TIM17_UP DMA requests mapped \
                                  on DMA1 channel 7 */
#define LL_SYSCFG_TIM6_RMP_DMA2_CH3           \
  ((SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP << 8U) | \
   (uint32_t)0x00000000U) /*!< TIM6 DMA requests mapped on DMA2 channel 3 */
#define LL_SYSCFG_TIM6_RMP_DMA1_CH3                                        \
  ((SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP << 8U) |                              \
   SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP) /*!< TIM6 DMA requests mapped on DMA1 \
                                        channel 3 */
#if defined(SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP)
#define LL_SYSCFG_TIM7_RMP_DMA2_CH4           \
  ((SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP << 8U) | \
   (uint32_t)0x00000000U) /*!< TIM7 DMA requests mapped on DMA2 channel 4 */
#define LL_SYSCFG_TIM7_RMP_DMA1_CH4                                        \
  ((SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP << 8U) |                              \
   SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP) /*!< TIM7 DMA requests mapped on DMA1 \
                                        channel 4 */
#endif                               /*SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP*/
#if defined(SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP)
#define LL_SYSCFG_TIM18_RMP_DMA2_CH5           \
  ((SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP << 8U) | \
   (uint32_t)0x00000000U) /*!< TIM18 DMA requests mapped on DMA2 channel 5 */
#define LL_SYSCFG_TIM18_RMP_DMA1_CH5                                         \
  ((SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP << 8U) |                               \
   SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP) /*!< TIM18 DMA requests mapped on DMA1 \
                                         channel 5 */
#endif                                /*SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP*/
/**
 * @}
...
#define LL_SYSCFG_TIM1_ITR3_RMP_TIM4_TRGO \
  ((SYSCFG_CFGR1_TIM1_ITR3_RMP << 8U) |   \
   (uint32_t)0x00000000U) /*!< TIM1_ITR3 = TIM4_TRGO */
#define LL_SYSCFG_TIM1_ITR3_RMP_TIM17_OC \
  ((SYSCFG_CFGR1_TIM1_ITR3_RMP << 8U) |  \
   SYSCFG_CFGR1_TIM1_ITR3_RMP) /*!< TIM1_ITR3 = TIM17_OC */
#endif                         /* SYSCFG_CFGR1_TIM1_ITR3_RMP */
#if defined(SYSCFG_CFGR1_ENCODER_MODE)
#define LL_SYSCFG_TIM15_ENCODEMODE_NOREDIRECTION \
  ((SYSCFG_CFGR1_ENCODER_MODE << 8U) |           \
   (uint32_t)0x00000000U) /*!< No redirection */
#define LL_SYSCFG_TIM15_ENCODEMODE_TIM2                                     \
  ((SYSCFG_CFGR1_ENCODER_MODE_0 << 8U) |                                    \
   SYSCFG_CFGR1_ENCODER_MODE_0) /*!< TIM2 IC1 and TIM2 IC2 are connected to \
                                   TIM15 IC1 and TIM15 IC2 respectively */
#if defined(SYSCFG_CFGR1_ENCODER_MODE_TIM3)
#define LL_SYSCFG_TIM15_ENCODEMODE_TIM3                                        \
  ((SYSCFG_CFGR1_ENCODER_MODE_TIM3 << 8U) |                                    \
   SYSCFG_CFGR1_ENCODER_MODE_TIM3) /*!< TIM3 IC1 and TIM3 IC2 are connected to \
                                      TIM15 IC1 and TIM15 IC2 respectively */
#endif                             /* SYSCFG_CFGR1_ENCODER_MODE_TIM3 */
#if defined(SYSCFG_CFGR1_ENCODER_MODE_TIM4)
#define LL_SYSCFG_TIM15_ENCODEMODE_TIM4                                        \
  ((SYSCFG_CFGR1_ENCODER_MODE_TIM4 << 8U) |                                    \
   SYSCFG_CFGR1_ENCODER_MODE_TIM4) /*!< TIM4 IC1 and TIM4 IC2 are connected to \
                                      TIM15 IC1 and TIM15 IC2 respectively */
 ...
 * @{
 */
#define LL_SYSCFG_ADC12_EXT2_RMP_TIM1_CC3                             \
  ((SYSCFG_CFGR4_ADC12_EXT2_RMP << 16U) |                             \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             EXT2:Trigger source is TIM1_CC3 */
#define LL_SYSCFG_ADC12_EXT2_RMP_TIM20_TRGO                                 \
  ((SYSCFG_CFGR4_ADC12_EXT2_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_EXT2_RMP) /*!< Input trigger of ADC12 regular channel \
                                   EXT2:Trigger source is TIM20_TRGO */
#define LL_SYSCFG_ADC12_EXT3_RMP_TIM2_CC2                             \
  ((SYSCFG_CFGR4_ADC12_EXT3_RMP << 16U) |                             \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             EXT3:Trigger source is TIM2_CC2 */
#define LL_SYSCFG_ADC12_EXT3_RMP_TIM20_TRGO2                                \
  ((SYSCFG_CFGR4_ADC12_EXT3_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_EXT3_RMP) /*!< Input trigger of ADC12 regular channel \
                                   EXT3:Trigger source is TIM20_TRGO2 */
#define LL_SYSCFG_ADC12_EXT5_RMP_TIM4_CC4                             \
  ((SYSCFG_CFGR4_ADC12_EXT5_RMP << 16U) |                             \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             EXT5:Trigger source is TIM4_CC4 */
#define LL_SYSCFG_ADC12_EXT5_RMP_TIM20_CC1                                  \
  ((SYSCFG_CFGR4_ADC12_EXT5_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_EXT5_RMP) /*!< Input trigger of ADC12 regular channel \
                                   EXT5:Trigger source is TIM20_CC1 */
#define LL_SYSCFG_ADC12_EXT13_RMP_TIM6_TRGO                           \
  ((SYSCFG_CFGR4_ADC12_EXT13_RMP << 16U) |                            \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             EXT13:Trigger source is TIM6_TRGO */
#define LL_SYSCFG_ADC12_EXT13_RMP_TIM20_CC2                                  \
  ((SYSCFG_CFGR4_ADC12_EXT13_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_EXT13_RMP) /*!< Input trigger of ADC12 regular channel \
                                    EXT13:Trigger source is TIM20_CC2 */
#define LL_SYSCFG_ADC12_EXT15_RMP_TIM3_CC4                            \
  ((SYSCFG_CFGR4_ADC12_EXT15_RMP << 16U) |                            \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             EXT15:Trigger source is TIM3_CC4 */
#define LL_SYSCFG_ADC12_EXT15_RMP_TIM20_CC3                                  \
  ((SYSCFG_CFGR4_ADC12_EXT15_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_EXT15_RMP) /*!< Input trigger of ADC12 regular channel \
                                    EXT15:Trigger source is TIM20_CC3 */
#define LL_SYSCFG_ADC12_JEXT3_RMP_TIM2_CC1                            \
  ((SYSCFG_CFGR4_ADC12_JEXT3_RMP << 16U) |                            \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             JEXT3:Trigger source is TIM2_CC1 */
#define LL_SYSCFG_ADC12_JEXT3_RMP_TIM20_TRGO                                 \
  ((SYSCFG_CFGR4_ADC12_JEXT3_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_JEXT3_RMP) /*!< Input trigger of ADC12 regular channel \
                                    JEXT3:Trigger source is TIM20_TRGO */
#define LL_SYSCFG_ADC12_JEXT6_RMP_EXTI_LINE_15                        \
  ((SYSCFG_CFGR4_ADC12_JEXT6_RMP << 16U) |                            \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             JEXT6:Trigger source is EXTI_LINE_15 */
#define LL_SYSCFG_ADC12_JEXT6_RMP_TIM20_TRGO2                                \
  ((SYSCFG_CFGR4_ADC12_JEXT6_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_JEXT6_RMP) /*!< Input trigger of ADC12 regular channel \
                                    JEXT6:Trigger source is TIM20_TRGO2 */
#define LL_SYSCFG_ADC12_JEXT13_RMP_TIM3_CC1                           \
  ((SYSCFG_CFGR4_ADC12_JEXT13_RMP << 16U) |                           \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC12 regular channel \
                             JEXT13:Trigger source is TIM3_CC1 */
#define LL_SYSCFG_ADC12_JEXT13_RMP_TIM20_CC4                                  \
  ((SYSCFG_CFGR4_ADC12_JEXT13_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC12_JEXT13_RMP) /*!< Input trigger of ADC12 regular channel \
                                     JEXT13:Trigger source is TIM20_CC4 */
#define LL_SYSCFG_ADC34_EXT5_RMP_EXTI_LINE_2                          \
  ((SYSCFG_CFGR4_ADC34_EXT5_RMP << 16U) |                             \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC34 regular channel \
                             EXT5:Trigger source is EXTI_LINE_2 */
#define LL_SYSCFG_ADC34_EXT5_RMP_TIM20_TRGO                                 \
  ((SYSCFG_CFGR4_ADC34_EXT5_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC34_EXT5_RMP) /*!< Input trigger of ADC34 regular channel \
                                   EXT5:Trigger source is TIM20_TRGO */
#define LL_SYSCFG_ADC34_EXT6_RMP_TIM4_CC1                             \
  ((SYSCFG_CFGR4_ADC34_EXT6_RMP << 16U) |                             \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC34 regular channel \
                             EXT6:Trigger source is TIM4_CC1 */
#define LL_SYSCFG_ADC34_EXT6_RMP_TIM20_TRGO2                                \
  ((SYSCFG_CFGR4_ADC34_EXT6_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC34_EXT6_RMP) /*!< Input trigger of ADC34 regular channel \
                                   EXT6:Trigger source is TIM20_TRGO2 */
#define LL_SYSCFG_ADC34_EXT15_RMP_TIM2_CC1                            \
  ((SYSCFG_CFGR4_ADC34_EXT15_RMP << 16U) |                            \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC34 regular channel \
                             EXT15:Trigger source is  TIM2_CC1 */
#define LL_SYSCFG_ADC34_EXT15_RMP_TIM20_CC1                                  \
  ((SYSCFG_CFGR4_ADC34_EXT15_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC34_EXT15_RMP) /*!< Input trigger of ADC34 regular channel \
                                    EXT15:Trigger source is TIM20_CC1 */
#define LL_SYSCFG_ADC34_JEXT5_RMP_TIM4_CC3                            \
  ((SYSCFG_CFGR4_ADC34_JEXT5_RMP << 16U) |                            \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC34 regular channel \
                             JEXT5:Trigger source is TIM4_CC3 */
#define LL_SYSCFG_ADC34_JEXT5_RMP_TIM20_TRGO                                 \
  ((SYSCFG_CFGR4_ADC34_JEXT5_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC34_JEXT5_RMP) /*!< Input trigger of ADC34 regular channel \
                                    JEXT5:Trigger source is TIM20_TRGO */
#define LL_SYSCFG_ADC34_JEXT11_RMP_TIM1_CC3                           \
  ((SYSCFG_CFGR4_ADC34_JEXT11_RMP << 16U) |                           \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC34 regular channel \
                             JEXT11:Trigger source is TIM1_CC3 */
#define LL_SYSCFG_ADC34_JEXT11_RMP_TIM20_TRGO2                                \
  ((SYSCFG_CFGR4_ADC34_JEXT11_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC34_JEXT11_RMP) /*!< Input trigger of ADC34 regular channel \
                                     JEXT11:Trigger source is TIM20_TRGO2 */
#define LL_SYSCFG_ADC34_JEXT14_RMP_TIM7_TRGO                          \
  ((SYSCFG_CFGR4_ADC34_JEXT14_RMP << 16U) |                           \
   (uint32_t)0x00000000U) /*!< Input trigger of ADC34 regular channel \
                             JEXT14:Trigger source is TIM7_TRGO */
#define LL_SYSCFG_ADC34_JEXT14_RMP_TIM20_CC2                                  \
  ((SYSCFG_CFGR4_ADC34_JEXT14_RMP << 16U) |                                   \
   SYSCFG_CFGR4_ADC34_JEXT14_RMP) /*!< Input trigger of ADC34 regular channel \
                                     JEXT14:Trigger source is TIM20_CC2 */
/**
 * @}
 */
...
#define LL_SYSCFG_DAC1_TRIG1_RMP_TIM8_TRGO                         \
  (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_DAC1_TRIG1_RMP << 4 | \
   (uint32_t)0x00000000U) /*!< No remap: DAC trigger TRIG1 is TIM8_TRGO */
#define LL_SYSCFG_DAC1_TRIG1_RMP_TIM3_TRGO                         \
  (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_DAC1_TRIG1_RMP << 4 | \
   SYSCFG_CFGR1_DAC1_TRIG1_RMP) /*!< DAC trigger is TIM3_TRGO */
#endif                          /* SYSCFG_CFGR1_DAC1_TRIG1_RMP */
#if defined(SYSCFG_CFGR3_DAC1_TRG3_RMP)
#define LL_SYSCFG_DAC1_TRIG3_RMP_TIM15_TRGO                       \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG3_RMP << 4 | \
   (uint32_t)0x00000000U) /*!< DAC trigger is TIM15_TRGO */
#define LL_SYSCFG_DAC1_TRIG3_RMP_HRTIM1_DAC1_TRIG1                \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG3_RMP << 4 | \
   SYSCFG_CFGR3_DAC1_TRG3_RMP) /*!< DAC trigger is HRTIM1_DAC1_TRIG1 */
#endif                         /* SYSCFG_CFGR3_DAC1_TRG3_RMP */
#if defined(SYSCFG_CFGR3_DAC1_TRG5_RMP)
#define LL_SYSCFG_DAC1_TRIG5_RMP_NO                               \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG5_RMP << 4 | \
   (uint32_t)0x00000000U) /*!<  No remap  */
#define LL_SYSCFG_DAC1_TRIG5_RMP_HRTIM1_DAC1_TRIG2                \
  (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG5_RMP << 4 | \
   SYSCFG_CFGR3_DAC1_TRG5_RMP) /*!< DAC trigger is HRTIM1_DAC1_TRIG2 */
...
#define LL_SYSCFG_TIMBREAK_PVD                                               \
  SYSCFG_CFGR2_PVD_LOCK /*!< Enables and locks the PVD connection with TIMx  \
...
#define LL_SYSCFG_TIMBREAK_SRAM_PARITY                                       \
  SYSCFG_CFGR2_SRAM_PARITY_LOCK /*!< Enables and locks the SRAM_PARITY error \
                                   signal with Break Input of TIMx */
#endif                          /* SYSCFG_CFGR2_SRAM_PARITY_LOCK */
#define LL_SYSCFG_TIMBREAK_LOCKUP                                        \
  SYSCFG_CFGR2_LOCKUP_LOCK /*!< Enables and locks the LOCKUP (Hardfault) \
                              output of CortexM0 with Break Input of TIMx */
/**
 * @}
 */
...
#define LL_DBGMCU_APB1_GRP1_TIM18_STOP                                         \
  DBGMCU_APB1_FZ_DBG_TIM18_STOP /*!< TIM18 counter stopped when core is halted \
                                 */
...
#define LL_DBGMCU_APB2_GRP1_TIM19_STOP                                         \
  DBGMCU_APB2_FZ_DBG_TIM19_STOP /*!< TIM19 counter stopped when core is halted \
                                 */
#endif                          /*DBGMCU_APB2_FZ_DBG_TIM19_STOP*/
#if defined(DBGMCU_APB2_FZ_DBG_TIM20_STOP)
#define LL_DBGMCU_APB2_GRP1_TIM20_STOP                                         \
  DBGMCU_APB2_FZ_DBG_TIM20_STOP /*!< TIM20 counter stopped when core is halted \
                                 */
#endif                          /*DBGMCU_APB2_FZ_DBG_TIM20_STOP*/
#if defined(DBGMCU_APB2_FZ_DBG_HRTIM1_STOP)
#define LL_DBGMCU_APB2_GRP1_HRTIM1_STOP                                   \
  DBGMCU_APB2_FZ_DBG_HRTIM1_STOP /*!< HRTIM1 counter stopped when core is \
                                    halted */
...
__STATIC_INLINE void LL_SYSCFG_SetRemapDMA_ADC(uint32_t Remap) {
  __IO uint32_t *reg =
      (__IO uint32_t *)(uint32_t)(SYSCFG_BASE + (Remap >> 24U));
 ...
 *         @arg @ref LL_SYSCFG_TIM16_RMP_DMA1_CH3 or @ref
 * LL_SYSCFG_TIM16_RMP_DMA1_CH6
 *         @arg @ref LL_SYSCFG_TIM17_RMP_DMA1_CH1 or @ref
 * LL_SYSCFG_TIM17_RMP_DMA1_CH7
 *         @arg @ref LL_SYSCFG_TIM6_RMP_DMA2_CH3 or @ref
 * LL_SYSCFG_TIM6_RMP_DMA1_CH3
 *         @arg @ref LL_SYSCFG_TIM7_RMP_DMA2_CH4 or @ref
 * LL_SYSCFG_TIM7_RMP_DMA1_CH4 (*)
 *         @arg @ref LL_SYSCFG_TIM18_RMP_DMA2_CH5 or @ref
...
__STATIC_INLINE void LL_SYSCFG_SetRemapTrigger_ADC(uint32_t Remap) {
  MODIFY_REG(SYSCFG->CFGR4, (Remap & 0xFFFF0000U) >> 16U,
             (Remap & 0x0000FFFFU));
}
#endif /* SYSCFG_CFGR4_ADC12_EXT2_RMP */
 ...
 * @note  Remap the USB interrupts (USB_HP, USB_LP and USB_WKUP) on interrupt
...
/**
 * @brief  Enable VBAT monitoring (to enable the power switch to deliver VBAT
 * voltage on ADC channel 18 input)
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsActiveFlag_SP(void) {
  return (READ_BIT(SYSCFG->CFGR2, SYSCFG_CFGR2_SRAM_PE) ==
 ...
 * @note For STM32F303xC, STM32F358xx and STM32F302xC devices, the device ID is
 * 0x422
 * @note For STM32F373xx and STM32F378xx devices, the device ID is 0x432
 * @note For STM32F303x8, STM32F334xx and STM32F328xx devices, the device ID is
 * 0x438.
 * @note For STM32F302x8, STM32F301x8 and STM32F318xx devices, the device ID is
 * 0x439
 * @note For STM32F303xE, STM32F398xx and STM32F302xE devices, the device ID is
 * 0x446
 ...
 * DBG_CAN_STOP  LL_DBGMCU_APB1_GRP1_FreezePeriph
 ...
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n APB1_FZ      DBG_I2C3_SMBUS_TIMEOUT
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n APB1_FZ      DBG_CAN_STOP
 * LL_DBGMCU_APB1_GRP1_UnFreezePeriph
 * @param  Periphs This parameter can be a combination of the following values:
 *         @arg @ref LL_DBGMCU_APB1_GRP1_TIM2_STOP
 *         @arg @ref LL_DBGMCU_APB1_GRP1_TIM3_STOP (*)
