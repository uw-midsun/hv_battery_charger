...
#define LL_TIM_DMABURST_BASEADDR_OR                                     \
  (TIM_DCR_DBA_4 | TIM_DCR_DBA_2) /*!< TIMx_OR register is the DMA base \
                                     address for DMA burst */
...
#define LL_TIM_TIM1_ETR_ADC1_RMP_AWD3      \
  (TIM1_OR_ETR_RMP_0 | TIM1_OR_ETR_RMP_1 | \
 ...
 * @{
 */
#define LL_TIM_TIM1_ETR_ADC4_RMP_NC \
  TIM1_OR_RMP_MASK /*!< TIM1_ETR is not connected to ADC4 analog watchdog  x*/
#define LL_TIM_TIM1_ETR_ADC4_RMP_AWD1 \
  (TIM1_OR_ETR_RMP_2 |                \
   TIM1_OR_RMP_MASK) /*!< TIM1_ETR is connected to ADC4 analog watchdog 1 */
#define LL_TIM_TIM1_ETR_ADC4_RMP_AWD2 \
  (TIM1_OR_ETR_RMP_3 |                \
   TIM1_OR_RMP_MASK) /*!< TIM1_ETR is connected to ADC4 analog watchdog 2 */
#define LL_TIM_TIM1_ETR_ADC4_RMP_AWD3      \
  (TIM1_OR_ETR_RMP_3 | TIM1_OR_ETR_RMP_2 | \
   TIM1_OR_RMP_MASK) /*!< TIM1_ETR is connected to ADC4 analog watchdog 3 */
/**
 * @}
 */
#else
 ...
 * @{
 */
#define LL_TIM_TIM1_ETR_ADC2_RMP_NC \
  TIM1_OR_RMP_MASK /*!< TIM1_ETR is not connected to ADC2 analog watchdog  x*/
#define LL_TIM_TIM1_ETR_ADC2_RMP_AWD1 \
  (TIM1_OR_ETR_RMP_2 |                \
   TIM1_OR_RMP_MASK) /*!< TIM1_ETR is connected to ADC2 analog watchdog 1 */
#define LL_TIM_TIM1_ETR_ADC2_RMP_AWD2 \
  (TIM1_OR_ETR_RMP_3 |                \
   TIM1_OR_RMP_MASK) /*!< TIM1_ETR is connected to ADC2 analog watchdog 2 */
#define LL_TIM_TIM1_ETR_ADC2_RMP_AWD3      \
  (TIM1_OR_ETR_RMP_3 | TIM1_OR_ETR_RMP_2 | \
   TIM1_OR_RMP_MASK) /*!< TIM1_ETR is connected to ADC2 analog watchdog 3 */
/**
 * @}
 */
#endif               /* ADC4 */
...
#define LL_TIM_TIM8_ETR_ADC2_RMP_NC \
  TIM8_OR_RMP_MASK /*!< TIM8_ETR is not connected to ADC2 analog watchdog x */
#define LL_TIM_TIM8_ETR_ADC2_RMP_AWD1 \
  (TIM8_OR_ETR_RMP_0 |                \
   TIM8_OR_RMP_MASK) /*!< TIM8_ETR is connected to ADC2 analog watchdog */
#define LL_TIM_TIM8_ETR_ADC2_RMP_AWD2 \
  (TIM8_OR_ETR_RMP_1 |                \
   TIM8_OR_RMP_MASK) /*!< TIM8_ETR is connected to ADC2 analog watchdog 2 */
#define LL_TIM_TIM8_ETR_ADC2_RMP_AWD3      \
  (TIM8_OR_ETR_RMP_0 | TIM8_OR_ETR_RMP_1 | \
   TIM8_OR_RMP_MASK) /*!< TIM8_ETR is connected to ADC2 analog watchdog 3 */
/**
 * @}
 */
...
#define LL_TIM_TIM8_ETR_ADC3_RMP_NC \
  TIM8_OR_RMP_MASK /*!< TIM8_ETR is not connected to ADC3 analog watchdog x */
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD1 \
  (TIM8_OR_ETR_RMP_2 |                \
   TIM8_OR_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog 1 */
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD2 \
  (TIM8_OR_ETR_RMP_3 |                \
   TIM8_OR_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog 2 */
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD3      \
  (TIM8_OR_ETR_RMP_2 | TIM8_OR_ETR_RMP_3 | \
   TIM8_OR_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog 3 */
/**
 * @}
 */
#endif /* TIM8 */
...
#define LL_TIM_TIM16_TI1_RMP_GPIO \
  0x00000000U /*!< TIM16 input capture 1 is connected to GPIO */
#define LL_TIM_TIM16_TI1_RMP_RTC                                            \
  (TIM16_OR_TI1_RMP_0 |                                                     \
   TIM16_OR_RMP_MASK) /*!< TIM16 input capture 1 is connected to RTC wakeup \
                         interrupt */
#define LL_TIM_TIM16_TI1_RMP_HSE_32                                      \
  (TIM16_OR_TI1_RMP_1 | TIM16_OR_RMP_MASK) /*!< TIM16 input capture 1 is \
                                              connected to HSE/32 clock */
#define LL_TIM_TIM16_TI1_RMP_MCO             \
  (TIM16_OR_TI1_RMP_1 | TIM16_OR_TI1_RMP_0 | \
   TIM16_OR_RMP_MASK) /*!< TIM16 input capture 1 is connected to MCO */
/**
 * @}
 */
#endif /* TIM16 */
 ...
 * @{
 */
#define LL_TIM_TIM20_ETR_ADC3_RMP_NC                                          \
  TIM20_OR_RMP_MASK /*!< TIM20_ETR is not connected to ADC3 analog watchdog x \
                     */
#define LL_TIM_TIM20_ETR_ADC3_RMP_AWD1 \
  (TIM20_OR_ETR_RMP_0 |                \
   TIM20_OR_RMP_MASK) /*!< TIM20_ETR is connected to ADC3 analog watchdog */
#define LL_TIM_TIM20_ETR_ADC3_RMP_AWD2 \
  (TIM20_OR_ETR_RMP_1 |                \
   TIM20_OR_RMP_MASK) /*!< TIM20_ETR is connected to ADC3 analog watchdog 2 */
#define LL_TIM_TIM20_ETR_ADC3_RMP_AWD3       \
  (TIM20_OR_ETR_RMP_0 | TIM20_OR_ETR_RMP_1 | \
   TIM20_OR_RMP_MASK) /*!< TIM20_ETR is connected to ADC3 analog watchdog 3 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_TIM_TIM20_ETR_ADC4_RMP_NC                                          \
  TIM20_OR_RMP_MASK /*!< TIM20_ETR is not connected to ADC4 analog watchdog x \
                     */
#define LL_TIM_TIM20_ETR_ADC4_RMP_AWD1 \
  (TIM20_OR_ETR_RMP_2 |                \
   TIM20_OR_RMP_MASK) /*!< TIM20_ETR is connected to ADC4 analog watchdog 1 */
#define LL_TIM_TIM20_ETR_ADC4_RMP_AWD2 \
  (TIM20_OR_ETR_RMP_3 |                \
   TIM20_OR_RMP_MASK) /*!< TIM20_ETR is connected to ADC4 analog watchdog 2 */
#define LL_TIM_TIM20_ETR_ADC4_RMP_AWD3       \
  (TIM20_OR_ETR_RMP_2 | TIM20_OR_ETR_RMP_3 | \
   TIM20_OR_RMP_MASK) /*!< TIM20_ETR is connected to ADC4 analog watchdog 3 */
/**
 * @}
 */
#endif /* TIM20 */
...
#define LL_TIM_TIM14_TI1_RMP_GPIO \
  TIM14_OR_RMP_MASK /*!< TIM14_TI1 is connected to GPIO */
#define LL_TIM_TIM14_TI1_RMP_RTC_CLK \
  (TIM14_OR_TI1_RMP_0 |              \
   TIM14_OR_RMP_MASK) /*!< TIM14_TI1 is connected to RTC Clock */
#define LL_TIM_TIM14_TI1_RMP_HSE \
  (TIM14_OR_TI1_RMP_1 |          \
   TIM14_OR_RMP_MASK) /*!< TIM14_TI1 is connected to HSE/32 */
 ...
 * except for STM32F373xC and STM32F378xx devices.
