...
#define DAC_CR_CH1_BITOFFSET                                                \
  0U /* Position of channel bits into registers CR, MCR, CCR, SHHR, SHRR of \
        channel 1 */
#define DAC_CR_CH2_BITOFFSET                                                 \
  16U /* Position of channel bits into registers CR, MCR, CCR, SHHR, SHRR of \
         channel 2 */
#define DAC_CR_CHX_BITOFFSET_MASK (DAC_CR_CH1_BITOFFSET | DAC_CR_CH2_BITOFFSET)

#define DAC_SWTR_CH1                                                        \
  (DAC_SWTRIGR_SWTRIG1) /* Channel bit into register SWTRIGR of channel 1.  \
                           This bit is into area of LL_DAC_CR_CHx_BITOFFSET \
                           but excluded by mask DAC_CR_CHX_BITOFFSET_MASK   \
                           (done to be enable to trig SW start of both DAC  \
...
#define DAC_REG_DOR2_REGOFFSET                                           \
  0x10000000U /* Register offset of DORx channel 1 versus DORx channel 2 \
...
typedef struct {
  uint32_t
      TriggerSource; /*!< Set the conversion trigger source for the selected DAC
                        channel: internal (SW start) or from external IP (timer
  ...
  uint32_t
      WaveAutoGenerationConfig; /*!< Set the waveform automatic generation mode
                                   ...
                                   LL_DAC_SetWaveNoiseLFSR() or @ref
                                   LL_DAC_SetWaveTriangleAmplitude(), depending
                                   on the wave automatic generation selected. */
...
#define LL_DAC_TRIG_EXT_TIM3_TRGO                                              \
  (DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP: TIM3  \
                      TRGO. Trigger remap: by default, default trigger. If     \
                      needed to restore trigger, use @ref                      \
                      LL_SYSCFG_DAC1_TRIG1_REMAP_TIM3_TRGO for TIM3 selection. \
                    */
#define LL_DAC_TRIG_EXT_TIM7_TRGO                                             \
  (DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from external IP: TIM7 \
                      TRGO. */
#define LL_DAC_TRIG_EXT_TIM15_TRGO                                           \
  (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from \
                                       external IP: TIM5 TRGO. */
#define LL_DAC_TRIG_EXT_TIM2_TRGO                                             \
  (DAC_CR_TSEL1_2) /*!< DAC channel conversion trigger from external IP: TIM2 \
                      TRGO. */
#define LL_DAC_TRIG_EXT_TIM4_TRGO                                            \
  (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from \
                                       external IP: TIM4 TRGO. */
#define LL_DAC_TRIG_EXT_TIM8_TRGO                                              \
  (LL_DAC_TRIG_EXT_TIM3_TRGO) /*!< DAC channel conversion trigger from         \
                                 external IP: TIM8 TRGO. Trigger remap: use    \
                                 @ref LL_SYSCFG_DAC1_TRIG1_REMAP_TIM8_TRGO for \
                                 TIM8 selection. */
...
#define LL_DAC_TRIG_EXT_TIM4_TRGO                                            \
  (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from \
                                       external IP: TIM4 TRGO. */
#define LL_DAC_TRIG_EXT_TIM18_TRGO                                     \
  (LL_DAC_TRIG_EXT_TIM5_TRGO) /*!< DAC channel conversion trigger from \
                                 external IP: TIM18 TRGO. */
#define LL_DAC_TRIG_EXT_EXTI_LINE9                                       \
  (DAC_CR_TSEL1_2 |                                                      \
   DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from external IP: \
                      external interrupt line 9. */
...
#define LL_DAC_TRIG_EXT_TIM15_TRGO                                             \
  (DAC_CR_TSEL1_1 |                                                            \
   DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP: TIM15 \
                      TRGO. Trigger remap: by default, default trigger. If     \
                      needed to restore trigger, use @ref                      \
                      LL_SYSCFG_DAC1_TRIG3_REMAP_TIM15_TRGO for TIM15          \
                      selection. */
#define LL_DAC_TRIGGER_HRTIM1_DACTRG1                                          \
  (LL_DAC_TRIG_EXT_TIM15_TRGO) /*!< DAC channel conversion trigger from        \
                                  external IP: HRTIM1 DACTRG1. Available only  \
                                  on DAC instance: DAC1. Trigger remap: use    \
                                  @ref                                         \
                                  LL_SYSCFG_DAC1_TRIG3_REMAP_HRTIM1_DAC1_TRIG1 \
                                  for HRTIM1 TRIG1 selection. */
#define LL_DAC_TRIGGER_HRTIM1_DACTRG2                                         \
  (DAC_CR_TSEL1_2 |                                                           \
   DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP:      \
                      HRTIM1 DACTRG2. Available only on DAC instance: DAC2.   \
                      Trigger remap: use @ref                                 \
                      LL_SYSCFG_DAC1_TRIG5_REMAP_HRTIM1_DAC1_TRIG2 for HRTIM1 \
                      TRIG2 selection. */
#define LL_DAC_TRIGGER_HRTIM1_DACTRG3                                      \
  (LL_DAC_TRIGGER_HRTIM1_DACTRG2) /*!< DAC channel conversion trigger from \
                                     external IP: HRTIM1 DACTRG3. */
#define LL_DAC_TRIG_EXT_EXTI_LINE9                                       \
  (DAC_CR_TSEL1_2 |                                                      \
   DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from external IP: \
                      external interrupt line 9. */
...
#define LL_DAC_TRIANGLE_AMPLITUDE_1                                           \
  0x00000000U /*!< Triangle wave generation, amplitude of 1 LSB of DAC output \
...
#define LL_DAC_OUTPUT_BUFFER_DISABLE                                         \
  (DAC_CR_BOFF1) /*!< The selected DAC channel output is not buffered: lower \
                    drive current capability, but also lower current         \
                    consumption */

#if defined(DAC_CR_OUTEN1) || defined(DAC_CR_OUTEN2)
#define LL_DAC_OUTPUT_SWITCH_DISABLE                                           \
  (LL_DAC_OUTPUT_BUFFER_ENABLE) /*!< Feature specific to STM32F303x6/8 and     \
                                   STM32F328: On DAC1 channel 2, output buffer \
                                   is replaced by a switch to connect DAC      \
                                   channel output to pin PA5. On DAC2 channel  \
                                   1, output buffer is replaced by a switch to \
                                   connect DAC channel output to pin PA6.      \
                                   Selection of switch disabled: DAC channel   \
                                   output not connected to GPIO. */
#define LL_DAC_OUTPUT_SWITCH_ENABLE                                           \
  (LL_DAC_OUTPUT_BUFFER_DISABLE) /*!< Feature specific to STM32F303x6/8 and   \
                                    STM32F328: On DAC1 channel 2, output      \
                                    buffer is replaced by a switch to connect \
                                    DAC channel output to pin PA5. On DAC2    \
                                    channel 1, output buffer is replaced by a \
                                    switch to connect DAC channel output to   \
                                    pin PA6. */
#endif
/**
 * @}
...
#define LL_DAC_DMA_REG_DATA_12BITS_RIGHT_ALIGNED                           \
  DAC_REG_DHR12RX_REGOFFSET_MASK /*!< DAC channel data holding register 12 \
                                    bits right aligned */
#define LL_DAC_DMA_REG_DATA_12BITS_LEFT_ALIGNED                            \
  DAC_REG_DHR12LX_REGOFFSET_MASK /*!< DAC channel data holding register 12 \
                                    bits left aligned */
#define LL_DAC_DMA_REG_DATA_8BITS_RIGHT_ALIGNED                               \
  DAC_REG_DHR8RX_REGOFFSET_MASK /*!< DAC channel data holding register 8 bits \
                                   right aligned */
/**
 * @}
 */
...
#define LL_DAC_DELAY_STARTUP_VOLTAGE_SETTLING_US                        \
  15U /*!< Delay for DAC channel voltage settling time from DAC channel \
 ...
 * @param  __DECIMAL_NB__ 1...2 (value "2" depending on DAC channel 2
 * availability)
 ...
 *         (2) On STM32F3, parameter not available on all DAC instances: DAC1
 * (for DAC instances DACx available on the selected device).\n (3) On STM32F3,
 * parameter not available on all DAC instances: DAC2 (for DAC instances DACx
...
__STATIC_INLINE uint32_t LL_DAC_DMA_GetRegAddr(DAC_TypeDef *DACx,
  ...
  return ((uint32_t)(__DAC_PTR_REG_OFFSET(
      (DACx)->DHR12R1, __DAC_MASK_SHIFT(DAC_Channel, Register))));
}
/**
 * @}
 */
...
__STATIC_INLINE uint32_t LL_DAC_RetrieveOutputData(DAC_TypeDef *DACx,
                                                   uint32_t DAC_Channel) {
  __IO uint32_t *preg = __DAC_PTR_REG_OFFSET(
      DACx->DOR1, __DAC_MASK_SHIFT(DAC_Channel, DAC_REG_DORX_REGOFFSET_MASK));
