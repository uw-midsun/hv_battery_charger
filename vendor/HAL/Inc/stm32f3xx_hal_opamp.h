...
typedef struct {
  ...
  uint32_t
      InvertingInput; /*!< Specifies the inverting input in Standalone & Pga
                         modes
                             - In Standalone mode:   i.e when mode is
                         OPAMP_STANDALONE_MODE This parameter must be a value of
                         @ref OPAMP_InvertingInput InvertingInput is either VM0
                         or VM1
                             - In PGA mode:          i.e when mode is
                         OPAMP_PGA_MODE & in Follower mode    i.e when mode is
  ...
  uint32_t NonInvertingInput; /*!< Specifies the non inverting input of the
                                 ...
                                 either VP0, VP1, VP2 or VP3 */

  uint32_t
      TimerControlledMuxmode; /*!< Specifies if the Timer controlled Mux mode is
                                 enabled or disabled This parameter must be a
                                 value of @ref OPAMP_TimerControlledMuxmode */

  uint32_t
      InvertingInputSecondary; /*!< Specifies the inverting input (secondary) of
                                  the opamp when TimerControlledMuxmode is
                                  enabled i.e. when TimerControlledMuxmode is
                                  OPAMP_TIMERCONTROLLEDMUXMODE_ENABLE
                                      - In Standalone mode:   i.e when mode is
                                  OPAMP_STANDALONE_MODE This parameter must be a
                                  value of @ref OPAMP_InvertingInputSecondary
                                        InvertingInputSecondary is either VM0 or
                                  VM1
                                      - In PGA mode:          i.e when mode is
                                  OPAMP_PGA_MODE & in Follower mode    i.e when
                                  mode is OPAMP_FOLLOWER_MODE This parameter is
                                  Not Applicable */

  uint32_t NonInvertingInputSecondary; /*!< Specifies the non inverting input
                                          ...
                                          @ref OPAMP_NonInvertingInputSecondary
                                            NonInvertingInput is either VP0,
                                          VP1, VP2 or VP3 */

  uint32_t
      PgaConnect; /*!< Specifies the inverting pin in PGA mode
...
typedef enum {
  ...
  HAL_OPAMP_STATE_BUSYLOCKED =
      0x00000005U, /*!< OPAMP is locked
                       only system reset allows reconfiguring the opamp. */

} HAL_OPAMP_StateTypeDef;

/**
 * @brief OPAMP Handle Structure definition to @brief  OPAMP Handle Structure
 * definition
 */
...
#define OPAMP_CSR_UPDATE_PARAMETERS_INIT_MASK                                 \
  (OPAMP_CSR_TRIMOFFSETN | OPAMP_CSR_TRIMOFFSETP | OPAMP_CSR_USERTRIM |       \
   OPAMP_CSR_PGGAIN | OPAMP_CSR_VPSSEL | OPAMP_CSR_VMSSEL | OPAMP_CSR_TCMEN | \
   OPAMP_CSR_VPSEL | OPAMP_CSR_VMSEL | OPAMP_CSR_FORCEVP)
...
#define OPAMP_NONINVERTINGINPUT_IO0                                           \
  OPAMP_CSR_VPSEL /*!< VP0 (PA1 for OPAMP1, VP0 PA7  for OPAMP2, VP0 PB0  for \
                     OPAMP3, VP0 PB13 for OPAMP4) connected to OPAMPx non                                                      \
                     inverting input */
#define OPAMP_NONINVERTINGINPUT_IO1                                         \
  (0x00000000U) /*!< VP1 (PA7 for OPAMP1, VP3 PD14 for OPAMP2, VP1 PB13 for \
                   OPAMP3, VP1 PD11 for OPAMP4) connected to OPAMPx non                                                    \
                   inverting input */
#define OPAMP_NONINVERTINGINPUT_IO2 \
  OPAMP_CSR_VPSEL_1 /*!< VP2 (PA3 for OPAMP1, VP2 PB0  for OPAMP2, VP2 PA1 for                                \
                       OPAMP3, VP3 PA4  for OPAMP4) connected to OPAMPx non            \
                       inverting input */
#define OPAMP_NONINVERTINGINPUT_IO3 \
  OPAMP_CSR_VPSEL_0 /*!< VP3 (PA5 for OPAMP1, VP1 PB14 for OPAMP2, VP3 PA5 for                                \
                       OPAMP3, VP2 PB11 for OPAMP4) connected to OPAMPx non            \
                       inverting input */
...
#define OPAMP_INVERTINGINPUT_IO0 \
  (0x00000000U) /*!< inverting input connected to VM0 */
#define OPAMP_INVERTINGINPUT_IO1 \
  OPAMP_CSR_VMSEL_0 /*!< inverting input connected to VM1 */
...
#define OPAMP_TIMERCONTROLLEDMUXMODE_DISABLE \
  (0x00000000U) /*!< Timer controlled Mux mode disabled */
#define OPAMP_TIMERCONTROLLEDMUXMODE_ENABLE \
  OPAMP_CSR_TCMEN /*!< Timer controlled Mux mode enabled */
...
#define OPAMP_SEC_NONINVERTINGINPUT_IO0                                      \
  OPAMP_CSR_VPSSEL /*!< VP0 (PA1 for OPAMP1, PA7 for OPAMP2, PB0 for OPAMP3, \
                      PB13 for OPAMP4) connected to OPAMPx non inverting input                                     \
                    */
#define OPAMP_SEC_NONINVERTINGINPUT_IO1                                     \
  (0x00000000U) /*!< VP1 (PA7 for OPAMP1, PD14 for OPAMP2, PB13 for OPAMP3, \
                   PD11 for OPAMP4) connected to OPAMPx non inverting input */
#define OPAMP_SEC_NONINVERTINGINPUT_IO2                                        \
  OPAMP_CSR_VPSSEL_1 /*!< VP2 (PA3 for OPAMP1, PB0 for OPAMP2, PA1 for OPAMP3, \
                        PA4 for OPAMP4) connected to OPAMPx non inverting                                             \
                        input */
#define OPAMP_SEC_NONINVERTINGINPUT_IO3                                 \
  OPAMP_CSR_VPSSEL_0 /*!< VP3 (PA5 for OPAMP1, PB14 for OPAMP2, PA5 for \
                        OPAMP3, PB11 for OPAMP4) connected to OPAMPx non                                                \
                        inverting input */
...
#define OPAMP_SEC_INVERTINGINPUT_IO0                                     \
  (0x00000000U) /*!< VM0 (PC5 for OPAMP1 and OPAMP2, PB10 for OPAMP3 and \
                   OPAMP4) connected to OPAMPx inverting input */
#define OPAMP_SEC_INVERTINGINPUT_IO1                                         \
  OPAMP_CSR_VMSSEL /*!< VM1 (PA3 for OPAMP1, PA5 for OPAMP2, PB2 for OPAMP3, \
...
#define OPAMP_PGA_CONNECT_INVERTINGINPUT_IO0                                   \
  OPAMP_CSR_PGGAIN_3 /*!< In PGA mode, the non inverting input is connected to \
                        VM0 */
#define OPAMP_PGA_CONNECT_INVERTINGINPUT_IO1                                  \
  (OPAMP_CSR_PGGAIN_2 |                                                       \
   OPAMP_CSR_PGGAIN_3) /*!< In PGA mode, the non inverting input is connected \
                          to VM1 */
...
#define OPAMP_PGA_GAIN_16 \
  (OPAMP_CSR_PGGAIN_0 | OPAMP_CSR_PGGAIN_1) /*!< PGA gain = 16 */

#define IS_OPAMP_PGA_GAIN(GAIN)                                    \
  (((GAIN) == OPAMP_PGA_GAIN_2) || ((GAIN) == OPAMP_PGA_GAIN_4) || \
   ((GAIN) == OPAMP_PGA_GAIN_8) || ((GAIN) == OPAMP_PGA_GAIN_16))
/**
 * @}
 */
...
#define OPAMP_VREF_NOTCONNECTEDTO_ADC \
  (0x00000000U) /*!< VREF not connected to ADC */
#define OPAMP_VREF_CONNECTEDTO_ADC \
  (0x00000001U) /*!< VREF not connected to ADC */
