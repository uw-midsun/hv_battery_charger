...
typedef struct {
  ...
  uint32_t NonInvertingInput; /*!< Selects the non inverting input of the
                                 comparator. This parameter can be a value of
                                 @ref COMPEx_NonInvertingInput Note: Only
                                 available on STM32F302xB/xC, STM32F303xB/xC and
                                 STM32F358xx devices */
  ...
  uint32_t
      Hysteresis; /*!< Selects the hysteresis voltage of the comparator.
                       This parameter can be a value of @ref COMPEx_Hysteresis
                       Note: Only available on STM32F302xB/xC, STM32F303xB/xC,
                     STM32F373xB/xC, STM32F358xx and STM32F378xx devices */

  uint32_t BlankingSrce; /*!< Selects the output blanking source of the
                            comparator. This parameter can be a value of @ref
                            COMPEx_BlankingSrce Note: Not available on
                            STM32F373xB/C and STM32F378xx devices */
  ...
  uint32_t Mode; /*!< Selects the operating consumption mode of the comparator
                      ...
                      Note: Not available on STM32F301x6/x8, STM32F302x6/x8,
                    STM32F334x6/x8, STM32F318xx and STM32F328xx devices */

  uint32_t WindowMode; /*!< Selects the window mode of the comparator X (X=2U, 4
                          or 6 if available). This parameter can be a value of
                          @ref COMPEx_WindowMode */

  uint32_t TriggerMode; /*!< Selects the trigger mode of the comparator
                           (interrupt mode). This parameter can be a value of
                           @ref COMP_TriggerMode */
...
typedef enum {
  ...
  HAL_COMP_STATE_READY_LOCKED =
      0x11U, /*!< COMP initialized but the configuration is locked */
  HAL_COMP_STATE_BUSY = 0x02U, /*!< COMP is running */
  HAL_COMP_STATE_BUSY_LOCKED =
      0x12 /*!< COMP is running and the configuration is locked  */
...
#define COMP_OUTPUTPOL_NONINVERTED \
  (0x00000000U) /*!< COMP output on GPIO isn't inverted */
#define COMP_OUTPUTPOL_INVERTED \
  COMP_CSR_COMPxPOL /*!< COMP output on GPIO is inverted  */
/**
 * @}
 */
...
#define COMP_TRIGGERMODE_NONE \
  (0x00000000U) /*!< No External Interrupt trigger detection */
#define COMP_TRIGGERMODE_IT_RISING                                    \
  (0x00000001U) /*!< External Interrupt Mode with Rising edge trigger \
                   detection */
#define COMP_TRIGGERMODE_IT_FALLING                                    \
  (0x00000002U) /*!< External Interrupt Mode with Falling edge trigger \
                   detection */
#define COMP_TRIGGERMODE_IT_RISING_FALLING                                    \
  (0x00000003U) /*!< External Interrupt Mode with Rising/Falling edge trigger \
                   detection */
#define COMP_TRIGGERMODE_EVENT_RISING \
  (0x00000010U) /*!< Event Mode with Rising edge trigger detection */
#define COMP_TRIGGERMODE_EVENT_FALLING \
  (0x00000020U) /*!< Event Mode with Falling edge trigger detection */
#define COMP_TRIGGERMODE_EVENT_RISING_FALLING \
  (0x00000030U) /*!< Event Mode with Rising/Falling edge trigger detection */
/**
 * @}
 */
