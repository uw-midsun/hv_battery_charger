 ...
 */
#define RTC_IT_TAMP \
  RTC_TAFCR_TAMPIE /*!< Enable global Tamper Interrupt           */
/**
 * @}
 */
...
/** @defgroup RTCEx_Tamper_Pin_Precharge_Duration_Definitions RTCEx Tamper Pin
...
#define RTC_TAMPER_PULLUP_DISABLE \
  RTC_TAFCR_TAMPPUDIS /*!< Tamper pins are not pre-charged before sampling */
#define RTC_TAMPER_PULLUP_MASK \
  RTC_TAFCR_TAMPPUDIS /*!< Masking all bits except bit TAMPPUDIS           */
/**
 * @}
 */
...
#define RTC_TIMESTAMPONTAMPERDETECTION_ENABLE \
  RTC_TAFCR_TAMPTS /*!< TimeStamp on Tamper Detection event saved        */
...
#define RTC_TIMESTAMPONTAMPERDETECTION_MASK \
  RTC_TAFCR_TAMPTS /*!< Masking all bits except bit TAMPTS               */
/**
 * @}
 */
 ...
 * @param  __HANDLE__ specifies the RTC handle.
 * @param  __INTERRUPT__ specifies the RTC Wakeup Timer interrupt sources to be
...
/**
 * @brief  Check whether the specified RTC Wakeup Timer interrupt has occurred
 * or not.
 * @param  __HANDLE__ specifies the RTC handle.
...
/**
 * @brief  Check whether the specified RTC Wakeup timer interrupt has been
 * enabled or not.
 * @param  __HANDLE__ specifies the RTC handle.
 * @param  __INTERRUPT__ specifies the RTC Wakeup timer interrupt sources to
...
/**
 * @brief  Check whether the specified RTC Timestamp interrupt has been enabled
 * or not.
 * @param  __HANDLE__ specifies the RTC handle.
...
#define __HAL_RTC_TAMPER3_ENABLE(__HANDLE__) \
  ((__HANDLE__)->Instance->TAFCR |= (RTC_TAFCR_TAMP3E))
...
#define RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT                                \
  EXTI_IMR_MR19 /*!< External interrupt line 19 Connected to the RTC Tamper \
                   and Timestamp event */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT                                     \
  EXTI_IMR_MR20 /*!< External interrupt line 20 Connected to the RTC Wakeup \
                   event */
/**
 * @}
 */
...
#define RTC_TAMPER_FLAGS_MASK \
  ((uint32_t)(RTC_FLAG_TAMP1F | RTC_FLAG_TAMP2F | RTC_FLAG_TAMP3F))
...
#define IS_RTC_TAMPER(TAMPER)                                          \
  ((((TAMPER) & ((uint32_t)~RTC_TAMPER_ENABLE_BITS_MASK)) == 0x00U) && \
   ((TAMPER) != 0U))
