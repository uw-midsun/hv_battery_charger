...
typedef struct {
  ...
  uint32_t DAC_OutputBuffer; /*!< Specifies whether the DAC channel output
                             buffer is enabled or disabled. This parameter can
                             be a value of @ref DAC_output_buffer For a given
                             DAC channel, is this parameter applies then
                             DAC_OutputSwitch does not apply */

  uint32_t DAC_OutputSwitch; /*!< Specifies whether the DAC channel output
                             switch is enabled or disabled. This parameter can
                             be a value of @ref DAC_OutputSwitch For a given DAC
                             channel, is this parameter applies then
                             DAC_OutputBuffer does not apply */
...
#define DAC_LFSRUNMASK_BITS1_0                                               \
  ((uint32_t)DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[1:0] for noise \
                                wave generation */
#define DAC_LFSRUNMASK_BITS2_0                                               \
  ((uint32_t)DAC_CR_MAMP1_1) /*!< Unmask DAC channel LFSR bit[2:0] for noise \
                                wave generation */
#define DAC_LFSRUNMASK_BITS3_0                                          \
  ((uint32_t)DAC_CR_MAMP1_1 |                                           \
   DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[3:0] for noise wave \
                      generation */
#define DAC_LFSRUNMASK_BITS4_0                                               \
  ((uint32_t)DAC_CR_MAMP1_2) /*!< Unmask DAC channel LFSR bit[4:0] for noise \
                                wave generation */
#define DAC_LFSRUNMASK_BITS5_0                                          \
  ((uint32_t)DAC_CR_MAMP1_2 |                                           \
   DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[5:0] for noise wave \
                      generation */
#define DAC_LFSRUNMASK_BITS6_0                                          \
  ((uint32_t)DAC_CR_MAMP1_2 |                                           \
   DAC_CR_MAMP1_1) /*!< Unmask DAC channel LFSR bit[6:0] for noise wave \
                      generation */
...
#define DAC_LFSRUNMASK_BITS8_0                                               \
  ((uint32_t)DAC_CR_MAMP1_3) /*!< Unmask DAC channel LFSR bit[8:0] for noise \
                                wave generation */
#define DAC_LFSRUNMASK_BITS9_0                                          \
  ((uint32_t)DAC_CR_MAMP1_3 |                                           \
   DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[9:0] for noise wave \
                      generation */
#define DAC_LFSRUNMASK_BITS10_0                                          \
  ((uint32_t)DAC_CR_MAMP1_3 |                                            \
   DAC_CR_MAMP1_1) /*!< Unmask DAC channel LFSR bit[10:0] for noise wave \
                      generation */
...
#define DAC_TRIANGLEAMPLITUDE_1 \
  (0x00000000U) /*!< Select max triangle amplitude of 1U */
#define DAC_TRIANGLEAMPLITUDE_3 \
  ((uint32_t)DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 3U */
#define DAC_TRIANGLEAMPLITUDE_7 \
  ((uint32_t)DAC_CR_MAMP1_1) /*!< Select max triangle amplitude of 7U */
#define DAC_TRIANGLEAMPLITUDE_15 \
  ((uint32_t)DAC_CR_MAMP1_1 |    \
   DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 15U */
#define DAC_TRIANGLEAMPLITUDE_31 \
  ((uint32_t)DAC_CR_MAMP1_2) /*!< Select max triangle amplitude of 31U */
#define DAC_TRIANGLEAMPLITUDE_63 \
  ((uint32_t)DAC_CR_MAMP1_2 |    \
   DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 63U */
#define DAC_TRIANGLEAMPLITUDE_127 \
  ((uint32_t)DAC_CR_MAMP1_2 |     \
   DAC_CR_MAMP1_1) /*!< Select max triangle amplitude of 127U */
#define DAC_TRIANGLEAMPLITUDE_255              \
  ((uint32_t)DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 | \
   DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 255U */
#define DAC_TRIANGLEAMPLITUDE_511 \
  ((uint32_t)DAC_CR_MAMP1_3) /*!< Select max triangle amplitude of 511U */
#define DAC_TRIANGLEAMPLITUDE_1023 \
  ((uint32_t)DAC_CR_MAMP1_3 |      \
   DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 1023U */
#define DAC_TRIANGLEAMPLITUDE_2047 \
  ((uint32_t)DAC_CR_MAMP1_3 |      \
   DAC_CR_MAMP1_1) /*!< Select max triangle amplitude of 2047U */
#define DAC_TRIANGLEAMPLITUDE_4095             \
  ((uint32_t)DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 | \
   DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 4095U */
