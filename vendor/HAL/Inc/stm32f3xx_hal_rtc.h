...
typedef struct {
  ...
  uint32_t
      SecondFraction; /*!< Specifies the range or granularity of Sub Second
                         register content corresponding to Synchronous prescaler
                         factor value (PREDIV_S) This parameter corresponds to a
                         time unit range between [0-1] Second with [1 Sec /
                         SecondFraction +1] granularity. This field will be used
                         only by HAL_RTC_GetTime function */
...
#define RTC_FLAG_TAMP3F \
  RTC_ISR_TAMP3F /*!< Tamper 3 event flag                      */
#endif           /* RTC_TAMPER3_SUPPORT */
#define RTC_FLAG_TAMP2F \
  RTC_ISR_TAMP2F /*!< Tamper 2 event flag                      */
#define RTC_FLAG_TAMP1F \
  RTC_ISR_TAMP1F /*!< Tamper 1 event flag                      */
#define RTC_FLAG_TSOVF \
  RTC_ISR_TSOVF /*!< Timestamp overflow flag                  */
#define RTC_FLAG_TSF \
  RTC_ISR_TSF /*!< Timestamp event flag                     */
#define RTC_FLAG_WUTF \
  RTC_ISR_WUTF /*!< Wakeup timer event flag                  */
#define RTC_FLAG_ALRBF \
  RTC_ISR_ALRBF /*!< Alarm B event flag                       */
#define RTC_FLAG_ALRAF \
  RTC_ISR_ALRAF /*!< Alarm A event flag                       */
#define RTC_FLAG_INITF \
  RTC_ISR_INITF /*!< RTC in initialization mode flag          */
#define RTC_FLAG_RSF \
  RTC_ISR_RSF /*!< Register synchronization flag            */
#define RTC_FLAG_INITS \
  RTC_ISR_INITS /*!< RTC initialization status flag           */
#define RTC_FLAG_SHPF \
  RTC_ISR_SHPF /*!< Shift operation pending flag             */
#define RTC_FLAG_WUTWF \
  RTC_ISR_WUTWF /*!< WUTR register write allowance flag       */
#define RTC_FLAG_ALRBWF \
  RTC_ISR_ALRBWF /*!< ALRMBR register write allowance flag     */
#define RTC_FLAG_ALRAWF \
  RTC_ISR_ALRAWF /*!< ALRMAR register write allowance flag     */
/**
 * @}
 */
...
#define RTC_TR_RESERVED_MASK                                                \
  ((uint32_t)(RTC_TR_HT | RTC_TR_HU | RTC_TR_MNT | RTC_TR_MNU | RTC_TR_ST | \
              RTC_TR_SU | RTC_TR_PM))
#define RTC_DR_RESERVED_MASK                                              \
  ((uint32_t)(RTC_DR_YT | RTC_DR_YU | RTC_DR_MT | RTC_DR_MU | RTC_DR_DT | \
              RTC_DR_DU | RTC_DR_WDU))
...
#define RTC_FLAGS_MASK                                                       \
  ((uint32_t)(RTC_FLAG_INITF | RTC_FLAG_INITS | RTC_FLAG_ALRAF |             \
              RTC_FLAG_ALRAWF | RTC_FLAG_ALRBF | RTC_FLAG_ALRBWF |           \
              RTC_FLAG_WUTF | RTC_FLAG_WUTWF | RTC_FLAG_RECALPF |            \
              RTC_FLAG_SHPF | RTC_FLAG_TSF | RTC_FLAG_TSOVF | RTC_FLAG_RSF | \
              RTC_TAMPER_FLAGS_MASK))

#define RTC_TIMEOUT_VALUE 1000U

#define RTC_EXTI_LINE_ALARM_EVENT                                          \
  EXTI_IMR_MR17 /*!< External interrupt line 17 connected to the RTC Alarm \
                   event */
/**
 * @}
 */
