...
#define USART_FLAG_CTS \
  USART_ISR_CTS /*!< USART clear to send flag                   */
#define USART_FLAG_CTSIF \
  USART_ISR_CTSIF /*!< USART clear to send interrupt flag         */
#define USART_FLAG_LBDF \
  USART_ISR_LBDF /*!< USART LIN break detection flag             */
#define USART_FLAG_TXE \
  USART_ISR_TXE /*!< USART transmit data register empty         */
 ...
 *         The maximum Baud Rate is derived from the maximum clock on F3 (i.e.
 * 72 MHz) divided by the smallest oversampling used on the USART (i.e. 8)
