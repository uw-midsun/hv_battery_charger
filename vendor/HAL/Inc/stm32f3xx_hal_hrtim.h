 ...
 */
typedef struct {
  uint32_t HRTIMInterruptRequests; /*!< Specifies which interrupts requests must
                                      enabled for the HRTIM instance. This
                                      parameter can be any combination of  @ref
                                      HRTIM_Common_Interrupt_Enable */
  uint32_t
      SyncOptions; /*!< Specifies how the HRTIM instance handles the external
                      synchronization signals. The HRTIM instance can be
                      configured to act as a slave (waiting for a trigger to be
                      synchronized) or a master (generating a synchronization
                      signal) or both. This parameter can be a combination of
                      @ref HRTIM_Synchronization_Options.*/
  uint32_t
      SyncInputSource; /*!< Specifies the external synchronization input source
                          (significant only when the HRTIM instance is
                          configured as a slave). This parameter can be a value
                          of @ref HRTIM_Synchronization_Input_Source. */
  uint32_t
      SyncOutputSource; /*!< Specifies the source and event to be sent on the
                           external synchronization outputs (significant only
                           when the HRTIM instance is configured as a master).
...
typedef struct {
  uint32_t
      CaptureTrigger1; /*!< Event(s) triggering capture unit 1.
                            When the timer operates in Simple mode, this
                          parameter can be a value of @ref
                          HRTIM_External_Event_Channels. When the timer operates
                          in Waveform mode, this parameter can be a combination
                          of @ref HRTIM_Capture_Unit_Trigger. */
  uint32_t
      CaptureTrigger2;        /*!< Event(s) triggering capture unit 2.
                                   When the timer operates in Simple mode, this
                                 parameter can be a value of @ref
                                 HRTIM_External_Event_Channels.        When the timer
                                 operates        in Waveform mode, this parameter can be a
                                 combination        of @ref HRTIM_Capture_Unit_Trigger. */
  ...
  uint32_t
      DMASrcAddress; /*!< Address of the source address of the DMA transfer. */
...
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
{
  ...
  HRTIM_TimerParamTypeDef
      TimerParam[MAX_HRTIM_TIMER]; /*!< HRTIM timers - including the master -
                                      parameters */
  ...
  void (*BurstModePeriodCallback)(
      struct __HRTIM_HandleTypeDef *
          hhrtim); /*!< Burst mode period interrupt callback function pointer */
  void (*SynchronizationEventCallback)(
      struct __HRTIM_HandleTypeDef
          *hhrtim); /*!< Sync Input interrupt callback function pointer */
  void (*ErrorCallback)(struct __HRTIM_HandleTypeDef *
                            hhrtim); /*!< DMA error callback function pointer */

  void (*RegistersUpdateCallback)(
      struct __HRTIM_HandleTypeDef *hhrtim,
      uint32_t
          TimerIdx); /*!< Timer x Update interrupt callback function pointer */
  void (*RepetitionEventCallback)(
      struct __HRTIM_HandleTypeDef *hhrtim,
      uint32_t TimerIdx); /*!< Timer x Repetition interrupt callback function
                             pointer              */
  ...
  void (*Capture1EventCallback)(
      struct __HRTIM_HandleTypeDef *hhrtim,
      uint32_t TimerIdx); /*!< Timer x Capture 1 interrupts callback function
                             pointer              */
  void (*Capture2EventCallback)(
      struct __HRTIM_HandleTypeDef *hhrtim,
      uint32_t TimerIdx); /*!< Timer x Capture 2 interrupts callback function
                             pointer              */
  ...
  void (*Output1SetCallback)(
      struct __HRTIM_HandleTypeDef *hhrtim,
      uint32_t TimerIdx); /*!< Timer x output 1 set interrupt callback function
                             pointer            */
  ...
  void (*Output2SetCallback)(
      struct __HRTIM_HandleTypeDef *hhrtim,
      uint32_t TimerIdx); /*!< Timer x output 2 set interrupt callback function
                             pointer            */
...
typedef struct {
  ...
  uint32_t Pulse; /*!< Specifies the compare value to be loaded into the Compare
                     Register. The compare value must be above or equal to 3
  ...
  uint32_t IdleLevel; /*!< Specifies whether the output level is active or
                         inactive when in IDLE state. This parameter can be any
                         value of @ref HRTIM_Output_IDLE_Level */
...
typedef struct {
  ...
  uint32_t
      EventFilter; /*!< Defines the frequency used to sample the External Event
...
typedef struct {
  ...
  uint32_t OutputPolarity;  /*!< Specifies the output polarity.
                                 This parameter can be any value of @ref
                               HRTIM_Output_Polarity */
  uint32_t OutputIdleLevel; /*!< Specifies whether the output level is active or
  ...
  uint32_t Event;         /*!< Specifies the external event triggering the pulse
                             generation.         This parameter can be any 'EEVx' value
                             of @ref         HRTIM_External_Event_Channels */
  uint32_t EventPolarity; /*!< Specifies the polarity of the external event (in
                             case of level sensitivity). This parameter can be a
                             value of @ref HRTIM_External_Event_Polarity */
  uint32_t EventSensitivity; /*!< Specifies the sensitivity of the external
...
typedef struct {
  uint32_t
      InterruptRequests;  /*!< Relevant for all HRTIM timers, including the
                             master.  Specifies which interrupts requests must
                             enabled for the timer.  This parameter can be any
                             combination of  @ref HRTIM_Master_Interrupt_Enable
  ...
  uint32_t StartOnSync;    /*!< Relevant for all HRTIM timers, including the
                              master.    Specifies whether or not timer is reset by
                              a    rising edge on the synchronization input (when
                              enabled).    This parameter can be any value of @ref
  ...
  uint32_t DACSynchro; /*!< Relevant for all HRTIM timers, including the master.
                            Indicates whether or not the a DAC synchronization
                          event is generated. This parameter can be any value of
                          @ref HRTIM_DAC_Synchronization   */
  uint32_t PreloadEnable; /*!< Relevant for all HRTIM timers, including the
                             master. Specifies whether or not register preload
                             is enabled. This parameter can be any value of @ref
  ...
  uint32_t BurstMode; /*!< Relevant for all HRTIM timers, including the master.
                           Specifies how the timer behaves during a burst mode
                         operation. This parameter can be any value of @ref
                         HRTIM_Timer_Burst_Mode  */
  uint32_t
      RepetitionUpdate; /*!< Relevant for all HRTIM timers, including the
                           master. Specifies whether or not registers update is
                           triggered by the repetition event. This parameter can
                           be any value of @ref HRTIM_Timer_Repetition_Update */
  ...
  uint32_t FaultLock;   /*!< Relevant for Timer A to Timer E.
                           ...
                           write protected.   This parameter can be a value of
                           @ref   HRTIM_Timer_Fault_Lock */
  uint32_t
      DeadTimeInsertion;          /*!< Relevant for Timer A to Timer E.
                                       Specifies whether or not dead-time insertion is
                                     enabled for the timer.          This parameter can
                                     be a value          of @ref HRTIM_Timer_Deadtime_Insertion */
  ...
  uint32_t ResetTrigger;          /*!< Relevant for Timer A to Timer E.
                                     ...
                                     reset.          This parameter can be a combination
                                     of @ref          HRTIM_Timer_Reset_Trigger */
  uint32_t
      ResetUpdate; /*!<  Relevant for Timer A to Timer E.
                         Specifies whether or not registers update is triggered
                      when the timer counter is reset. This parameter can be a
                      value of @ref HRTIM_Timer_Reset_Update */
...
typedef struct {
  ...
  uint32_t AutoDelayedTimeout; /*!< Specifies compare value for timing unit 1 or
                                  3 when auto delayed mode with time out is
...
typedef struct {
  uint32_t Polarity;  /*!< Specifies the output polarity.
                           This parameter can be any value of @ref
                         HRTIM_Output_Polarity */
  uint32_t SetSource; /*!< Specifies the event(s) transitioning the output from
                         its inactive level to its active level. This parameter
                         can be a combination of @ref HRTIM_Output_Set_Source */
  uint32_t
      ResetSource; /*!< Specifies the event(s) transitioning the output from its
                      active level to its inactive level. This parameter can be
                      a combination of @ref HRTIM_Output_Reset_Source */
  uint32_t
      IdleMode;        /*!< Specifies whether or not the output is affected by a
                          burst mode operation.   This parameter can be any value of
                          @ref HRTIM_Output_Idle_Mode */
  uint32_t IdleLevel;  /*!< Specifies whether the output level is active or
                          inactive when in IDLE state.  This parameter can be any
                          value of @ref HRTIM_Output_IDLE_Level */
  ...
  uint32_t ChopperModeEnable; /*!< Indicates whether or not the chopper mode is
                                 enabled This parameter can be any value of @ref
                                 HRTIM_Output_Chopper_Mode_Enable */
  uint32_t
      BurstModeEntryDelayed; /*!< Indicates whether or not dead-time is inserted
                                when entering the IDLE state during a burst mode
                                operation. This parameters can be any value of
                                @ref HRTIM_Output_Burst_Mode_Entry_Delayed */
 ...
 */
typedef struct {
  uint32_t Filter; /*!< Specifies the type of event filtering within the timing
                      unit. This parameter can be a value of @ref
...
typedef struct {
  ...
  uint32_t
      RisingValue;     /*!< Specifies the dead-time following a rising edge.
                            This parameter can be a number between 0x0 and 0x1FFU */
  uint32_t RisingSign; /*!< Specifies whether the dead-time is positive or
                          negative on rising edge. This parameter can be a value
                          of @ref HRTIM_Deadtime_Rising_Sign */
  ...
  uint32_t FallingLock; /*!< Specifies whether or not dead-time falling settings
                           (value and sign) are write protected. This parameter
                           can be a value of @ref HRTIM_Deadtime_Falling_Lock */
  uint32_t FallingSignLock; /*!< Specifies whether or not dead-time falling sign
                               is write protected. This parameter can be a value
                               of @ref HRTIM_Deadtime_Falling_Sign_Lock */
...
typedef struct {
  ...
  uint32_t Polarity; /*!< Specifies the polarity of the external event (in case
                        of level sensitivity). This parameter can be a value of
                        @ref HRTIM_External_Event_Polarity */
  ...
  uint32_t FastMode; /*!< Indicates whether or not low latency mode is enabled
                        for the external event. This parameter can be a value of
                        @ref HRTIM_External_Event_Fast_Mode */
...
typedef struct {
  uint32_t
      Source;        /*!< Identifies the source of the fault.
  ...
  uint32_t Filter; /*!< Defines the frequency used to sample the Fault input and
                      the length of the digital filter. This parameter can be a
                      value of @ref HRTIM_Fault_Filter */
  uint32_t Lock; /*!< Indicates whether or not fault programming bits are write
...
#define HRTIM_PRESCALERRATIO_MUL8                                              \
  (0x00000002U) /*!< fHRCK: fHRTIM x 8U = 1.152 GHz - Resolution: 868 ps - Min \
                   PWM frequency: 17.6 kHz (fHRTIM=144MHz)  */
#define HRTIM_PRESCALERRATIO_MUL4                                             \
  (0x00000003U) /*!< fHRCK: fHRTIM x 4U = 576 MHz - Resolution: 1.73 ns - Min \
                   PWM frequency: 8.8 kHz (fHRTIM=144MHz)    */
#define HRTIM_PRESCALERRATIO_MUL2                                             \
  (0x00000004U) /*!< fHRCK: fHRTIM x 2U = 288 MHz - Resolution: 3.47 ns - Min \
                   PWM frequency: 4.4 kHz (fHRTIM=144MHz)    */
...
#define HRTIM_PRELOAD_DISABLED                                                \
  (0x00000000U) /*!< Preload disabled: the write access is directly done into \
                   the active register */
...
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT1_EEV6                   \
  (HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 1 delayed Idle on external \
                           Event 6U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT2_EEV6                   \
  (HRTIM_OUTR_DLYPRT_0 |                                                       \
   HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 2 delayed Idle on external \
                           Event 6U */
...
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDBOTH_EEV7                   \
  (HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 |                                 \
   HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 1 and output2 delayed Idle \
...
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDBOTH_EEV9                     \
  (HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 |                                 \
   HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 1 and output2 delayed Idle on \
                           external Event 7U */
...
#define HRTIM_TIMRESETTRIGGER_EEV_1                                            \
  (HRTIM_RSTR_EXTEVNT1) /*!< The timer counter is reset upon external event 1U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_2                                            \
  (HRTIM_RSTR_EXTEVNT2) /*!< The timer counter is reset upon external event 2U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_3                                            \
  (HRTIM_RSTR_EXTEVNT3) /*!< The timer counter is reset upon external event 3U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_4                                            \
  (HRTIM_RSTR_EXTEVNT4) /*!< The timer counter is reset upon external event 4U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_5                                            \
  (HRTIM_RSTR_EXTEVNT5) /*!< The timer counter is reset upon external event 5U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_6                                            \
  (HRTIM_RSTR_EXTEVNT6) /*!< The timer counter is reset upon external event 6U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_7                                            \
  (HRTIM_RSTR_EXTEVNT7) /*!< The timer counter is reset upon external event 7U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_8                                            \
  (HRTIM_RSTR_EXTEVNT8) /*!< The timer counter is reset upon external event 8U \
                         */
#define HRTIM_TIMRESETTRIGGER_EEV_9                                            \
  (HRTIM_RSTR_EXTEVNT9) /*!< The timer counter is reset upon external event 9U \
                         */
...
#define HRTIM_BASICOCMODE_TOGGLE                                               \
  (0x00000001U) /*!< Output toggles when the timer counter reaches the compare \
                   value */
...
#define HRTIM_OUTPUTSET_MASTERPER                                              \
  (HRTIM_SET1R_MSTPER) /*!< The master timer period event forces the output to \
                          its active state */
#define HRTIM_OUTPUTSET_MASTERCMP1                                             \
  (HRTIM_SET1R_MSTCMP1) /*!< Master Timer compare 1 event forces the output to \
                           its active state */
#define HRTIM_OUTPUTSET_MASTERCMP2                                             \
  (HRTIM_SET1R_MSTCMP2) /*!< Master Timer compare 2 event forces the output to \
                           its active state */
#define HRTIM_OUTPUTSET_MASTERCMP3                                             \
  (HRTIM_SET1R_MSTCMP3) /*!< Master Timer compare 3 event forces the output to \
                           its active state */
#define HRTIM_OUTPUTSET_MASTERCMP4                                             \
  (HRTIM_SET1R_MSTCMP4) /*!< Master Timer compare 4 event forces the output to \
                           its active state */
...
#define HRTIM_OUTPUTSET_EEV_1                                                 \
  (HRTIM_SET1R_EXTVNT1) /*!< External event 1 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_2                                                 \
  (HRTIM_SET1R_EXTVNT2) /*!< External event 2 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_3                                                 \
  (HRTIM_SET1R_EXTVNT3) /*!< External event 3 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_4                                                 \
  (HRTIM_SET1R_EXTVNT4) /*!< External event 4 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_5                                                 \
  (HRTIM_SET1R_EXTVNT5) /*!< External event 5 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_6                                                 \
  (HRTIM_SET1R_EXTVNT6) /*!< External event 6 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_7                                                 \
  (HRTIM_SET1R_EXTVNT7) /*!< External event 7 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_8                                                 \
  (HRTIM_SET1R_EXTVNT8) /*!< External event 8 forces the output to its active \
                           state */
#define HRTIM_OUTPUTSET_EEV_9                                                 \
  (HRTIM_SET1R_EXTVNT9) /*!< External event 9 forces the output to its active \
                           state */
...
#define HRTIM_OUTPUTRESET_TIMPER                                              \
  (HRTIM_RST1R_PER) /*!< Timer period event forces the output to its inactive \
                       state */
...
#define HRTIM_OUTPUTRESET_MASTERPER                                            \
  (HRTIM_RST1R_MSTPER) /*!< The master timer period event forces the output to \
                          its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP1                                           \
  (HRTIM_RST1R_MSTCMP1) /*!< Master Timer compare 1 event forces the output to \
                           its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP2                                           \
  (HRTIM_RST1R_MSTCMP2) /*!< Master Timer compare 2 event forces the output to \
                           its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP3                                           \
  (HRTIM_RST1R_MSTCMP3) /*!< Master Timer compare 3 event forces the output to \
                           its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP4                                           \
  (HRTIM_RST1R_MSTCMP4) /*!< Master Timer compare 4 event forces the output to \
                           its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_1                                           \
  (HRTIM_RST1R_TIMEVNT1) /*!< Timer event 1 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_2                                           \
  (HRTIM_RST1R_TIMEVNT2) /*!< Timer event 2 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_3                                           \
  (HRTIM_RST1R_TIMEVNT3) /*!< Timer event 3 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_4                                           \
  (HRTIM_RST1R_TIMEVNT4) /*!< Timer event 4 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_5                                           \
  (HRTIM_RST1R_TIMEVNT5) /*!< Timer event 5 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_6                                           \
  (HRTIM_RST1R_TIMEVNT6) /*!< Timer event 6 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_7                                           \
  (HRTIM_RST1R_TIMEVNT7) /*!< Timer event 7 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_8                                           \
  (HRTIM_RST1R_TIMEVNT8) /*!< Timer event 8 forces the output to its active \
                            state */
#define HRTIM_OUTPUTRESET_TIMEV_9                                           \
  (HRTIM_RST1R_TIMEVNT9) /*!< Timer event 9 forces the output to its active \
                            state */
...
#define HRTIM_OUTPUTBURSTMODEENTRY_DELAYED                                    \
  (HRTIM_OUTR_DIDL1) /*!< Dead-time is inserted on output before entering the \
                        idle mode */
/**
 * @}
 */
...
#define HRTIM_SYNCOPTION_SLAVE                                                \
  0x00000002U /*!< HRTIM instance acts as a SLAVE, i.e. it is synchronized by \
                 external sources (SYNCIN) */
/**
 * @}
 */
...
#define HRTIM_SYNCINPUTSOURCE_NONE                                            \
  0x00000000U /*!< disabled. HRTIM is not synchronized and runs in standalone \
                 mode */
...
#define HRTIM_EVENTSRC_4                                                      \
  (HRTIM_EECR1_EE1SRC_1 | HRTIM_EECR1_EE1SRC_0) /*!< External event source 4U \
                                                 */
/**
 * @}
 */
...
#define HRTIM_BURSTDMA_ICR                                                    \
  (HRTIM_BDTUPR_TIMICR) /*!< MICR or TIMxICR register is updated by Burst DMA \
                           accesses */
#define HRTIM_BURSTDMA_DIER                                                  \
  (HRTIM_BDTUPR_TIMDIER) /*!< MDIER or TIMxDIER register is updated by Burst \
                            DMA accesses */
#define HRTIM_BURSTDMA_CNT                                                    \
  (HRTIM_BDTUPR_TIMCNT) /*!< MCNTR or CNTxCR register is updated by Burst DMA \
                           accesses */
...
#define HRTIM_OUTPUTSTATE_IDLE                                                 \
  (0x00000001U) /*!< Main operating mode, where the output can take the active \
                   or inactive level as programmed in the crossbar unit */
#define HRTIM_OUTPUTSTATE_RUN                                                  \
  (0x00000002U) /*!< Default operating state (e.g. after an HRTIM reset, when  \
                   the outputs are disabled by software or during a burst mode \
                   operation */
...
#define HRTIM_PUSHPULL_IDLESTATUS_OUTPUT1                                      \
  0x00000000U /*!< Protection occurred when the output 1 was active and output \
                 2 forced inactive */
  ...
  ((((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) ||                \
   ...
   ((((EVENT) == HRTIM_EVENT_6) || ((EVENT) == HRTIM_EVENT_7) ||               \
    ...
    (((FILTER) == HRTIM_EVENTFILTER_NONE) ||                                   \
     ((FILTER) == HRTIM_EVENTFILTER_1) || ((FILTER) == HRTIM_EVENTFILTER_2) || \
     ((FILTER) == HRTIM_EVENTFILTER_3) || ((FILTER) == HRTIM_EVENTFILTER_4) || \
     ((FILTER) == HRTIM_EVENTFILTER_5) || ((FILTER) == HRTIM_EVENTFILTER_6) || \
     ((FILTER) == HRTIM_EVENTFILTER_7) || ((FILTER) == HRTIM_EVENTFILTER_8) || \
...
#define __HAL_HRTIM_TIMER_ENABLE_IT(__HANDLE__, __TIMER__, __INTERRUPT__) \
  ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxDIER |= (__INTERRUPT__))
...
#define __HAL_HRTIM_TIMER_GET_FLAG(__HANDLE__, __TIMER__, __FLAG__)           \
  (((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxISR & (__FLAG__)) == \
   (__FLAG__))
...
#define __HAL_HRTIM_SETCLOCKPRESCALER(__HANDLE__, __TIMER__, __PRESCALER__)   \
  (((__TIMER__) == HRTIM_TIMERINDEX_MASTER)                                   \
       ? (MODIFY_REG((__HANDLE__)->Instance->sMasterRegs.MCR,                 \
                     HRTIM_MCR_CK_PSC, (__PRESCALER__)))                      \
       : (MODIFY_REG((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxCR, \
                     HRTIM_TIMCR_CK_PSC, (__PRESCALER__))))
 ...
 * @retval None
 */
#define __HAL_HRTIM_SETCOMPARE(__HANDLE__, __TIMER__, __COMPAREUNIT__,        \
                               __COMPARE__)                                   \
  (((__TIMER__) == HRTIM_TIMERINDEX_MASTER)                                   \
       ? (((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_1)                          \
          ...
          : ((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_3)                        \
              ? ((__HANDLE__)->Instance->sMasterRegs.MCMP3R = (__COMPARE__))  \
              : ((__HANDLE__)->Instance->sMasterRegs.MCMP4R = (__COMPARE__))) \
       : (((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_1)                          \
              ? ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CMP1xR =    \
                     (__COMPARE__))                                           \
          : ((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_2)                        \
              ? ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CMP2xR =    \
                     (__COMPARE__))                                           \
          : ((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_3)                        \
              ? ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CMP3xR =    \
                     (__COMPARE__))                                           \
...
HAL_StatusTypeDef HAL_HRTIM_WaveformCompareConfig(
    HRTIM_HandleTypeDef *hhrtim, uint32_t TimerIdx, uint32_t CompareUnit,
    const HRTIM_CompareCfgTypeDef *pCompareCfg);

HAL_StatusTypeDef HAL_HRTIM_WaveformCaptureConfig(
    HRTIM_HandleTypeDef *hhrtim, uint32_t TimerIdx, uint32_t CaptureUnit,
    const HRTIM_CaptureCfgTypeDef *pCaptureCfg);

HAL_StatusTypeDef HAL_HRTIM_WaveformOutputConfig(
    HRTIM_HandleTypeDef *hhrtim, uint32_t TimerIdx, uint32_t Output,
