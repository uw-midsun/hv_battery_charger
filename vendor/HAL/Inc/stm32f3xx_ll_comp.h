...
/*       delimited by compilation switches.                                   */
    ...
    defined(COMP5) || defined(COMP6) || defined(COMP7)
...
#define LL_COMP_OUTPUT_LEVEL_BITOFFSET_POS \
  ((uint32_t)30U) /* Value equivalent to POSITION_VAL(COMPxOUT) */
  ...
  uint32_t
      OutputSelection; /*!< Set comparator output selection.
                          ...
                          COMP_LL_EC_OUTPUT_SELECTION
                            ...
                            This feature can be modified afterwards using
                          unitary function @ref LL_COMP_SetOutputSelection(). */
...
#define LL_COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                            \
  (COMP2_CSR_COMP2WNDWEN) /*!< Window mode enable: Comparators instances pair \
...
#define LL_COMP_WINDOWMODE_COMP3_INPUT_PLUS_COMMON                            \
  (COMP4_CSR_COMP4WNDWEN) /*!< Window mode enable: Comparators instances pair \
                             COMP3 and COMP4 have their input plus connected  \
                             together. The common input is COMP3 input plus   \
                             (COMP4 input plus is no more accessible). */
#endif
#if defined(COMP6_CSR_COMP6WNDWEN)
#define LL_COMP_WINDOWMODE_COMP5_INPUT_PLUS_COMMON                            \
  (COMP6_CSR_COMP6WNDWEN) /*!< Window mode enable: Comparators instances pair \
                             COMP5 and COMP6 have their input plus connected  \
                             together. The common input is COMP5 input plus   \
                             (COMP6 input plus is no more accessible). */
#endif
/**
 * @}
 */
...
#define LL_COMP_POWERMODE_MEDIUMSPEED \
  (COMP_CSR_COMPxMODE_0) /*!< COMP power mode to medium speed */
#define LL_COMP_POWERMODE_LOWPOWER \
  (COMP_CSR_COMPxMODE_1) /*!< COMP power mode to low power */
#define LL_COMP_POWERMODE_ULTRALOWPOWER \
  (COMP_CSR_COMPxMODE_1 |               \
   COMP_CSR_COMPxMODE_0) /*!< COMP power mode to ultra-low power */
#endif
/**
 * @}
 */
...
#define LL_COMP_INPUT_PLUS_IO1                                                 \
  ((uint32_t)0x00000000U) /*!< Comparator input plus connected to IO1 (pin PA1 \
                             for COMP1, PA3 for COMP2 (except STM32F334xx:     \
                             PA7), PB14 for COMP3, PB0 for COMP4, PD12 for     \
                             COMP5, PD11 for COMP6, PA0  for COMP7) (COMP      \
                             instance availability depends on the selected     \
                             device) */
#define LL_COMP_INPUT_PLUS_IO2                                                 \
  ((uint32_t)0x00000000U) /*!< Comparator input plus connected to IO2: Same as \
                             IO1 */
#else
#define LL_COMP_INPUT_PLUS_IO1                                                 \
  ((uint32_t)0x00000000U) /*!< Comparator input plus connected to IO1 (pin PA7 \
                             for COMP2, PB14 for COMP3, PB0 for COMP4, PD12    \
                             for COMP5, PD11 for COMP6, PA0  for COMP7) (COMP  \
                             instance availability depends on the selected     \
                             device) */
#define LL_COMP_INPUT_PLUS_IO2                                               \
  (COMP_CSR_COMPxNONINSEL) /*!< Comparator input plus connected to IO2 (pin  \
                              PA3 for COMP2, PD14 for COMP3, PE7 for COMP4,  \
                              PB13 for COMP5, PB11 for COMP6, PC1 for COMP7) \
                              (COMP instance availability depends on the     \
                              selected device) */
#endif
#if defined(STM32F302xC) || defined(STM32F302xE) || defined(STM32F303xC) || \
    defined(STM32F303xE) || defined(STM32F358xx) || defined(STM32F398xx)
#define LL_COMP_INPUT_PLUS_DAC1_CH1_COMP1                                    \
  (COMP_CSR_COMPxSW1) /*!< Comparator input plus connected to DAC1 channel 1 \
                         (DAC_OUT1), through dedicated switch (Note: this    \
                         switch is solely intended to redirect signals onto  \
                         high impedance input, such as COMP1 input plus      \
                         (highly resistive switch)) (specific to COMP        \
                         instance: COMP1) */
...
#define LL_COMP_INPUT_PLUS_DAC1_CH1                                           \
  LL_COMP_INPUT_PLUS_DAC1_CH1_COMP1 /*!< Comparator input plus connected to   \
                                       DAC1 channel 1 (DAC_OUT1), through     \
                                       dedicated switch. Caution: Parameter   \
                                       specific to COMP instances, defined    \
                                       with generic naming, not taking into   \
                                       account COMP instance constraints.     \
                                       Refer to literal definitions above for \
...
#define LL_COMP_INPUT_PLUS_DAC1_CH1_COMP2                                    \
  (COMP_CSR_COMPxSW1) /*!< Comparator input plus connected to DAC1 channel 1 \
                         (DAC_OUT1), through dedicated switch (Note: this    \
                         switch is solely intended to redirect signals onto  \
                         high impedance input, such as COMP2 input plus      \
                         (highly resistive switch)) (specific to COMP        \
                         instance: COMP2) */
...
/*       Refer to literal definitions above for COMP instance constraints.    */
#define LL_COMP_INPUT_PLUS_DAC1_CH1                                           \
  LL_COMP_INPUT_PLUS_DAC1_CH1_COMP2 /*!< Comparator input plus connected to   \
                                       DAC1 channel 1 (DAC_OUT1), through     \
                                       dedicated switch. Caution: Parameter   \
                                       specific to COMP instances, defined    \
                                       with generic naming, not taking into   \
...
#define LL_COMP_INPUT_MINUS_1_2VREFINT                                         \
  (COMP_CSR_COMPxINSEL_0) /*!< Comparator input minus connected to 1/2 VrefInt \
                           */
#define LL_COMP_INPUT_MINUS_3_4VREFINT                                         \
  (COMP_CSR_COMPxINSEL_1) /*!< Comparator input minus connected to 3/4 VrefInt \
                           */
#define LL_COMP_INPUT_MINUS_VREFINT \
  (COMP_CSR_COMPxINSEL_1 |          \
   COMP_CSR_COMPxINSEL_0) /*!< Comparator input minus connected to VrefInt */
#define LL_COMP_INPUT_MINUS_DAC1_CH1                                    \
  (COMP_CSR_COMPxINSEL_2) /*!< Comparator input minus connected to DAC1 \
                             channel 1 (DAC_OUT1)  */
...
#define LL_COMP_INPUT_MINUS_DAC1_CH2                                    \
  (COMP_CSR_COMPxINSEL_2 |                                              \
   COMP_CSR_COMPxINSEL_0) /*!< Comparator input minus connected to DAC1 \
                             channel 2 (DAC_OUT2)  */
#endif
#if defined(STM32F301x8) || defined(STM32F318xx) || defined(STM32F334x8)
#define LL_COMP_INPUT_MINUS_IO1                                             \
  (COMP_CSR_COMPxINSEL_2 |                                                  \
   COMP_CSR_COMPxINSEL_1) /*!< Comparator input minus connected to IO1 (pin \
                             PA2 for COMP2) */
#else
#define LL_COMP_INPUT_MINUS_IO1                                                \
  (COMP_CSR_COMPxINSEL_2 |                                                     \
   COMP_CSR_COMPxINSEL_1) /*!< Comparator input minus connected to IO1 (pin    \
                             ...
                             PC0 for COMP7 (COMP instance availability depends \
                             on the selected device)) */
#endif
#define LL_COMP_INPUT_MINUS_IO2                                               \
  (COMP_CSR_COMPxINSEL_2 | COMP_CSR_COMPxINSEL_1 |                            \
   COMP_CSR_COMPxINSEL_0) /*!< Comparator input minus connected to IO2 (PB12  \
                             for COMP3, PB2 for COMP4, PB10 for COMP5, PB15   \
                             for COMP6 (COMP instance availability depends on \
                             the selected device)) */
#if defined(STM32F301x8) || defined(STM32F318xx) || defined(STM32F334x8) || \
    defined(STM32F302x8) || defined(STM32F303x8) || defined(STM32F328xx)
/* This device has no comparator input minus IO3 */
#else
#define LL_COMP_INPUT_MINUS_IO3                                             \
  (COMP_CSR_COMPxINSEL_2 |                                                  \
   COMP_CSR_COMPxINSEL_0) /*!< Comparator input minus connected to IO3 (pin \
                             PA5 for COMP1/2/3/4/5/6/7 (COMP instance       \
                             availability depends on the selected device)) */
#endif
#define LL_COMP_INPUT_MINUS_IO4                                             \
  (COMP_CSR_COMPxINSEL_2) /*!< Comparator input minus connected to IO4 (pin \
                             PA4 for COMP1/2/3/4/5/6/7 (COMP instance       \
                             availability depends on the selected device)) */
#if defined(STM32F303x8) || defined(STM32F328xx) || defined(STM32F334x8)
#define LL_COMP_INPUT_MINUS_DAC2_CH1                                    \
  (COMP_CSR_COMPxINSEL_3) /*!< Comparator input minus connected to DAC2 \
                             channel 1 (DAC2_OUT1)  */
#else
...
#define LL_COMP_HYSTERESIS_LOW                                                 \
  (COMP_CSR_COMPxHYST_0) /*!< Hysteresis level low (available only on devices: \
                            STM32F303xB/C, STM32F358xC) */
#define LL_COMP_HYSTERESIS_MEDIUM                                        \
  (COMP_CSR_COMPxHYST_1) /*!< Hysteresis level medium (available only on \
                            devices: STM32F303xB/C, STM32F358xC) */
#define LL_COMP_HYSTERESIS_HIGH                                        \
  (COMP_CSR_COMPxHYST_1 |                                              \
   COMP_CSR_COMPxHYST_0) /*!< Hysteresis level high (available only on \
                            devices: STM32F303xB/C, STM32F358xC) */
#endif
/**
 * @}
...
#define LL_COMP_OUTPUT_NONE                                                   \
  ((uint32_t)0x00000000) /*!< COMP output is not connected to other           \
                            peripherals (except GPIO and EXTI that are always \
                            connected to COMP output) (specific to COMP       \
                            instance: COMP2) */
...
#define LL_COMP_OUTPUT_TIM1_BKIN                                          \
  (COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM1 break input \
                              (BKIN) */
#define LL_COMP_OUTPUT_TIM1_BKIN2                                           \
  (COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM1 break input 2 \
                              (BKIN2) */

#if defined(STM32F301x8) || defined(STM32F318xx)
/* Note: Output redirection specific to COMP instance: COMP2 */
#define LL_COMP_OUTPUT_TIM1_IC1_COMP2                                         \
  (COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 |                          \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM1 input capture 1 \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM2_IC4_COMP2                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM1 input capture 4 \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM1_OCCLR_COMP2                                   \
  (COMP_CSR_COMPxOUTSEL_2 |                                               \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM1 OCREF clear \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP2                                   \
  (COMP_CSR_COMPxOUTSEL_3 |                                               \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM2 OCREF clear \
                              (specific to COMP instance: COMP2) */
/* Note: Output redirection specific to COMP instance: COMP4 */
#define LL_COMP_OUTPUT_TIM15_IC2_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM15 input capture 1 \
                              (specific to COMP instance: COMP4) */
#define LL_COMP_OUTPUT_TIM15_OCCLR_COMP4                                   \
  (COMP_CSR_COMPxOUTSEL_3 |                                                \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM15 OCREF clear \
                              (specific to COMP instance: COMP4) */
/* Note: Output redirection specific to COMP instance: COMP6 */
#define LL_COMP_OUTPUT_TIM2_IC2_COMP6                                         \
  (COMP_CSR_COMPxOUTSEL_2 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM2 input capture 2 \
                              (specific to COMP instance: COMP6) */
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP6                                   \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM2 OCREF clear \
                              (specific to COMP instance: COMP6) */
#define LL_COMP_OUTPUT_TIM16_IC1_COMP6                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                    \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM16 input capture 1 \
                              (specific to COMP instance: COMP6) */
#define LL_COMP_OUTPUT_TIM16_OCCLR_COMP6                                   \
  (COMP_CSR_COMPxOUTSEL_3 |                                                \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM16 OCREF clear \
                              (specific to COMP instance: COMP6) */
...
#define LL_COMP_OUTPUT_TIM1_IC1                                               \
  LL_COMP_OUTPUT_TIM1_IC1_COMP2 /*!< COMP output connected to TIM1 input      \
                                   capture 1.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM1_OCCLR                                             \
  LL_COMP_OUTPUT_TIM1_OCCLR_COMP2 /*!< COMP output connected to TIM1 OCREF    \
                                     clear.         Caution: Parameter        \
                                     specific to COMP instances, defined with \
                                     generic naming, not taking into account  \
                                     COMP instance constraints. Refer to      \
                                     literal definitions above for COMP       \
                                     instance constraints. */
#define LL_COMP_OUTPUT_TIM2_IC2                                               \
  LL_COMP_OUTPUT_TIM2_IC2_COMP6 /*!< COMP output connected to TIM2 input      \
                                   capture 2.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
...
#define LL_COMP_OUTPUT_TIM2_IC4                                               \
  LL_COMP_OUTPUT_TIM2_IC4_COMP2 /*!< COMP output connected to TIM2 input      \
                                   capture 4.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
...
#define LL_COMP_OUTPUT_TIM15_IC2                                              \
  LL_COMP_OUTPUT_TIM15_IC2_COMP4 /*!< COMP output connected to TIM15 input    \
                                    capture 1.    Caution: Parameter specific \
                                    to COMP instances, defined with generic   \
                                    naming, not taking into account COMP      \
                                    instance constraints. Refer to literal    \
                                    definitions above for COMP instance       \
                                    constraints. */
#define LL_COMP_OUTPUT_TIM15_OCCLR                                             \
  LL_COMP_OUTPUT_TIM15_OCCLR_COMP4 /*!< COMP output connected to TIM15 OCREF   \
                                      clear.        Caution: Parameter         \
                                      specific to COMP instances, defined with \
                                      generic naming, not taking into account  \
                                      COMP instance constraints. Refer to      \
                                      literal definitions above for COMP       \
                                      instance constraints. */
#define LL_COMP_OUTPUT_TIM16_IC1                                              \
  LL_COMP_OUTPUT_TIM16_IC1_COMP6 /*!< COMP output connected to TIM16 input    \
                                    capture 1.    Caution: Parameter specific \
                                    to COMP instances, defined with generic   \
                                    naming, not taking into account COMP      \
                                    instance constraints. Refer to literal    \
                                    definitions above for COMP instance       \
                                    constraints. */
#define LL_COMP_OUTPUT_TIM16_OCCLR                                             \
  LL_COMP_OUTPUT_TIM16_OCCLR_COMP6 /*!< COMP output connected to TIM16 OCREF   \
                                      clear.        Caution: Parameter         \
                                      specific to COMP instances, defined with \
                                      generic naming, not taking into account  \
                                      COMP instance constraints. Refer to      \
...
/*       Refer to literal definitions above for COMP instance constraints.    */
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2_3                                   \
  LL_COMP_OUTPUT_TIM2_OCCLR_COMP2 /*!< COMP output connected to TIM2 OCREF    \
                                     clear.         Caution: Parameter        \
                                     specific to COMP instances, defined with \
                                     generic naming, not taking into account  \
                                     COMP instance constraints. Refer to      \
...
#define LL_COMP_OUTPUT_TIM3_OCCLR_COMP2_4                                 \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_1 |                      \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM3 OCREF clear \
                              (specific to COMP instance: COMP2, COMP4) */
/* Note: Output redirection specific to COMP instance: COMP2 */
#define LL_COMP_OUTPUT_TIM1_IC1_COMP2                                         \
  (COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 |                          \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM1 input capture 1 \
...
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP2                                   \
  (COMP_CSR_COMPxOUTSEL_3 |                                               \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM2 OCREF clear \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM3_IC1_COMP2                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM3 input capture 1 \
                              (specific to COMP instance: COMP2) */
/* Note: Output redirection specific to COMP instance: COMP4 */
#define LL_COMP_OUTPUT_TIM3_IC3_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_2 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM3 input capture 3 \
                              (specific to COMP instance: COMP4) */
#define LL_COMP_OUTPUT_TIM15_IC2_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM15 input capture 1 \
                              (specific to COMP instance: COMP4) */
...
#define LL_COMP_OUTPUT_TIM3_IC1                                               \
  LL_COMP_OUTPUT_TIM3_IC1_COMP2 /*!< COMP output connected to TIM3 input      \
                                   capture 1.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM3_IC3                                               \
  LL_COMP_OUTPUT_TIM3_IC3_COMP4 /*!< COMP output connected to TIM3 input      \
                                   capture 3.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
...
#define LL_COMP_OUTPUT_TIM3_OCCLR                                             \
  LL_COMP_OUTPUT_TIM3_OCCLR_COMP2_4 /*!< COMP output connected to TIM3 OCREF  \
                                       clear.         Caution: Parameter      \
                                       specific to COMP instances, defined    \
                                       with generic naming, not taking into   \
                                       account COMP instance constraints.     \
...
#define LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4                               \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_1 |                      \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM3 OCREF clear \
                              (specific to COMP instance: COMP2, COMP4) */
/* Note: Output redirection specific to COMP instance: COMP1, COMP2 */
#define LL_COMP_OUTPUT_TIM1_IC1_COMP1_2                                       \
  (COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 |                          \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM1 input capture 1 \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM2_IC4_COMP1_2                                       \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM2 input capture 4 \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2                                 \
  (COMP_CSR_COMPxOUTSEL_2 |                                               \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM1 OCREF clear \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2                                 \
  (COMP_CSR_COMPxOUTSEL_3 |                                               \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM2 OCREF clear \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM3_IC1_COMP1_2                                       \
  (COMP_CSR_COMPxOUTSEL_3 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM3 input capture 1 \
                              (specific to COMP instance: COMP2) */
/* Note: Output redirection specific to COMP instance: COMP4 */
#define LL_COMP_OUTPUT_TIM3_IC3_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_2 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM3 input capture 3 \
                              (specific to COMP instance: COMP4) */
#define LL_COMP_OUTPUT_TIM4_IC2_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                   \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM4 input capture 2 \
                              (specific to COMP instance: COMP4) */
#define LL_COMP_OUTPUT_TIM15_IC2_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM15 input capture 1 \
                              (specific to COMP instance: COMP4) */
...
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP6                                   \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM2 OCREF clear \
                              (specific to COMP instance: COMP6) */
#define LL_COMP_OUTPUT_TIM4_IC4_COMP6                                         \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_1 |                          \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM4 input capture 4 \
                              (specific to COMP instance: COMP6) */
#define LL_COMP_OUTPUT_TIM16_IC1_COMP6                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                    \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM16 input capture 1 \
...
/*       LL_COMP_OUTPUT_TIM2_OCCLR_COMP6).                                    */
#define LL_COMP_OUTPUT_TIM1_IC1                                               \
  LL_COMP_OUTPUT_TIM1_IC1_COMP1_2 /*!< COMP output connected to TIM1 input    \
                                     capture 1.     Caution: Parameter        \
                                     specific to COMP instances, defined with \
                                     generic naming, not taking into account  \
                                     COMP instance constraints. Refer to      \
                                     literal definitions above for COMP       \
                                     instance constraints. */
#define LL_COMP_OUTPUT_TIM1_OCCLR                                             \
  LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2 /*!< COMP output connected to TIM1 OCREF  \
                                       clear.         Caution: Parameter      \
                                       specific to COMP instances, defined    \
                                       with generic naming, not taking into   \
                                       account COMP instance constraints.     \
...
#define LL_COMP_OUTPUT_TIM2_IC2                                               \
  LL_COMP_OUTPUT_TIM2_IC2_COMP6 /*!< COMP output connected to TIM2 input      \
                                   ...
                                   constraints. */
#define LL_COMP_OUTPUT_TIM2_IC4                                               \
  LL_COMP_OUTPUT_TIM2_IC4_COMP1_2 /*!< COMP output connected to TIM2 input    \
                                     capture 4.     Caution: Parameter        \
                                     specific to COMP instances, defined with \
                                     generic naming, not taking into account  \
                                     COMP instance constraints. Refer to      \
                                     literal definitions above for COMP       \
                                     instance constraints. */
#define LL_COMP_OUTPUT_TIM3_IC1                                               \
  LL_COMP_OUTPUT_TIM3_IC1_COMP1_2 /*!< COMP output connected to TIM3 input    \
                                     capture 1.     Caution: Parameter        \
                                     specific to COMP instances, defined with \
                                     generic naming, not taking into account  \
                                     COMP instance constraints. Refer to      \
...
#define LL_COMP_OUTPUT_TIM3_IC3                                               \
  LL_COMP_OUTPUT_TIM3_IC3_COMP4 /*!< COMP output connected to TIM3 input      \
                                   ...
                                   constraints. */
#define LL_COMP_OUTPUT_TIM3_OCCLR                                              \
  LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4 /*!< COMP output connected to TIM3 OCREF \
                                         clear.         Caution: Parameter     \
                                         specific to COMP instances, defined   \
                                         with generic naming, not taking into  \
                                         account COMP instance constraints.    \
                                         Refer to literal definitions above    \
                                         for COMP instance constraints. */
#define LL_COMP_OUTPUT_TIM4_IC2                                               \
  LL_COMP_OUTPUT_TIM4_IC2_COMP4 /*!< COMP output connected to TIM4 input      \
                                   capture 2.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM4_IC4                                               \
  LL_COMP_OUTPUT_TIM4_IC4_COMP6 /*!< COMP output connected to TIM4 input      \
                                   capture 4.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
...
/*       Refer to literal definitions above for COMP instance constraints.    */
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2_3                                   \
  LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2 /*!< COMP output connected to TIM2 OCREF  \
                                       clear.         Caution: Parameter      \
                                       specific to COMP instances, defined    \
                                       with generic naming, not taking into   \
                                       account COMP instance constraints.     \
...
#elif defined(STM32F303xC) || defined(STM32F358xx) || defined(STM32F303xE) || \
    defined(STM32F398xx)
/* Note: Output redirection common to all COMP instances */
#define LL_COMP_OUTPUT_TIM8_BKIN                                          \
  (COMP_CSR_COMPxOUTSEL_1 |                                               \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM8 break input \
                              (BKIN) */
#define LL_COMP_OUTPUT_TIM8_BKIN2                                           \
  (COMP_CSR_COMPxOUTSEL_2) /*!< COMP output connected to TIM8 break input 2 \
                              (BKIN2) */
#define LL_COMP_OUTPUT_TIM1_TIM8_BKIN2                                      \
  (COMP_CSR_COMPxOUTSEL_2 |                                                 \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM1 break input 2 \
                              and TIM8 break input 2 (BKIN2) */
#if defined(STM32F303xE) || defined(STM32F398xx)
#define LL_COMP_OUTPUT_TIM20_BKIN                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                               \
   COMP_CSR_COMPxOUTSEL_2) /*!< COMP output connected to TIM8 break input \
                              (BKIN) */
#define LL_COMP_OUTPUT_TIM20_BKIN2                                          \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_2 |                        \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM8 break input 2 \
                              (BKIN2) */
#define LL_COMP_OUTPUT_TIM1_TIM8_TIM20_BKIN2                                 \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_2 |                         \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM1 break input 2, \
                              TIM8 break input 2 and TIM20 break input 2     \
                              (BKIN2) */
#endif
/* Note: Output redirection specific to COMP instance: COMP1, COMP2, COMP3,
 * COMP7 */
#define LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2_3_7                                  \
  (COMP_CSR_COMPxOUTSEL_2 |                                                    \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM1 OCREF clear      \
                              (specific to COMP instance: COMP1, COMP2, COMP3, \
                              COMP7) */
/* Note: Output redirection specific to COMP instance: COMP1, COMP2, COMP3 */
#define LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2_3                                    \
  (COMP_CSR_COMPxOUTSEL_3 |                                                    \
...
/* Note: Output redirection specific to COMP instance: COMP1, COMP2, COMP4,
 * COMP5 */
#define LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4_5                                  \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_1 |                           \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM3 OCREF clear      \
                              (specific to COMP instance: COMP1, COMP2, COMP4, \
                              COMP5) */
/* Note: Output redirection specific to COMP instance: COMP4, COMP5, COMP6,
 * COMP7 */
#define LL_COMP_OUTPUT_TIM8_OCCLR_COMP4_5_6_7                                  \
  (COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 |                           \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM8 OCREF clear      \
                              (specific to COMP instance: COMP4, COMP5, COMP6, \
                              COMP7) */
/* Note: Output redirection specific to COMP instance: COMP1, COMP2 */
#define LL_COMP_OUTPUT_TIM1_IC1_COMP1_2                                       \
  (COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 |                          \
...
#define LL_COMP_OUTPUT_TIM3_IC1_COMP1_2                                       \
  (COMP_CSR_COMPxOUTSEL_3 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM3 input capture 1 \
                              (specific to COMP instance: COMP2) */
#if defined(STM32F303xE) || defined(STM32F398xx)
#define LL_COMP_OUTPUT_TIM20_OCCLR_COMP2                                      \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 | \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM20 OCREF clear    \
                              (specific to COMP instance: COMP2) */
#endif
/* Note: Output redirection specific to COMP instance: COMP3 */
#define LL_COMP_OUTPUT_TIM3_IC2_COMP3                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM3 input capture 2 \
                              (specific to COMP instance: COMP3) */
#define LL_COMP_OUTPUT_TIM4_IC1_COMP3                                         \
  (COMP_CSR_COMPxOUTSEL_2 | COMP_CSR_COMPxOUTSEL_1 |                          \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM4 input capture 1 \
                              (specific to COMP instance: COMP3) */
#define LL_COMP_OUTPUT_TIM15_IC1_COMP3                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                    \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM15 input capture 1 \
                              (specific to COMP instance: COMP3) */
#define LL_COMP_OUTPUT_TIM15_BKIN_COMP3                                    \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_1 |                       \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM15 break input \
                              (BKIN) */
/* Note: Output redirection specific to COMP instance: COMP4 */
#define LL_COMP_OUTPUT_TIM3_IC3_COMP4                                         \
  (COMP_CSR_COMPxOUTSEL_2 |                                                   \
...
#define LL_COMP_OUTPUT_TIM2_IC1_COMP5                                         \
  (COMP_CSR_COMPxOUTSEL_2 |                                                   \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM2 input capture 1 \
                              (specific to COMP instance: COMP5) */
#define LL_COMP_OUTPUT_TIM4_IC3_COMP5                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                   \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM4 input capture 3 \
                              (specific to COMP instance: COMP5) */
#define LL_COMP_OUTPUT_TIM17_IC1_COMP5                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM17 input capture 1 \
                              (specific to COMP instance: COMP5) */
#define LL_COMP_OUTPUT_TIM16_BKIN_COMP5                                    \
  (COMP_CSR_COMPxOUTSEL_3 |                                                \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM16 break input \
                              (BKIN) */
/* Note: Output redirection specific to COMP instance: COMP6 */
#define LL_COMP_OUTPUT_TIM2_IC2_COMP6                                         \
  (COMP_CSR_COMPxOUTSEL_2 |                                                   \
...
#define LL_COMP_OUTPUT_TIM1_IC2_COMP7                                         \
  (COMP_CSR_COMPxOUTSEL_3 |                                                   \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM2 input capture 1 \
                              (specific to COMP instance: COMP7) */
#define LL_COMP_OUTPUT_TIM2_IC3_COMP7                                         \
  (COMP_CSR_COMPxOUTSEL_3) /*!< COMP output connected to TIM4 input capture 3 \
                              (specific to COMP instance: COMP7) */
#define LL_COMP_OUTPUT_TIM17_OCCLR_COMP7                                   \
  (COMP_CSR_COMPxOUTSEL_3 |                                                \
   COMP_CSR_COMPxOUTSEL_1) /*!< COMP output connected to TIM17 OCREF clear \
                              (specific to COMP instance: COMP7) */
#define LL_COMP_OUTPUT_TIM17_BKIN_COMP7                                    \
  (COMP_CSR_COMPxOUTSEL_3 | COMP_CSR_COMPxOUTSEL_1 |                       \
   COMP_CSR_COMPxOUTSEL_0) /*!< COMP output connected to TIM17 break input \
                              (BKIN) */
...
#define LL_COMP_OUTPUT_TIM1_IC1                                               \
  LL_COMP_OUTPUT_TIM1_IC1_COMP1_2 /*!< COMP output connected to TIM1 input    \
                                     ...
                                     literal definitions above for COMP       \
                                     instance constraints. */
#define LL_COMP_OUTPUT_TIM1_IC2                                               \
  LL_COMP_OUTPUT_TIM1_IC2_COMP7 /*!< COMP output connected to TIM2 input      \
                                   capture 1.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   ...
                                   constraints. */
#define LL_COMP_OUTPUT_TIM1_OCCLR                                              \
  LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2_3_7 /*!< COMP output connected to TIM1     \
                                           OCREF clear.         Caution:       \
                                           Parameter specific to COMP          \
                                           instances, defined with generic     \
                                           naming, not taking into account     \
                                           COMP instance constraints. Refer to \
                                           literal definitions above for COMP  \
                                           instance constraints. */
#define LL_COMP_OUTPUT_TIM2_IC1                                               \
  LL_COMP_OUTPUT_TIM2_IC1_COMP5 /*!< COMP output connected to TIM2 input      \
                                   capture 1.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
...
#define LL_COMP_OUTPUT_TIM2_IC2                                               \
  LL_COMP_OUTPUT_TIM2_IC2_COMP6 /*!< COMP output connected to TIM2 input      \
                                   ...
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM2_IC3                                               \
  LL_COMP_OUTPUT_TIM2_IC3_COMP7 /*!< COMP output connected to TIM4 input      \
                                   capture 3.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
...
#define LL_COMP_OUTPUT_TIM3_IC1                                               \
  LL_COMP_OUTPUT_TIM3_IC1_COMP1_2 /*!< COMP output connected to TIM3 input    \
                                     ...
                                     literal definitions above for COMP       \
                                     instance constraints. */
#define LL_COMP_OUTPUT_TIM3_IC2                                               \
  LL_COMP_OUTPUT_TIM3_IC2_COMP3 /*!< COMP output connected to TIM3 input      \
                                   capture 2.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
...
#define LL_COMP_OUTPUT_TIM3_IC3                                               \
  LL_COMP_OUTPUT_TIM3_IC3_COMP4 /*!< COMP output connected to TIM3 input      \
                                   ...
                                   constraints. */
#define LL_COMP_OUTPUT_TIM3_OCCLR                                              \
  LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4_5 /*!< COMP output connected to TIM3     \
                                           OCREF clear.         Caution:       \
                                           Parameter specific to COMP          \
                                           instances, defined with generic     \
                                           naming, not taking into account     \
                                           ...
                                           literal definitions above for COMP  \
                                           instance constraints. */
#define LL_COMP_OUTPUT_TIM4_IC1                                               \
  LL_COMP_OUTPUT_TIM4_IC1_COMP3 /*!< COMP output connected to TIM4 input      \
                                   capture 1.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
...
#define LL_COMP_OUTPUT_TIM4_IC2                                               \
  LL_COMP_OUTPUT_TIM4_IC2_COMP4 /*!< COMP output connected to TIM4 input      \
                                   ...
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM4_IC3                                               \
  LL_COMP_OUTPUT_TIM4_IC3_COMP5 /*!< COMP output connected to TIM4 input      \
                                   capture 3.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
...
#define LL_COMP_OUTPUT_TIM4_IC4                                               \
  LL_COMP_OUTPUT_TIM4_IC4_COMP6 /*!< COMP output connected to TIM4 input      \
                                   ...
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM8_OCCLR                                              \
  LL_COMP_OUTPUT_TIM8_OCCLR_COMP4_5_6_7 /*!< COMP output connected to TIM8     \
                                           OCREF clear.         Caution:       \
                                           Parameter specific to COMP          \
                                           instances, defined with generic     \
                                           naming, not taking into account     \
                                           ...
                                           literal definitions above for COMP  \
                                           instance constraints. */
#define LL_COMP_OUTPUT_TIM15_IC1                                              \
  LL_COMP_OUTPUT_TIM15_IC1_COMP3 /*!< COMP output connected to TIM15 input    \
                                    capture 1.    Caution: Parameter specific \
                                    to COMP instances, defined with generic   \
                                    naming, not taking into account COMP      \
                                    instance constraints. Refer to literal    \
...
#define LL_COMP_OUTPUT_TIM15_IC2                                              \
  LL_COMP_OUTPUT_TIM15_IC2_COMP4 /*!< COMP output connected to TIM15 input    \
                                    ...
                                    definitions above for COMP instance       \
                                    constraints. */
#define LL_COMP_OUTPUT_TIM15_BKIN                                              \
  LL_COMP_OUTPUT_TIM15_BKIN_COMP3 /*!< COMP output connected to TIM15 break    \
                                     input (BKIN). Caution: Parameter specific \
                                     to COMP instances, defined with generic   \
                                     naming, not taking into account COMP      \
                                     instance constraints. Refer to literal    \
                                     definitions above for COMP instance       \
...
#define LL_COMP_OUTPUT_TIM16_IC1                                              \
  LL_COMP_OUTPUT_TIM16_IC1_COMP6 /*!< COMP output connected to TIM16 input    \
                                    ...
                                    definitions above for COMP instance       \
                                    constraints. */
#define LL_COMP_OUTPUT_TIM16_BKIN                                              \
  LL_COMP_OUTPUT_TIM16_BKIN_COMP5 /*!< COMP output connected to TIM16 break    \
                                     input (BKIN). Caution: Parameter specific \
                                     to COMP instances, defined with generic   \
                                     naming, not taking into account COMP      \
                                     instance constraints. Refer to literal    \
...
#define LL_COMP_OUTPUT_TIM16_OCCLR                                             \
  LL_COMP_OUTPUT_TIM16_OCCLR_COMP6 /*!< COMP output connected to TIM16 OCREF   \
                                      ...
                                      literal definitions above for COMP       \
                                      instance constraints. */
#define LL_COMP_OUTPUT_TIM17_IC1                                              \
  LL_COMP_OUTPUT_TIM17_IC1_COMP5 /*!< COMP output connected to TIM17 input    \
                                    capture 1.    Caution: Parameter specific \
                                    to COMP instances, defined with generic   \
                                    naming, not taking into account COMP      \
                                    instance constraints. Refer to literal    \
...
#define LL_COMP_OUTPUT_TIM17_BKIN                                              \
  LL_COMP_OUTPUT_TIM17_BKIN_COMP7 /*!< COMP output connected to TIM17 break    \
                                     input (BKIN). Caution: Parameter specific \
                                     to COMP instances, defined with generic   \
                                     naming, not taking into account COMP      \
                                     instance constraints. Refer to literal    \
                                     definitions above for COMP instance       \
                                     constraints. */
#define LL_COMP_OUTPUT_TIM17_OCCLR                                             \
  LL_COMP_OUTPUT_TIM17_OCCLR_COMP7 /*!< COMP output connected to TIM17 OCREF   \
                                      clear.        Caution: Parameter         \
                                      specific to COMP instances, defined with \
                                      generic naming, not taking into account  \
                                      COMP instance constraints. Refer to      \
                                      ...
                                      instance constraints. */
#if defined(STM32F303xE) || defined(STM32F398xx)
#define LL_COMP_OUTPUT_TIM20_OCCLR                                             \
  LL_COMP_OUTPUT_TIM20_OCCLR_COMP2 /*!< COMP output connected to TIM20 OCREF   \
                                      clear.        Caution: Parameter         \
                                      specific to COMP instances, defined with \
                                      generic naming, not taking into account  \
                                      COMP instance constraints. Refer to      \
...
#define LL_COMP_OUTPUTPOL_NONINVERTED                                          \
  ((uint32_t)0x00000000U) /*!< COMP output polarity is not inverted:           \
                             comparator output is high when the plus           \
                             (non-inverting) input is at a higher voltage than \
                             the minus (inverting) input */
#define LL_COMP_OUTPUTPOL_INVERTED                                             \
  (COMP_CSR_COMPxPOL) /*!< COMP output polarity is inverted: comparator output \
...
#define LL_COMP_BLANKINGSRC_NONE \
  ((uint32_t)0x00000000U) /*!<Comparator output without blanking */
...
#define LL_COMP_BLANKINGSRC_TIM1_OC5_COMP2                                   \
  (COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM1 OC5 \
                                (specific to COMP instance: COMP2) */
#define LL_COMP_BLANKINGSRC_TIM2_OC3_COMP2                                   \
  (COMP_CSR_COMPxBLANKING_1) /*!< Comparator output blanking source TIM2 OC3 \
                                (specific to COMP instance: COMP2) */
#define LL_COMP_BLANKINGSRC_TIM3_OC3_COMP2                                   \
  (COMP_CSR_COMPxBLANKING_1 |                                                \
   COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM3 OC3 \
                                (specific to COMP instance: COMP2) */
/* Note: Output blanking source specific to COMP instance: COMP4 */
#define LL_COMP_BLANKINGSRC_TIM3_OC4_COMP4                                   \
  (COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM3 OC4 \
                                (specific to COMP instance: COMP4) */
#define LL_COMP_BLANKINGSRC_TIM15_OC1_COMP4                                   \
  (COMP_CSR_COMPxBLANKING_0 |                                                 \
   COMP_CSR_COMPxBLANKING_1) /*!< Comparator output blanking source TIM15 OC1 \
                                (specific to COMP instance: COMP4) */
/* Note: Output blanking source specific to COMP instance: COMP6 */
#define LL_COMP_BLANKINGSRC_TIM2_OC4_COMP6                                   \
  (COMP_CSR_COMPxBLANKING_0 |                                                \
   COMP_CSR_COMPxBLANKING_1) /*!< Comparator output blanking source TIM2 OC4 \
                                (specific to COMP instance: COMP6) */
#define LL_COMP_BLANKINGSRC_TIM15_OC2_COMP6                                   \
  (COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM15 OC2 \
                                (specific to COMP instance: COMP6) */
...
#define LL_COMP_BLANKINGSRC_TIM1_OC5                                           \
  LL_COMP_BLANKINGSRC_TIM1_OC5_COMP2 /*!< Comparator output blanking source    \
                                        TIM1 OC5.  Caution: Parameter specific \
                                        to COMP instances, defined with        \
                                        generic naming, not taking into        \
                                        account COMP instance constraints.     \
                                        Refer to literal definitions above for \
                                        COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM2_OC3                                           \
  LL_COMP_BLANKINGSRC_TIM2_OC3_COMP2 /*!< Comparator output blanking source    \
                                        TIM2 OC3.  Caution: Parameter specific \
                                        to COMP instances, defined with        \
                                        generic naming, not taking into        \
                                        account COMP instance constraints.     \
                                        Refer to literal definitions above for \
                                        COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM2_OC4                                           \
  LL_COMP_BLANKINGSRC_TIM2_OC4_COMP6 /*!< Comparator output blanking source    \
                                        TIM2 OC4.  Caution: Parameter specific \
                                        to COMP instances, defined with        \
                                        generic naming, not taking into        \
                                        account COMP instance constraints.     \
                                        Refer to literal definitions above for \
...
#define LL_COMP_BLANKINGSRC_TIM3_OC3                                           \
  LL_COMP_BLANKINGSRC_TIM3_OC3_COMP2 /*!< Comparator output blanking source    \
                                        TIM3 OC3.  Caution: Parameter specific \
                                        to COMP instances, defined with        \
                                        generic naming, not taking into        \
                                        account COMP instance constraints.     \
                                        Refer to literal definitions above for \
...
#define LL_COMP_BLANKINGSRC_TIM3_OC4                                           \
  LL_COMP_BLANKINGSRC_TIM3_OC4_COMP4 /*!< Comparator output blanking source    \
                                        TIM3 OC4.  Caution: Parameter specific \
                                        to COMP instances, defined with        \
                                        generic naming, not taking into        \
                                        account COMP instance constraints.     \
                                        Refer to literal definitions above for \
...
#define LL_COMP_BLANKINGSRC_TIM15_OC1                                         \
  LL_COMP_BLANKINGSRC_TIM15_OC1_COMP4 /*!< Comparator output blanking source  \
                                         TIM15 OC1. Caution: Parameter        \
                                         specific to COMP instances, defined  \
                                         with generic naming, not taking into \
                                         account COMP instance constraints.   \
                                         Refer to literal definitions above   \
                                         for COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM15_OC2                                         \
  LL_COMP_BLANKINGSRC_TIM15_OC2_COMP6 /*!< Comparator output blanking source  \
                                         TIM15 OC2. Caution: Parameter        \
                                         specific to COMP instances, defined  \
                                         with generic naming, not taking into \
                                         account COMP instance constraints.   \
                                         Refer to literal definitions above   \
...
#define LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1_2                                 \
  (COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM1 OC5 \
                                (specific to COMP instance: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM2_OC3_COMP1_2                                 \
  (COMP_CSR_COMPxBLANKING_1) /*!< Comparator output blanking source TIM2 OC3 \
                                (specific to COMP instance: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM3_OC3_COMP1_2                                 \
  (COMP_CSR_COMPxBLANKING_1 |                                                \
   COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM3 OC3 \
                                (specific to COMP instance: COMP1, COMP2) */
/* Note: Output blanking source specific to COMP instance: COMP4 */
...
/*       Refer to literal definitions above for COMP instance constraints.    */
#define LL_COMP_BLANKINGSRC_TIM1_OC5                                           \
  LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1_2 /*!< Comparator output blanking source  \
                                          TIM1 OC5.  Caution: Parameter        \
                                          specific to COMP instances, defined  \
                                          with generic naming, not taking into \
                                          account COMP instance constraints.   \
                                          Refer to literal definitions above   \
                                          for COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM2_OC3                                           \
  LL_COMP_BLANKINGSRC_TIM2_OC3_COMP1_2 /*!< Comparator output blanking source  \
                                          TIM2 OC3.  Caution: Parameter        \
                                          specific to COMP instances, defined  \
                                          with generic naming, not taking into \
                                          account COMP instance constraints.   \
                                          Refer to literal definitions above   \
...
#define LL_COMP_BLANKINGSRC_TIM2_OC4                                           \
  LL_COMP_BLANKINGSRC_TIM2_OC4_COMP6 /*!< Comparator output blanking source    \
                                        ...
                                        COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM3_OC3                                           \
  LL_COMP_BLANKINGSRC_TIM3_OC3_COMP1_2 /*!< Comparator output blanking source  \
                                          TIM3 OC3.  Caution: Parameter        \
                                          specific to COMP instances, defined  \
                                          with generic naming, not taking into \
                                          account COMP instance constraints.   \
                                          Refer to literal definitions above   \
...
#elif defined(STM32F303xE) || defined(STM32F398xx) || defined(STM32F303xC) || \
    defined(STM32F358xx)
/* Note: Output blanking source specific to COMP instance: COMP1, COMP2, COMP7
 */
#define LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1_2_7                               \
  (COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM1 OC5 \
                                (specific to COMP instance: COMP1, COMP2,    \
                                COMP7) */
/* Note: Output blanking source specific to COMP instance: COMP1, COMP2 */
...
#define LL_COMP_BLANKINGSRC_TIM2_OC4_COMP3_6                                 \
  (COMP_CSR_COMPxBLANKING_1 |                                                \
   COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM2 OC4 \
                                (specific to COMP instance: COMP3, COMP6) */
/* Note: Output blanking source specific to COMP instance: COMP4, COMP5, COMP6,
 * COMP7 */
#define LL_COMP_BLANKINGSRC_TIM8_OC5_COMP4_5_6_7                             \
  (COMP_CSR_COMPxBLANKING_1) /*!< Comparator output blanking source TIM8 OC5 \
                                (specific to COMP instance: COMP4, COMP5,    \
                                COMP6, COMP7) */
/* Note: Output blanling source specific to COMP instance: COMP6, COMP7 */
#define LL_COMP_BLANKINGSRC_TIM15_OC2_COMP6_7                                 \
  (COMP_CSR_COMPxBLANKING_2) /*!< Comparator output blanking source TIM15 OC2 \
                                (specific to COMP instance: COMP6, COMP7) */
/* Note: Output blanking source specific to COMP instance: COMP4 */
#define LL_COMP_BLANKINGSRC_TIM3_OC4_COMP4                                   \
  (COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM3 OC4 \
                                (specific to COMP instance: COMP4) */
#define LL_COMP_BLANKINGSRC_TIM15_OC1_COMP4                                   \
  (COMP_CSR_COMPxBLANKING_1 |                                                 \
   COMP_CSR_COMPxBLANKING_0) /*!< Comparator output blanking source TIM15 OC1 \
                                (specific to COMP instance: COMP4) */
...
/*       Refer to literal definitions above for COMP instance constraints.    */
#define LL_COMP_BLANKINGSRC_TIM1_OC5                                         \
  LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1_2_7 /*!< Comparator output blanking     \
                                            source TIM1 OC5.  Caution:       \
                                            Parameter specific to COMP       \
                                            instances, defined with generic  \
                                            naming, not taking into account  \
                                            COMP instance constraints. Refer \
                                            to literal definitions above for \
                                            COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM2_OC3                                           \
  LL_COMP_BLANKINGSRC_TIM2_OC3_COMP1_2 /*!< Comparator output blanking source  \
                                          TIM2 OC3.  Caution: Parameter        \
                                          ...
                                          for COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM2_OC4                                           \
  LL_COMP_BLANKINGSRC_TIM2_OC4_COMP3_6 /*!< Comparator output blanking source  \
                                          TIM2 OC4.  Caution: Parameter        \
                                          specific to COMP instances, defined  \
                                          with generic naming, not taking into \
                                          account COMP instance constraints.   \
                                          Refer to literal definitions above   \
...
#define LL_COMP_BLANKINGSRC_TIM15_OC1                                         \
  LL_COMP_BLANKINGSRC_TIM15_OC1_COMP4 /*!< Comparator output blanking source  \
                                         ...
                                         for COMP instance constraints. */
#define LL_COMP_BLANKINGSRC_TIM15_OC2                                          \
  LL_COMP_BLANKINGSRC_TIM15_OC2_COMP6_7 /*!< Comparator output blanking source \
                                           TIM15 OC2. Caution: Parameter       \
                                           specific to COMP instances, defined \
                                           with generic naming, not taking     \
                                           into account COMP instance          \
                                           constraints. Refer to literal       \
                                           definitions above for COMP instance \
                                           constraints. */
...
#define LL_COMP_OUTPUT_LEVEL_LOW                                               \
  ((uint32_t)0x00000000U) /*!< Comparator output level low (if the polarity is \
                             not inverted, otherwise to be complemented) */
#define LL_COMP_OUTPUT_LEVEL_HIGH                                            \
  ((uint32_t)0x00000001U) /*!< Comparator output level high (if the polarity \
...
#define LL_COMP_DELAY_STARTUP_US \
  ((uint32_t)60U) /*!< Delay for COMP startup time */
#else
#define LL_COMP_DELAY_STARTUP_US \
  ((uint32_t)10U) /*!< Delay for COMP startup time */
#endif
...
#define __LL_COMP_COMMON_INSTANCE(__COMPx__)                              \
  ((((__COMPx__) == COMP1) || ((__COMPx__) == COMP2)) ? ((COMP12_COMMON)) \
                                                      : (((uint32_t)0U)))
...
#define __LL_COMP_COMMON_INSTANCE(__COMPx__) ((uint32_t)0U)
#endif
 ...
 *
 *         (1) Parameter available on devices: STM32F302xB/C, STM32F303xB/C,
 * STM32F358xC (2) Parameter available on devices: STM32F303xB/C, STM32F358xC
 * @retval None
 */
 ...
 *
 *         (1) Parameter available only on devices: STM32F302xB/C,
 * STM32F303xB/C, STM32F358xC
 * @retval None
 */
 ...
 *         (1) Parameter available on all devices except STM32F301x6/8,
 * STM32F318x8, STM32F302x6/8, STM32F303x6/8, STM32F328xx, STM32F334xx.\n (2)
 * Parameter available only on devices STM32F303x6/8, STM32F328x8,
 * STM32F334xx.\n (3) Parameter available on all devices except STM32F301x6/8,
 * STM32F318x8, STM32F302xx.\n
 ...
 *
 *         (1) Parameter available only on devices STM32F302xB/C, STM32F303xB/C,
 * STM32F358xC.\n (2) Parameter available on devices: STM32F302xB/C,
 * STM32F302xD/E, STM32F303xB/C/D/E, STM32F358xC, STM32F398xE.\n (3) Parameter
 * available on devices: STM32F301x6/8, STM32F318xx, STM32F302x6/8.
 * @retval None
 */
__STATIC_INLINE void LL_COMP_ConfigInputs(COMP_TypeDef *COMPx,
  ...
  MODIFY_REG(COMPx->CSR, COMP_CSR_COMPxINSEL | COMP_CSR_COMPxNONINSEL,
             InputMinus | InputPlus);
#elif defined(COMP_CSR_COMPxSW1)
  MODIFY_REG(COMPx->CSR, COMP_CSR_COMPxINSEL | COMP_CSR_COMPxSW1,
             InputMinus | InputPlus);
#else
...
__STATIC_INLINE void LL_COMP_SetInputPlus(COMP_TypeDef *COMPx,
                                          uint32_t InputPlus) {
#if defined(COMP_CSR_COMPxNONINSEL) && defined(COMP_CSR_COMPxSW1)
  MODIFY_REG(COMPx->CSR, (COMP_CSR_COMPxNONINSEL | COMP_CSR_COMPxSW1),
             InputPlus);
#elif defined(COMP_CSR_COMPxNONINSEL)
...
__STATIC_INLINE uint32_t LL_COMP_GetInputPlus(COMP_TypeDef *COMPx) {
  ...
  return (uint32_t)(READ_BIT(COMPx->CSR,
                             (COMP_CSR_COMPxNONINSEL | COMP_CSR_COMPxSW1)));
#elif defined(COMP_CSR_COMPxNONINSEL)
 ...
 *
 *         (1) Parameter available on devices: STM32F302x8, STM32F318xx,
 * STM32F303x8, STM32F328xx, STM32F334x8, STM32F302xC, STM32F302xE, STM32F303xC,
 * STM32F358xx, STM32F303xE, STM32F398xx.\n (2) Parameter available on devices:
 * STM32F301x8, STM32F302x8, STM32F318xx, STM32F303x8, STM32F328xx,
 * STM32F334x8.\n (3) Parameter available on devices: STM32F302xC, STM32F302xE,
 * STM32F303xC, STM32F358xx, STM32F303xE, STM32F398xx.\n (4) Parameter available
 * on devices: STM32F303xC, STM32F358xx, STM32F303xE, STM32F398xx.\n (5)
 * Parameter available on devices: STM32F303xE, STM32F398xx.\n (6) Parameter
 * available on devices: STM32F303x8, STM32F328xx, STM32F334x8.
 * @retval None
 */
 ...
 *
 *         (1) Parameter available on devices: STM32F301x8, STM32F302x8,
 * STM32F318xx, STM32F303x8, STM32F334x8, STM32F328xx.\n (2) Parameter available
 * on devices: STM32F302xE, STM32F302xC.\n (3) Parameter available on devices:
 * STM32F303xE, STM32F398xx, STM32F303xC, STM32F358xx.
 * @retval None
 */
...
#endif /* STM32F301x8 || STM32F302x8 || STM32F302xC || STM32F302xE || \
          STM32F303x8 || STM32F303xC || STM32F303xE || STM32F318xx || \
          STM32F328xx || STM32F334x8 || STM32F358xx || STM32F398xx */
...
#define LL_COMP_WINDOWMODE_DISABLE                                          \
  ((uint32_t)0x00000000U) /*!< Window mode disable: Comparators 1 and 2 are \
                             independent */
#define LL_COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                             \
  (COMP_CSR_WNDWEN) /*!< Window mode enable: Comparators instances pair COMP1  \
                       and COMP2 have their input plus connected together. The \
                       common input is COMP1 input plus (COMP2 input plus is   \
                       no more accessible). */
/**
 * @}
 */
...
#define LL_COMP_INPUT_MINUS_DAC1_CH1                                    \
  (COMP_CSR_COMP1INSEL_2) /*!< Comparator input minus connected to DAC1 \
                             channel 1 (DAC_OUT1)  */
#define LL_COMP_INPUT_MINUS_DAC1_CH2                                    \
  (COMP_CSR_COMP1INSEL_2 |                                              \
   COMP_CSR_COMP1INSEL_0) /*!< Comparator input minus connected to DAC1 \
                             channel 2 (DAC_OUT2)  */
#define LL_COMP_INPUT_MINUS_IO1                                             \
  (COMP_CSR_COMP1INSEL_2 |                                                  \
   COMP_CSR_COMP1INSEL_1) /*!< Comparator input minus connected to IO1 (pin \
                             PA0 for COMP1, pin PA2 for COMP2) */
#define LL_COMP_INPUT_MINUS_IO2                                             \
  (COMP_CSR_COMP1INSEL_2 | COMP_CSR_COMP1INSEL_1 |                          \
   COMP_CSR_COMP1INSEL_0) /*!< Comparator input minus connected to IO2 (pin \
                             PA6 for COMP1 & COMP2) */
#define LL_COMP_INPUT_MINUS_IO3                                             \
  (COMP_CSR_COMP1INSEL_2 |                                                  \
   COMP_CSR_COMP1INSEL_0) /*!< Comparator input minus connected to IO3 (pin \
                             PA5 for COMP1 & COMP2) */
#define LL_COMP_INPUT_MINUS_IO4                                             \
  (COMP_CSR_COMP1INSEL_2) /*!< Comparator input minus connected to IO4 (pin \
                             PA4 for COMP1 & COMP2) */
#define LL_COMP_INPUT_MINUS_DAC2_CH1                                    \
  (COMP_CSR_COMP1INSEL_2 | COMP_CSR_COMP1INSEL_1 |                      \
   COMP_CSR_COMP1INSEL_0) /*!< Comparator input minus connected to DAC2 \
                             channel 1 (DAC2_OUT1)  */
/**
 * @}
 */
...
#define LL_COMP_OUTPUT_NONE                                                    \
  ((uint32_t)0x00000000U) /*!< COMP output is not connected to other           \
                             peripherals (except GPIO and EXTI that are always \
                             connected to COMP output) */
#define LL_COMP_OUTPUT_TIM2_IC4                                               \
...
#define LL_COMP_OUTPUT_TIM15_BKIN_COMP1                                    \
  (COMP_CSR_COMP1OUTSEL_0) /*!< COMP output connected to TIM15 break input \
                              (BKIN) (specific to COMP instance: COMP1) */
#define LL_COMP_OUTPUT_TIM3_IC1_COMP1                                         \
  (COMP_CSR_COMP1OUTSEL_1) /*!< COMP output connected to TIM3 input capture 1 \
                              (specific to COMP instance: COMP1) */
#define LL_COMP_OUTPUT_TIM3_OCCLR_COMP1                                   \
  (COMP_CSR_COMP1OUTSEL_1 |                                               \
   COMP_CSR_COMP1OUTSEL_0) /*!< COMP output connected to TIM3 OCREF clear \
                              (specific to COMP instance: COMP1) */
#define LL_COMP_OUTPUT_TIM5_IC4_COMP1                                         \
  (COMP_CSR_COMP1OUTSEL_2 |                                                   \
   COMP_CSR_COMP1OUTSEL_1) /*!< COMP output connected to TIM5 input capture 4 \
                              (specific to COMP instance: COMP1) */
#define LL_COMP_OUTPUT_TIM5_OCCLR_COMP1                                   \
  (COMP_CSR_COMP1OUTSEL_2 | COMP_CSR_COMP1OUTSEL_1 |                      \
   COMP_CSR_COMP1OUTSEL_0) /*!< COMP output connected to TIM5 OCREF clear \
                              (specific to COMP instance: COMP1) */

/* Note: Output redirection specific to COMP instance: COMP2 */
#define LL_COMP_OUTPUT_TIM16_BKIN_COMP2                                    \
  (COMP_CSR_COMP1OUTSEL_0) /*!< COMP output connected to TIM16 break input \
                              (BKIN) (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM4_IC1_COMP2                                         \
  (COMP_CSR_COMP1OUTSEL_1) /*!< COMP output connected to TIM4 input capture 1 \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM4_OCCLR_COMP2                                   \
  (COMP_CSR_COMP1OUTSEL_1 |                                               \
   COMP_CSR_COMP1OUTSEL_0) /*!< COMP output connected to TIM4 OCREF clear \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM3_IC1_COMP2                                         \
  (COMP_CSR_COMP1OUTSEL_2 |                                                   \
   COMP_CSR_COMP1OUTSEL_1) /*!< COMP output connected to TIM3 input capture 1 \
                              (specific to COMP instance: COMP2) */
#define LL_COMP_OUTPUT_TIM3_OCCLR_COMP2                                   \
  (COMP_CSR_COMP1OUTSEL_2 | COMP_CSR_COMP1OUTSEL_1 |                      \
   COMP_CSR_COMP1OUTSEL_0) /*!< COMP output connected to TIM3 OCREF clear \
                              (specific to COMP instance: COMP2) */
...
#define LL_COMP_OUTPUT_TIM15_BKIN                                              \
  LL_COMP_OUTPUT_TIM15_BKIN_COMP1 /*!< COMP output connected to TIM15 break    \
                                     input (BKIN). Caution: Parameter specific \
                                     to COMP instances, defined with generic   \
                                     naming, not taking into account COMP      \
                                     instance constraints. Refer to literal    \
                                     ...
                                     constraints. */
#define LL_COMP_OUTPUT_TIM16_BKIN                                              \
  LL_COMP_OUTPUT_TIM16_BKIN_COMP2 /*!< COMP output connected to TIM16 break    \
                                     input (BKIN). Caution: Parameter specific \
                                     to COMP instances, defined with generic   \
                                     naming, not taking into account COMP      \
                                     instance constraints. Refer to literal    \
                                     ...
                                     constraints. */
#define LL_COMP_OUTPUT_TIM4_IC1                                               \
  LL_COMP_OUTPUT_TIM4_IC1_COMP2 /*!< COMP output connected to TIM4 input      \
                                   capture 1.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM4_OCCLR                                             \
  LL_COMP_OUTPUT_TIM4_OCCLR_COMP2 /*!< COMP output connected to TIM4 OCREF    \
                                     ...
                                     literal definitions above for COMP       \
                                     instance constraints. */
#define LL_COMP_OUTPUT_TIM5_IC4                                               \
  LL_COMP_OUTPUT_TIM5_IC1_COMP1 /*!< COMP output connected to TIM5 input      \
                                   capture 4.     Caution: Parameter specific \
                                   to COMP instances, defined with generic    \
                                   naming, not taking into account COMP       \
                                   instance constraints. Refer to literal     \
                                   definitions above for COMP instance        \
                                   constraints. */
#define LL_COMP_OUTPUT_TIM5_OCCLR                                             \
  LL_COMP_OUTPUT_TIM5_OCCLR_COMP1 /*!< COMP output connected to TIM5 OCREF    \
                                     clear.         Caution: Parameter        \
                                     specific to COMP instances, defined with \
                                     generic naming, not taking into account  \
                                     COMP instance constraints. Refer to      \
...
#define LL_COMP_OUTPUTPOL_NONINVERTED                                          \
  ((uint32_t)0x00000000U) /*!< COMP output polarity is not inverted:           \
                             ...
                             the minus (inverting) input */
#define LL_COMP_OUTPUTPOL_INVERTED                                             \
  (COMP_CSR_COMP1POL) /*!< COMP output polarity is inverted: comparator output \
                         is low when the plus (non-inverting) input is at a    \
                         lower voltage than the minus (inverting) input */
/**
 * @}
...
__STATIC_INLINE uint32_t LL_COMP_GetPowerMode(COMP_TypeDef *COMPx) {
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1MODE
...
__STATIC_INLINE uint32_t LL_COMP_GetInputPlus(COMP_TypeDef *COMPx) {
  ...
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1SW1
                                        << __COMP_BITOFFSET_INSTANCE(COMPx)) >>
                __COMP_BITOFFSET_INSTANCE(COMPx));
}
...
__STATIC_INLINE uint32_t LL_COMP_GetInputMinus(COMP_TypeDef *COMPx) {
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1INSEL
                                        << __COMP_BITOFFSET_INSTANCE(COMPx)) >>
                __COMP_BITOFFSET_INSTANCE(COMPx));
}
...
__STATIC_INLINE uint32_t LL_COMP_GetInputHysteresis(COMP_TypeDef *COMPx) {
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1HYST
                                        << __COMP_BITOFFSET_INSTANCE(COMPx)) >>
                __COMP_BITOFFSET_INSTANCE(COMPx));
}
...
__STATIC_INLINE uint32_t LL_COMP_GetOutputSelection(COMP_TypeDef *COMPx) {
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1OUTSEL
                                        << __COMP_BITOFFSET_INSTANCE(COMPx)) >>
                __COMP_BITOFFSET_INSTANCE(COMPx));
}
...
__STATIC_INLINE uint32_t LL_COMP_GetOutputPolarity(COMP_TypeDef *COMPx) {
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1POL
                                        << __COMP_BITOFFSET_INSTANCE(COMPx)) >>
                __COMP_BITOFFSET_INSTANCE(COMPx));
}
...
__STATIC_INLINE uint32_t LL_COMP_ReadOutputLevel(COMP_TypeDef *COMPx) {
  return (
      uint32_t)(READ_BIT(COMP->CSR, COMP_CSR_COMP1OUT
                                        << __COMP_BITOFFSET_INSTANCE(COMPx)) >>
                (__COMP_BITOFFSET_INSTANCE(COMPx) +
                 LL_COMP_OUTPUT_LEVEL_BITOFFSET_POS));
}
