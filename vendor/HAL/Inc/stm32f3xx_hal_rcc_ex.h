...
#define IS_RCC_ADC1PLLCLK_DIV(ADCCLK)                                          \
  (((ADCCLK) == RCC_ADC1PLLCLK_OFF) || ((ADCCLK) == RCC_ADC1PLLCLK_DIV1) ||    \
   ...
   ((ADCCLK) == RCC_ADC1PLLCLK_DIV128) || ((ADCCLK) == RCC_ADC1PLLCLK_DIV256))
#define IS_RCC_I2SCLKSOURCE(SOURCE) \
  (((SOURCE) == RCC_I2SCLKSOURCE_SYSCLK) || ((SOURCE) == RCC_I2SCLKSOURCE_EXT))
 ...
 * clock This parameter must be a number between RCC_PLL_MUL2 and RCC_PLL_MUL16.
 *
 */
 ...
 * ADC1 clock
 *            @arg @ref RCC_ADC1PLLCLK_DIV10 PLL clock divided by 10 selected as
 * ADC1 clock
 *            @arg @ref RCC_ADC1PLLCLK_DIV12 PLL clock divided by 12 selected as
 * ADC1 clock
 *            @arg @ref RCC_ADC1PLLCLK_DIV16 PLL clock divided by 16 selected as
 * ADC1 clock
 *            @arg @ref RCC_ADC1PLLCLK_DIV32 PLL clock divided by 32 selected as
 * ADC1 clock
 *            @arg @ref RCC_ADC1PLLCLK_DIV64 PLL clock divided by 64 selected as
 * ADC1 clock
 ...
 * as ADC1 & ADC2 clock
 *            @arg @ref RCC_ADC12PLLCLK_DIV128 PLL clock divided by 128 selected
 * as ADC1 & ADC2 clock
 *            @arg @ref RCC_ADC12PLLCLK_DIV256 PLL clock divided by 256 selected
 * as ADC1 & ADC2 clock
 */
 ...
 *            @arg @ref RCC_UART4CLKSOURCE_SYSCLK System Clock selected as UART4
 * clock
 ...
 *            @arg @ref RCC_UART5CLKSOURCE_SYSCLK System Clock selected as UART5
 * clock
 ...
 * as ADC3 & ADC4 clock
 *            @arg @ref RCC_ADC34PLLCLK_DIV128 PLL clock divided by 128 selected
 * as ADC3 & ADC4 clock
 *            @arg @ref RCC_ADC34PLLCLK_DIV256 PLL clock divided by 256 selected
 * as ADC3 & ADC4 clock
 */
