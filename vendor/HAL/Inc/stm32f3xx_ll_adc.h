...
#define ADC_REG_RANK_1_SQRX_BITOFFSET_POS \
  ((uint32_t)6U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ1) */
#define ADC_REG_RANK_2_SQRX_BITOFFSET_POS \
  ((uint32_t)12U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ2) */
#define ADC_REG_RANK_3_SQRX_BITOFFSET_POS \
  ((uint32_t)18U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ3) */
#define ADC_REG_RANK_4_SQRX_BITOFFSET_POS \
  ((uint32_t)24U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ4) */
#define ADC_REG_RANK_5_SQRX_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ5) */
#define ADC_REG_RANK_6_SQRX_BITOFFSET_POS \
  ((uint32_t)6U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ6) */
#define ADC_REG_RANK_7_SQRX_BITOFFSET_POS \
  ((uint32_t)12U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ7) */
#define ADC_REG_RANK_8_SQRX_BITOFFSET_POS \
  ((uint32_t)18U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ8) */
#define ADC_REG_RANK_9_SQRX_BITOFFSET_POS \
  ((uint32_t)24U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ9) */
#define ADC_REG_RANK_10_SQRX_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ10) */
#define ADC_REG_RANK_11_SQRX_BITOFFSET_POS \
  ((uint32_t)6U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ11) */
#define ADC_REG_RANK_12_SQRX_BITOFFSET_POS \
  ((uint32_t)12U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ12) */
#define ADC_REG_RANK_13_SQRX_BITOFFSET_POS \
  ((uint32_t)18U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ13) */
#define ADC_REG_RANK_14_SQRX_BITOFFSET_POS \
  ((uint32_t)24U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ14) */
#define ADC_REG_RANK_15_SQRX_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_SQR4_SQ15) */
#define ADC_REG_RANK_16_SQRX_BITOFFSET_POS \
  ((uint32_t)6U) /* Value equivalent to POSITION_VAL(ADC_SQR4_SQ16) */
...
#define ADC_INJ_RANK_1_JSQR_BITOFFSET_POS \
  ((uint32_t)8U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ1) */
#define ADC_INJ_RANK_2_JSQR_BITOFFSET_POS \
  ((uint32_t)14U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ2) */
#define ADC_INJ_RANK_3_JSQR_BITOFFSET_POS \
  ((uint32_t)20U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ3) */
#define ADC_INJ_RANK_4_JSQR_BITOFFSET_POS \
  ((uint32_t)26U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ4) */
...
#define ADC_REG_TRIG_SOURCE_MASK                                         \
  (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CFGR_EXTSEL) << (4U * 0U)) |         \
   ((ADC_CFGR_EXTSEL) << (4U * 1U)) | ((ADC_CFGR_EXTSEL) << (4U * 2U)) | \
...
#define ADC_REG_TRIG_EXTSEL_BITOFFSET_POS \
  ((uint32_t)6U) /* Value equivalent to POSITION_VAL(ADC_CFGR_EXTSEL) */
#define ADC_REG_TRIG_EXTEN_BITOFFSET_POS \
  ((uint32_t)10U) /* Value equivalent to POSITION_VAL(ADC_CFGR_EXTEN) */
...
#if defined(STM32F303xC) || defined(STM32F358xx) || defined(STM32F303xE) || \
    defined(STM32F398xx)
/* Internal mask offset for ADC group injected trigger sources                */
/* available only on specific ADC instances.                                  */
/* (offset placed into a spare area of literal definition) */
#define ADC_REG_TRIG_EXT_INST_ADC12                                           \
  ((uint32_t)0x00000001U) /* Marker for differentiation of ADC group regular  \
                             external trigger available only on ADC instance: \
                             ADC1, ADC2 */
#define ADC_REG_TRIG_EXT_INST_ADC34                                           \
  ((uint32_t)0x00000002U) /* Marker for differentiation of ADC group regular  \
                             external trigger available only on ADC instance: \
                             ADC3, ADC4 */
#endif
...
#define ADC_INJ_TRIG_SOURCE_MASK                                           \
  (((LL_ADC_INJ_TRIG_SOFTWARE & ADC_JSQR_JEXTSEL) << (4U * 0U)) |          \
   ((ADC_JSQR_JEXTSEL) << (4U * 1U)) | ((ADC_JSQR_JEXTSEL) << (4U * 2U)) | \
...
#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS \
  ((uint32_t)2U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JEXTSEL) */
#define ADC_INJ_TRIG_EXTEN_BITOFFSET_POS \
  ((uint32_t)6U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JEXTEN) */
...
/* available only on specific ADC instances.                                  */
/* (offset placed into a spare area of literal definition) */
#define ADC_INJ_TRIG_EXT_INST_ADC12                                           \
  ((uint32_t)0x00000001U) /* Marker for differentiation of ADC group injected \
                             external trigger available only on ADC instance: \
                             ADC1, ADC2 */
#define ADC_INJ_TRIG_EXT_INST_ADC34                                           \
  ((uint32_t)0x00000002U) /* Marker for differentiation of ADC group injected \
                             external trigger available only on ADC instance: \
                             ADC3, ADC4 */
#endif
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS \
  ((uint32_t)26U) /* Value equivalent to    \
                     POSITION_VAL(ADC_CHANNEL_ID_NUMBER_MASK) */
...
#define ADC_CHANNEL_ID_INTERNAL_CH \
  ((uint32_t)0x80000000U) /* Marker of internal channel */
#define ADC_CHANNEL_ID_INTERNAL_CH_2                                      \
  ((uint32_t)0x00080000U) /* Marker of internal channel for other ADC     \
                             instances, in case of different ADC internal \
                             channels mapped on same channel number on    \
                             different ADC instances */
...
#define ADC_CHANNEL_SMPx_BITOFFSET_POS   \
  ((uint32_t)20U) /* Value equivalent to \
                     POSITION_VAL(ADC_CHANNEL_SMPx_BITOFFSET_MASK) */
  ...
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)0U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP0) */
#define ADC_CHANNEL_1_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)3U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP1) */
#define ADC_CHANNEL_2_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)6U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP2) */
#define ADC_CHANNEL_3_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)9U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP3) */
#define ADC_CHANNEL_4_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)12U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP4) */
#define ADC_CHANNEL_5_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)15U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP5) */
#define ADC_CHANNEL_6_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)18U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP6) */
#define ADC_CHANNEL_7_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)21U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP7) */
#define ADC_CHANNEL_8_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)24U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP8) */
#define ADC_CHANNEL_9_SMP                                                 \
  (ADC_SMPR1_REGOFFSET |                                                  \
   (((uint32_t)27U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP9) */
#define ADC_CHANNEL_10_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)0U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP10) */
#define ADC_CHANNEL_11_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)3U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP11) */
#define ADC_CHANNEL_12_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)6U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP12) */
#define ADC_CHANNEL_13_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)9U)                                                        \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP13) */
#define ADC_CHANNEL_14_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)12U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP14) */
#define ADC_CHANNEL_15_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)15U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP15) */
#define ADC_CHANNEL_16_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)18U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP16) */
#define ADC_CHANNEL_17_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)21U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP17) */
#define ADC_CHANNEL_18_SMP                                                \
  (ADC_SMPR2_REGOFFSET |                                                  \
   (((uint32_t)24U)                                                       \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP18) */
...
#define ADC_CFGR_RES_BITOFFSET_POS \
  ((uint32_t)3U) /* Value equivalent to POSITION_VAL(ADC_CFGR_RES) */
#define ADC_CFGR_AWD1SGL_BITOFFSET_POS \
  ((uint32_t)22U) /* Value equivalent to POSITION_VAL(ADC_CFGR_AWD1SGL) */
#define ADC_CFGR_AWD1EN_BITOFFSET_POS \
  ((uint32_t)23U) /* Value equivalent to POSITION_VAL(ADC_CFGR_AWD1EN) */
#define ADC_CFGR_JAWD1EN_BITOFFSET_POS \
  ((uint32_t)24U) /* Value equivalent to POSITION_VAL(ADC_CFGR_JAWD1EN) */
#define ADC_TR1_HT1_BITOFFSET_POS \
  ((uint32_t)16U) /* Value equivalent to POSITION_VAL(ADC_TR1_HT1) */
...
#define VREFINT_CAL_ADDR                                                       \
  ((uint16_t *)((                                                              \
      uint32_t)0x1FFFF7BAU)) /* Internal voltage reference, address of         \
...
#define VREFINT_CAL_VREF                                                    \
  ((uint32_t)3300U) /* Analog voltage reference (Vref+) value with which    \
...
#define TEMPSENSOR_CAL2_ADDR                                                  \
  ((uint16_t *)((                                                             \
      uint32_t)0x1FFFF7C2U)) /* Internal temperature sensor, address of       \
                                parameter TS_CAL2: On STM32F3, temperature    \
                                sensor ADC raw data acquired at temperature   \
                                110 DegC (tolerance: +-5 DegC), Vref+ = 3.3 V \
                                (tolerance: +-10 mV). */
...
#define TEMPSENSOR_CAL_VREFANALOG                                           \
  ((uint32_t)3300U) /* Analog voltage reference (Vref+) voltage with which  \
                       temperature sensor has been calibrated in production \
                       (+-10 mV) (unit: mV). */
...
#define LL_ADC_DMA_REG_REGULAR_DATA                                          \
  ((uint32_t)0x00000000U) /* ADC group regular conversion data register      \
                             (corresponding to register DR) to be used with  \
                             ADC configured in independent mode. Without DMA \
                             transfer, register accessed by LL function @ref \
                             LL_ADC_REG_ReadConversionData32() and other     \
                             functions @ref LL_ADC_REG_ReadConversionDatax() \
                           */
#if defined(ADC_MULTIMODE_SUPPORT)
#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                     \
  ((uint32_t)0x00000001U) /* ADC group regular conversion data register       \
...
#define LL_ADC_CLOCK_ASYNC_DIV1 \
  ((uint32_t)0x00000000U) /*!< ADC asynchronous clock without prescaler */
/**
 * @}
 */
...
#define LL_ADC_PATH_INTERNAL_NONE \
  ((uint32_t)0x00000000U) /*!< ADC measurement paths all disabled */
...
#define LL_ADC_RESOLUTION_12B \
  ((uint32_t)0x00000000U)                      /*!< ADC resolution 12 bits */
...
#define LL_ADC_DATA_ALIGN_RIGHT                                             \
  ((uint32_t)0x00000000U) /*!< ADC conversion data alignment: right aligned \
...
#define LL_ADC_LP_MODE_NONE \
  ((uint32_t)0x00000000U) /*!< No ADC low power mode activated */
...
#define LL_ADC_OFFSET_DISABLE                                                 \
  ((uint32_t)0x00000000U) /*!< ADC offset disabled (among ADC selected offset \
                             number 1, 2, 3 or 4) */
...
#define LL_ADC_GROUP_REGULAR                                             \
  ((uint32_t)0x00000001U) /*!< ADC group regular (available on all STM32 \
                             devices) */
#define LL_ADC_GROUP_INJECTED                                                 \
  ((uint32_t)0x00000002U) /*!< ADC group injected (not available on all STM32 \
                             devices)*/
#define LL_ADC_GROUP_REGULAR_INJECTED \
  ((uint32_t)0x00000003U) /*!< ADC both groups regular and injected */
/**
 * @}
 */
...
#define LL_ADC_CHANNEL_VREFINT                                                 \
  (LL_ADC_CHANNEL_18 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: \
                                  Internal voltage reference. On STM32F3, ADC  \
                                  channel available only on all ADC instances, \
                                  but only one ADC instance is allowed to be   \
...
#define LL_ADC_CHANNEL_TEMPSENSOR                                             \
  (LL_ADC_CHANNEL_16 |                                                        \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to         \
                                  Temperature sensor. On STM32F3, ADC channel \
...
#define LL_ADC_CHANNEL_VBAT                                                   \
  (LL_ADC_CHANNEL_17 |                                                        \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3: \
                                  ...
                                  On STM32F3, ADC channel available only on   \
                                  ADC instance: ADC1. */
...
#define LL_ADC_CHANNEL_VOPAMP1                                               \
  (LL_ADC_CHANNEL_15 |                                                       \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to OPAMP1 \
                                  output. On STM32F3, ADC channel available  \
...
#define LL_ADC_CHANNEL_VOPAMP4                                                 \
  (LL_ADC_CHANNEL_17 | ADC_CHANNEL_ID_INTERNAL_CH |                            \
   ADC_CHANNEL_ID_INTERNAL_CH_2) /*!< ADC internal channel connected to OPAMP4 \
                                    output. On STM32F3, ADC channel available  \
...
#define LL_ADC_REG_TRIG_SOFTWARE                                              \
  ((uint32_t)0x00000000U) /*!< ADC group regular conversion trigger internal: \
                             SW start. */
#if defined(STM32F303xC) || defined(STM32F358xx) || defined(STM32F303xE) || \
    defined(STM32F398xx)
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1_ADC12                                     \
  (ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH2_ADC12                                     \
  (ADC_CFGR_EXTSEL_0 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                           \
  (ADC_CFGR_EXTSEL_1 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2_ADC12                                     \
  (ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO_ADC12                                    \
  (ADC_CFGR_EXTSEL_2 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM3 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4_ADC12                                     \
...
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO2                                      \
  (ADC_CFGR_EXTSEL_3 |                                                      \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     from external IP: TIM8 TRGO2. Trigger  \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO2                                      \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 |                                  \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     from external IP: TIM1 TRGO2. Trigger  \
                                     edge set to rising edge (default       \
                                     setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_TRGO_ADC12                                    \
...
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO                                          \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM6_TRGO_ADC12                                    \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 |                 \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM6 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM15_TRGO                                      \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 |              \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     from external IP: TIM15 TRGO. Trigger  \
                                     edge set to rising edge (default       \
                                     setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_CH4_ADC12                                     \
  (ADC_CFGR_EXTSEL |                                                           \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
...
#define LL_ADC_REG_TRIG_EXT_TIM20_TRG0_ADC12                                   \
  (LL_ADC_REG_TRIG_EXT_TIM1_CH3) /*!< ADC group regular conversion trigger     \
                                    from external IP: TIM20 TRGO. Trigger edge \
                                    set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM20_TRG02_ADC12                               \
  (LL_ADC_REG_TRIG_EXT_TIM2_CH2_ADC12) /*!< ADC group regular conversion    \
                                          trigger from external IP: TIM20   \
                                          TRGO2. Trigger edge set to rising \
                                          edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM20_CH1_ADC12                                 \
  (LL_ADC_REG_TRIG_EXT_TIM4_CH4_ADC12) /*!< ADC group regular conversion    \
                                          trigger from external IP: TIM20   \
                                          channel 1 event (capture compare: \
                                          input capture or output capture). \
                                          Trigger edge set to rising edge   \
                                          (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM20_CH2_ADC12                                  \
  (LL_ADC_REG_TRIG_EXT_TIM6_TRGO_ADC12) /*!< ADC group regular conversion    \
                                           trigger from external IP: TIM20   \
                                           channel 2 event (capture compare: \
                                           input capture or output capture). \
                                           Trigger edge set to rising edge   \
                                           (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM20_CH3_ADC12                                 \
  (LL_ADC_REG_TRIG_EXT_TIM3_CH4_ADC12) /*!< ADC group regular conversion    \
                                          trigger from external IP: TIM20   \
                                          channel 3 event (capture compare: \
                                          input capture or output capture). \
                                          Trigger edge set to rising edge   \
                                          (default setting). */
...
/* Note: For devices STM32F303xE, STM32F398xx: some triggers require to set   */
/*       register SYSCFG_CFGR4. Refer to reference manual.                    */
#define LL_ADC_REG_TRIG_EXT_TIM3_CH1_ADC34                                     \
  (ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM3 channel 1 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH3_ADC34                                     \
  (ADC_CFGR_EXTSEL_0 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                           \
  (ADC_CFGR_EXTSEL_1 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_CH1_ADC34                                     \
  (ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO__ADC34                                   \
  (ADC_CFGR_EXTSEL_2 |                                                         \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM8 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE2_ADC34                                 \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 |                                   \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger  \
                                     from external IP: external interrupt    \
                                     line 2. Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH1_ADC34                                     \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_TRGO__ADC34                                   \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                 \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM2 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
...
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO2                                      \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 |                                  \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     ...
                                     edge set to rising edge (default       \
                                     setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO__ADC34                                   \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                 \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM3 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO                                          \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM4 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM7_TRGO_ADC34                                    \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 |                 \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM7 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM15_TRGO                                      \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 |              \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     ...
                                     edge set to rising edge (default       \
                                     setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH1_ADC34                                    \
  (ADC_CFGR_EXTSEL |                                                          \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger   \
                                     from external IP: TIM2 CCx. Trigger edge \
                                     set to rising edge (default setting). */
#if defined(STM32F303xE) || defined(STM32F398xx)
#define LL_ADC_REG_TRIG_EXT_TIM20_TRG0_ADC34                                 \
  (LL_ADC_REG_TRIG_EXT_EXTI_LINE2_ADC34) /*!< ADC group regular conversion   \
                                            trigger from external IP: TIM20  \
                                            TRGO. Trigger edge set to rising \
                                            edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM20_TRG02_ADC34                               \
  (LL_ADC_REG_TRIG_EXT_TIM4_CH1_ADC34) /*!< ADC group regular conversion    \
                                          trigger from external IP: TIM20   \
                                          TRGO2. Trigger edge set to rising \
                                          edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM20_CH1_ADC34                                 \
  (LL_ADC_REG_TRIG_EXT_TIM2_CH1_ADC34) /*!< ADC group regular conversion    \
                                          trigger from external IP: TIM20   \
                                          channel 1 event (capture compare: \
                                          input capture or output capture). \
                                          Trigger edge set to rising edge   \
...
#define LL_ADC_REG_TRIG_EXT_HRTIM_TRG1                                      \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |              \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     from external IP: HRTIM TRG1. Trigger  \
                                     edge set to rising edge (default       \
                                     setting). */
#define LL_ADC_REG_TRIG_EXT_HRTIM_TRG3                                      \
  (ADC_CFGR_EXTSEL_3 |                                                      \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger \
                                     from external IP: HRTIM TRG3. Trigger  \
                                     edge set to rising edge (default       \
                                     setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO                                          \
  (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_0 |                                     \
...
#define LL_ADC_REG_CONV_SINGLE                                               \
  ((uint32_t)0x00000000U) /*!< ADC conversions are performed in single mode: \
...
#define LL_ADC_REG_DMA_TRANSFER_NONE \
  ((uint32_t)0x00000000U) /*!< ADC conversions are not transferred by DMA */
...
#define LL_ADC_REG_OVR_DATA_PRESERVED                                         \
  ((uint32_t)0x00000000U) /*!< ADC group regular behavior in case of overrun: \
                             data preserved */
...
#define LL_ADC_REG_SEQ_SCAN_DISABLE                                            \
  ((uint32_t)0x00000000U) /*!< ADC group regular sequencer disable (equivalent \
...
#define LL_ADC_REG_SEQ_DISCONT_DISABLE                                        \
  ((uint32_t)0x00000000U) /*!< ADC group regular sequencer discontinuous mode \
                             disable */
...
#define LL_ADC_INJ_TRIG_SOFTWARE                                               \
  ((uint32_t)0x00000000U) /*!< ADC group injected conversion trigger internal: \
                             SW start.. Trigger edge set to rising edge        \
                             (default setting). */
#if defined(STM32F303xC) || defined(STM32F358xx) || defined(STM32F303xE) || \
    defined(STM32F398xx)
...
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                          \
  (ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM1 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                           \
  (ADC_JSQR_JEXTSEL_0 |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO_ADC12                                    \
  (ADC_JSQR_JEXTSEL_1 |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM2 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1_ADC12                                     \
  (ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH4_ADC12                                     \
  (ADC_JSQR_JEXTSEL_2 |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM3 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO_ADC12                                    \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15_ADC12                                 \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                                  \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger  \
                                     from external IP: external interrupt     \
                                     line 15. Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4_ADC12                                     \
...
#define LL_ADC_INJ_TRIG_EXT_TIM3_TRGO                                          \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM3 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH1_ADC12                                     \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM6_TRGO_ADC12                                    \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM6 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM15_TRGO                                       \
  (ADC_JSQR_JEXTSEL |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                     from external IP: TIM15 TRG0. Trigger   \
                                     edge set to rising edge (default        \
                                     setting). */
#if defined(STM32F303xE) || defined(STM32F398xx)
#define LL_ADC_INJ_TRIG_EXT_TIM20_TRGO_ADC12                               \
  (LL_ADC_INJ_TRIG_EXT_TIM2_CH1_ADC12) /*!< ADC group injected conversion  \
                                          trigger from external IP: TIM20  \
                                          TRG0. Trigger edge set to rising \
                                          edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM20_TRGO2_ADC12                                  \
  (LL_ADC_INJ_TRIG_EXT_EXTI_LINE15_ADC12) /*!< ADC group injected conversion   \
                                             trigger from external IP: TIM20   \
                                             TRG02. Trigger edge set to rising \
                                             edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM20_CH4_ADC12                                 \
  (LL_ADC_INJ_TRIG_EXT_TIM2_CH1_ADC12) /*!< ADC group injected conversion   \
                                          trigger from external IP: TIM20   \
...
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                           \
  (ADC_JSQR_JEXTSEL_0 |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH3_ADC34                                     \
  (ADC_JSQR_JEXTSEL_1 |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH2_ADC34                                     \
  (ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     ...
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4__ADC34                                    \
  (ADC_JSQR_JEXTSEL_2 |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM8 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH4_ADC34                                     \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO__ADC34                                   \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2                                       \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 |                                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                     ...
                                     edge set to rising edge (default        \
                                     setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH3_ADC34                                     \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM1 channel 3 event    \
                                     (capture compare: input capture or output \
...
#define LL_ADC_INJ_TRIG_EXT_TIM3_TRGO                                          \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM3 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO__ADC34                                   \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM2 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM7_TRGO_ADC34                                    \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM7 TRG0. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM15_TRGO                                       \
  (ADC_JSQR_JEXTSEL |                                                        \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                     ...
                                     setting). */
#if defined(STM32F303xE) || defined(STM32F398xx)
#define LL_ADC_INJ_TRIG_EXT_TIM20_TRG_ADC34                                  \
  (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |                                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                     from external IP: TIM20 TRG0. Trigger   \
                                     edge set to rising edge (default        \
                                     setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM20_TRG2_ADC34                                \
  (LL_ADC_INJ_TRIG_EXT_TIM1_CH3_ADC34) /*!< ADC group injected conversion   \
                                          trigger from external IP: TIM20   \
                                          TRG02. Trigger edge set to rising \
                                          edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM20_CH2                                         \
  (LL_ADC_INJ_TRIG_EXT_TIM15_TRGO) /*!< ADC group injected conversion trigger \
                                      from external IP: TIM20 channel 2 event \
                                      (capture compare: input capture or      \
...
#define LL_ADC_INJ_TRIG_EXT_HRTIM_TRG2                                       \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_0 |                                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                     from external IP: HRTIM TRG2. Trigger   \
                                     edge set to rising edge (default        \
                                     setting). */
#define LL_ADC_INJ_TRIG_EXT_HRTIM_TRG4                                       \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 |                                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                     from external IP: HRTIM TRG4. Trigger   \
                                     edge set to rising edge (default        \
                                     setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH3                                           \
  (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |              \
...
#define LL_ADC_INJ_TRIG_INDEPENDENT                                        \
  ((uint32_t)0x00000000U) /*!< ADC group injected conversion trigger       \
...
#define LL_ADC_INJ_QUEUE_2CONTEXTS_LAST_ACTIVE                                 \
  ((uint32_t)0x00000000U) /* Group injected sequence context queue is enabled  \
                             and can contain up to 2 contexts. When all        \
                             contexts have been processed, the queue maintains \
                             the last context active perpetually. */
...
#define LL_ADC_INJ_SEQ_SCAN_DISABLE                                  \
  ((uint32_t)0x00000000U) /*!< ADC group injected sequencer disable  \
...
#define LL_ADC_INJ_SEQ_DISCONT_DISABLE                                         \
  ((uint32_t)0x00000000U) /*!< ADC group injected sequencer discontinuous mode \
                             disable */
...
#define LL_ADC_SAMPLINGTIME_4CYCLES_5 \
  (ADC_SMPR2_SMP10_1) /*!< Sampling time 4.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_19CYCLES_5 \
  (ADC_SMPR2_SMP10_2) /*!< Sampling time 19.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_61CYCLES_5 \
  (ADC_SMPR2_SMP10_2 |                 \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 61.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_181CYCLES_5 \
  (ADC_SMPR2_SMP10_2 |                  \
   ADC_SMPR2_SMP10_1) /*!< Sampling time 181.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_601CYCLES_5    \
  (ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1 | \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 601.5 ADC clock cycles */
/**
 * @}
 */
...
#define LL_ADC_AWD_DISABLE \
  ((uint32_t)0x00000000U) /*!< ADC analog watchdog monitoring disabled */
...
#define LL_ADC_AWD_CH_VOPAMP1_REG                                             \
  ((LL_ADC_CHANNEL_VOPAMP1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |         \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal      \
                        channel connected to DAC1 channel 1, channel specific \
...
#endif
#if defined(OPAMP3_CSR_OPAMP3EN)
#define LL_ADC_AWD_CH_VOPAMP3_REG                                             \
  ((LL_ADC_CHANNEL_VOPAMP3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |         \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal      \
                        channel connected to DAC1 channel 1, channel specific \
                        to ADC3, converted by group regular only */
#define LL_ADC_AWD_CH_VOPAMP3_INJ                                             \
  ((LL_ADC_CHANNEL_VOPAMP3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |        \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal      \
                        channel connected to DAC1 channel 1, channel specific \
                        to ADC3, converted by group injected only */
#define LL_ADC_AWD_CH_VOPAMP3_REG_INJ                                          \
  ((LL_ADC_CHANNEL_VOPAMP3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |         \
   ADC_CFGR_AWD1EN |                                                           \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal       \
                        channel connected to DAC1 channel 1, channel specific  \
...
#define LL_ADC_MULTI_INDEPENDENT                                             \
  ((uint32_t)0x00000000U) /*!< ADC dual mode disabled (ADC independent mode) \
                           */
...
#define LL_ADC_MULTI_REG_DMA_EACH_ADC                                      \
  ((uint32_t)0x00000000U) /*!< ADC multimode group regular conversions are \
...
#define LL_ADC_MULTI_TWOSMP_DELAY_1CYCLE                                \
  ((uint32_t)0x00000000U) /*!< ADC multimode delay between two sampling \
...
#define LL_ADC_DELAY_INTERNAL_REGUL_STAB_US                                    \
  ((uint32_t)10U) /*!< Delay for ADC stabilization time (ADC voltage regulator \
                     start-up time) */
...
#define LL_ADC_DELAY_VREFINT_STAB_US                                           \
  ((uint32_t)12U) /*!< Delay for internal voltage reference stabilization time \
                   */
...
#define LL_ADC_DELAY_TEMPSENSOR_STAB_US \
  ((uint32_t)120U) /*!< Delay for temperature sensor stabilization time */
...
#define LL_ADC_DELAY_CALIB_ENABLE_ADC_CYCLES                                \
  ((uint32_t)4U) /*!< Delay required between ADC end of calibration and ADC \
                    enable */
 ...
 *             only one ADC instance is allowed to be connected to VrefInt at
 * the same time.
...
#define __LL_ADC_DECIMAL_NB_TO_CHANNEL(__DECIMAL_NB__)                        \
  (((__DECIMAL_NB__) <= 9U)                                                   \
       ? (((__DECIMAL_NB__) << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) |         \
          ...
          (ADC_SMPR1_REGOFFSET | (((uint32_t)(3U * (__DECIMAL_NB__)))         \
                                  << ADC_CHANNEL_SMPx_BITOFFSET_POS)))        \
       : (((__DECIMAL_NB__) << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) |         \
          (ADC_AWD2CR_AWD2CH_0 << (__DECIMAL_NB__)) |                         \
          (ADC_SMPR2_REGOFFSET | (((uint32_t)(3U * ((__DECIMAL_NB__) - 10U))) \
                                  << ADC_CHANNEL_SMPx_BITOFFSET_POS))))
 ...
 *
 *         (0) On STM32F3, parameter available only on analog watchdog number:
 * AWD1.\n (1) On STM32F3, parameter available only on ADC instance: ADC1.\n (2)
 * On STM32F3, parameter available only on ADC instance: ADC2.\n (3) On STM32F3,
 * parameter available only on ADC instance: ADC3.\n (4) On STM32F3, parameter
 * available only on ADC instances: ADC4.\n (5) On STM32F3, ADC channel
 * available only on all ADC instances, but only one ADC instance is allowed to
 * be connected to VrefInt at the same time.
 */
...
#define __LL_ADC_ANALOGWD_THRESHOLDS_HIGH_LOW(__AWD_THRESHOLD_TYPE__, \
                                              __AWD_THRESHOLDS__)     \
  (((__AWD_THRESHOLDS__) >> POSITION_VAL((__AWD_THRESHOLD_TYPE__))) & \
...
#define __LL_ADC_CALIB_FACTOR_SINGLE_DIFF(__CALIB_FACTOR_SINGLE_ENDED__,      \
  ...
  (((__CALIB_FACTOR_DIFFERENTIAL__) << POSITION_VAL(ADC_CALFACT_CALFACT_D)) | \
 ...
 * sensor slope typical value (unit: uV/DegCelsius). On STM32F3, refer to device
 ...
 * below) (unit: mV). On STM32F3, refer to device datasheet parameter "V25"
...
__STATIC_INLINE void LL_ADC_SetCalibrationFactor(ADC_TypeDef *ADCx,
  ...
  MODIFY_REG(ADCx->CALFACT, SingleDiff & ADC_SINGLEDIFF_CALIB_FACTOR_MASK,
             CalibrationFactor << POSITION_VAL(
...
__STATIC_INLINE void LL_ADC_SetOffsetState(ADC_TypeDef *ADCx, uint32_t Offsety,
  ...
  __IO uint32_t *preg =
      (__IO uint32_t *)((uint32_t)((uint32_t)(&ADCx->OFR1) + (Offsety * 4U)));
...
/**
  ...
  *         (1) On STM32F3, parameter not available on all devices: among
  others, on STM32F303xE, STM32F398xx.\n
  *         (2) On STM32F3, parameter not available on all devices: among
  others, on STM32F303xC, STM32F358xx.\n
  *         (3) On STM32F3, parameter not available on all devices: among
  others, on STM32F303x8, STM32F328xx.\n
  *         (4) On STM32F3, parameter not available on all devices: among
  others, on STM32F334x8.\n
  *         (5) On STM32F3, parameter not available on all devices: among
  others, on STM32F302xC, STM32F302xE.\n
  *         (6) On STM32F3, parameter not available on all devices: among
  others, on STM32F301x8, STM32F302x8, STM32F318xx.\n
  *         (7) On STM32F3, parameter not available on all ADC instances: ADC1,
  ADC2 (for ADC instances ADCx available on the selected device).\n
  *         (8) On STM32F3, parameter not available on all ADC instances: ADC3,
  ADC4 (for ADC instances ADCx available on the selected device).
  * @retval None
  */
 ...
 *
 *         (1) On STM32F3, parameter not available on all devices: among others,
 * on STM32F303xE, STM32F398xx.\n (2) On STM32F3, parameter not available on all
 * devices: among others, on STM32F303xC, STM32F358xx.\n (3) On STM32F3,
 * parameter not available on all devices: among others, on STM32F303x8,
 * STM32F328xx.\n (4) On STM32F3, parameter not available on all devices: among
 * others, on STM32F334x8.\n (5) On STM32F3, parameter not available on all
 * devices: among others, on STM32F302xC, STM32F302xE.\n (6) On STM32F3,
 * parameter not available on all devices: among others, on STM32F301x8,
 * STM32F302x8, STM32F318xx.\n (7) On STM32F3, parameter not available on all
 * ADC instances: ADC1, ADC2 (for ADC instances ADCx available on the selected
 * device).\n (8) On STM32F3, parameter not available on all ADC instances:
 * ADC3, ADC4 (for ADC instances ADCx available on the selected device).
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime(ADC_TypeDef *ADCx,
  ...
  return (uint32_t)(READ_BIT(*preg,
                             ADC_SMPR1_SMP0 << __ADC_MASK_SHIFT(
...
__STATIC_INLINE void LL_ADC_SetAnalogWDMonitChannels(ADC_TypeDef *ADCx,
  ...
  /* containing other bits reserved for other purpose.                        */
  __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(
      ADCx->CFGR, __ADC_MASK_SHIFT(AWDy, ADC_AWD_CRX_REGOFFSET_MASK) +
...
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDMonitChannels(ADC_TypeDef *ADCx,
  ...
  uint32_t AWD1ChannelSingle = ((AWD123ChannelGroup & ADC_CFGR_AWD1SGL) >>
                                ADC_CFGR_AWD1SGL_BITOFFSET_POS);

  uint32_t AWD1ChannelGroup =
      ((AWD123ChannelGroup |
        ((ADC_CHANNEL_0_BITFIELD
          << ((AWD123ChannelGroup & ADC_CHANNEL_ID_NUMBER_MASK) >>
              ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS)) *
         AWD1ChannelSingle) |
        (ADC_CHANNEL_ID_BITFIELD_MASK *
         (~AWD1ChannelSingle & ((uint32_t)0x00000001U)))) *
       (((AWD123ChannelGroup & ADC_CFGR_JAWD1EN) >>
         ADC_CFGR_JAWD1EN_BITOFFSET_POS) |
        ((AWD123ChannelGroup & ADC_CFGR_AWD1EN) >>
  ...
  /*       conflict.                                                          */
  uint32_t AWD23Enabled =
      ((((uint32_t)0x00000001U) >> (AWD123ChannelGroup % 3U))
       << 6U); /* Value "0" if AWD2-3 is enabled, value "32" if AWD2-3 is
                  disabled */

  uint32_t AWD23ChannelGroup =
      (((AWD123ChannelGroup |
         ((uint32_t)POSITION_VAL(AWD123ChannelGroup)
          << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) |
         ((ADC_CFGR_AWD1SGL) >>
          ((((uint32_t)0x00000001U) >>
            (ADC_AWD_CR23_CHANNEL_MASK - AWD123ChannelGroup))
           << 5U)) |
...
__STATIC_INLINE void LL_ADC_ConfigAnalogWDThresholds(
  ...
  /* containing other bits reserved for other purpose.                        */
  __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(
      ADCx->TR1, __ADC_MASK_SHIFT(AWDy, ADC_AWD_TRX_REGOFFSET_MASK));
...
__STATIC_INLINE void LL_ADC_EnableInternalRegulator(ADC_TypeDef *ADCx) {
  ...
  MODIFY_REG(ADCx->CR, ADC_CR_BITS_PROPERTY_RS, ADC_CR_ADVREGEN_0);
}
...
__STATIC_INLINE uint32_t LL_ADC_IsInternalRegulatorEnabled(ADC_TypeDef *ADCx) {
  return (READ_BIT(ADCx->CR, (ADC_CR_ADVREGEN_1 | ADC_CR_ADVREGEN_0)) ==
          (ADC_CR_ADVREGEN_0));
}
...
/* into ADC group regular sequencer ranks literals definition.                */
#define ADC_REG_RANK_1_SQRX_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ1) */
#define ADC_REG_RANK_2_SQRX_BITOFFSET_POS \
  ((uint32_t)5U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ2) */
#define ADC_REG_RANK_3_SQRX_BITOFFSET_POS \
  ((uint32_t)10U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ3) */
#define ADC_REG_RANK_4_SQRX_BITOFFSET_POS \
  ((uint32_t)15U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ4) */
#define ADC_REG_RANK_5_SQRX_BITOFFSET_POS \
  ((uint32_t)20U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ5) */
#define ADC_REG_RANK_6_SQRX_BITOFFSET_POS \
  ((uint32_t)25U) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ6) */
#define ADC_REG_RANK_7_SQRX_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ7) */
#define ADC_REG_RANK_8_SQRX_BITOFFSET_POS \
  ((uint32_t)5U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ8) */
#define ADC_REG_RANK_9_SQRX_BITOFFSET_POS \
  ((uint32_t)10U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ9) */
#define ADC_REG_RANK_10_SQRX_BITOFFSET_POS \
  ((uint32_t)15U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ10) */
#define ADC_REG_RANK_11_SQRX_BITOFFSET_POS \
  ((uint32_t)20U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ11) */
#define ADC_REG_RANK_12_SQRX_BITOFFSET_POS \
  ((uint32_t)25U) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ12) */
#define ADC_REG_RANK_13_SQRX_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ13) */
#define ADC_REG_RANK_14_SQRX_BITOFFSET_POS \
  ((uint32_t)5U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ14) */
#define ADC_REG_RANK_15_SQRX_BITOFFSET_POS \
  ((uint32_t)10U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ15) */
#define ADC_REG_RANK_16_SQRX_BITOFFSET_POS \
  ((uint32_t)15U) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ16) */
...
/* into ADC group injected sequencer ranks literals definition.               */
#define ADC_INJ_RANK_1_JSQR_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ1) */
#define ADC_INJ_RANK_2_JSQR_BITOFFSET_POS \
  ((uint32_t)5U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ2) */
#define ADC_INJ_RANK_3_JSQR_BITOFFSET_POS \
  ((uint32_t)10U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ3) */
#define ADC_INJ_RANK_4_JSQR_BITOFFSET_POS \
  ((uint32_t)15U) /* Value equivalent to POSITION_VAL(ADC_JSQR_JSQ4) */
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS \
  ((uint32_t)0U) /* Value equivalent to     \
                    POSITION_VAL(ADC_CHANNEL_ID_NUMBER_MASK) */
#define ADC_CHANNEL_ID_MASK \
  (ADC_CHANNEL_ID_NUMBER_MASK | ADC_CHANNEL_ID_INTERNAL_CH_MASK)
/* Equivalent mask of ADC_CHANNEL_NUMBER_MASK aligned on register LSB (bit 0) */
#define ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0                                    \
  ((uint32_t)0x0000001FU) /* Equivalent to shift: (ADC_CHANNEL_NUMBER_MASK >> \
                             POSITION_VAL(ADC_CHANNEL_NUMBER_MASK)) */
...
#define ADC_CHANNEL_ID_INTERNAL_CH \
  ((uint32_t)0x80000000U) /* Marker of internal channel */
#define ADC_CHANNEL_ID_INTERNAL_CH_2                                      \
  ((uint32_t)0x40000000U) /* Marker of internal channel for other ADC     \
                             instances, in case of different ADC internal \
                             channels mapped on same channel number on    \
                             different ADC instances */
#define ADC_CHANNEL_ID_INTERNAL_CH_MASK \
...
/* ADC registers bits positions */
#define ADC_CR1_DUALMOD_BITOFFSET_POS \
  ((uint32_t)16U) /* Value equivalent to POSITION_VAL(ADC_CR1_DUALMOD) */
...
#define TEMPSENSOR_CAL2_ADDR                                                  \
  ((uint16_t *)((                                                             \
      uint32_t)0x1FFFF7C2U)) /* Internal temperature sensor, address of       \
                                parameter TS_CAL2: On STM32F37x, temperature  \
                                sensor ADC raw data acquired at temperature   \
                                110 DegC (tolerance: +-5 DegC), Vref+ = 3.3 V \
                                (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL1_TEMP                                                   \
...
typedef struct {
  uint32_t
      TriggerSource; /*!< Set ADC group regular conversion trigger source:
                        internal (SW start) or external from timer or external
                        interrupt. This parameter can be a value of @ref
                        ADC_LL_EC_REG_TRIGGER_SOURCE
                          @note On this STM32 series, external trigger is set
                        with trigger polarity: rising edge (only trigger
                        polarity available on this STM32 series).
...
#define LL_ADC_FLAG_EOS                                                   \
  ADC_SR_EOC /*!< ADC flag ADC group regular end of sequence conversions  \
                (Note: on this STM32 series, there is no flag ADC group   \
                regular end of unitary conversion. Flag noted as "EOC" is \
 ...
 */
#define LL_ADC_IT_EOS                                                         \
  ADC_CR1_EOCIE /*!< ADC interruption ADC group regular end of sequence       \
                   conversions (Note: on this STM32 series, there is no flag  \
                   ADC group regular end of unitary conversion. Flag noted as \
                   "EOC" is corresponding to flag "EOS" in other STM32        \
                   families) */
#define LL_ADC_IT_JEOS                                                        \
...
#define LL_ADC_PATH_INTERNAL_TEMPSENSOR                                       \
  (ADC_CR2_TSVREFE) /*!< ADC measurement path to internal channel temperature \
                       sensor */
/**
 * @}
 */
...
#define LL_ADC_SEQ_SCAN_DISABLE                                                \
  ((uint32_t)0x00000000U) /*!< ADC conversion is performed in unitary          \
                             conversion mode (one channel converted, that      \
                             defined in rank 1). Configuration of both groups  \
                             regular and injected sequencers (sequence length, \
                             ...) is discarded: equivalent to length of 1      \
                             rank.*/
#define LL_ADC_SEQ_SCAN_ENABLE                                                \
  ((uint32_t)ADC_CR1_SCAN) /*!< ADC conversions are performed in sequence     \
                              conversions mode, according to configuration of \
                              both groups regular and injected sequencers     \
                              (sequence length, ...). */
/**
 * @}
 */
...
#define LL_ADC_CHANNEL_VREFINT                                                 \
  (LL_ADC_CHANNEL_17 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: \
                                  Internal voltage reference. On STM32F37x,    \
                                  ADC channel available only on ADC instance:  \
                                  ADC1. */
#define LL_ADC_CHANNEL_TEMPSENSOR                                     \
  (LL_ADC_CHANNEL_16 |                                                \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to \
...
#define LL_ADC_REG_TRIG_SOFTWARE                                            \
  (ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 |                                    \
   ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger internal (SW \
                        start) */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                         \
  (ADC_CR2_EXTSEL_1 |                                                        \
   ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger external from \
                        TIM2 CC2. Trigger edge set to rising edge (default   \
                        setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                        \
  (ADC_CR2_EXTSEL_2) /*!< ADC group regular conversion trigger external from \
                        TIM3 TRGO. Trigger edge set to rising edge (default  \
                        setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH2                                         \
  (ADC_CR2_EXTSEL_2 |                                                        \
   ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger external from \
                        TIM4 CC4. Trigger edge set to rising edge (default   \
                        setting). */
#define LL_ADC_REG_TRIG_EXT_TIM19_TRGO                                        \
  ((uint32_t)0x00000000U) /*!< ADC group regular conversion trigger external  \
                             from TIM19 TRGO. Trigger edge set to rising edge \
                             (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM19_CH3                                        \
  (ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger external from \
                        TIM19 CC3. Trigger edge set to rising edge (default  \
                        setting). */
#define LL_ADC_REG_TRIG_EXT_TIM19_CH4                                        \
  (ADC_CR2_EXTSEL_1) /*!< ADC group regular conversion trigger external from \
                        TIM19 CC4. Trigger edge set to rising edge (default  \
                        setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                    \
  (ADC_CR2_EXTSEL_2 |                                                      \
   ADC_CR2_EXTSEL_1) /*!< ADC group regular conversion trigger external    \
                        interrupt line 11. Trigger edge set to rising edge \
                        (default setting). */
/**
 * @}
 */
 ...
 */
#define LL_ADC_REG_TRIG_EXT_RISING                                           \
  ((uint32_t)0x00000000U) /*!< ADC group regular conversion trigger polarity \
                             set to rising edge */
/**
 * @}
 */
...
#define LL_ADC_REG_DMA_TRANSFER_NONE \
  ((uint32_t)0x00000000U) /*!< ADC conversions are not transferred by DMA */
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                     \
  (ADC_CR2_DMA) /*!< ADC conversions are transferred by DMA, in unlimited     \
...
#define LL_ADC_INJ_TRIG_SOFTWARE                                              \
  (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 |                                    \
   ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger internal (SW \
                         start) */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO                                          \
  (ADC_CR2_JEXTSEL_1) /*!< ADC group injected conversion trigger external from \
                         TIM2 TRGO. Trigger edge set to rising edge (default   \
                         setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                           \
  (ADC_CR2_JEXTSEL_1 |                                                         \
   ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger external from \
                         TIM2 CC1. Trigger edge set to rising edge (default    \
                         setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH4                                           \
  (ADC_CR2_JEXTSEL_2) /*!< ADC group injected conversion trigger external from \
                         TIM3 CC4. Trigger edge set to rising edge (default    \
                         setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                          \
  (ADC_CR2_JEXTSEL_2 |                                                         \
   ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger external from \
                         ...
                         setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM19_CH1                                         \
  ((uint32_t)0x00000000U) /*!< ADC group injected conversion trigger external \
                             from TIM19 CC1. Trigger edge set to rising edge  \
                             (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM19_CH2                                          \
  (ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger external from \
                         TIM19 CC2. Trigger edge set to rising edge (default   \
                         setting). */
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                     \
  (ADC_CR2_JEXTSEL_2 |                                                      \
   ADC_CR2_JEXTSEL_1) /*!< ADC group injected conversion trigger external   \
                         interrupt line 15. Trigger edge set to rising edge \
                         (default setting). */
/**
 * @}
 */
 ...
 */
#define LL_ADC_INJ_TRIG_EXT_RISING                                            \
  ((uint32_t)0x00000000U) /*!< ADC group injected conversion trigger polarity \
                             set to rising edge */
/**
 * @}
 */
 ...
 */
#define LL_ADC_SAMPLINGTIME_1CYCLE_5 \
  ((uint32_t)0x00000000U) /*!< Sampling time 1.5 ADC clock cycle */
#define LL_ADC_SAMPLINGTIME_7CYCLES_5 \
  (ADC_SMPR2_SMP0_0) /*!< Sampling time 7.5 ADC clock cycles */
...
/* Unit: us                                                                   */
#define LL_ADC_DELAY_TEMPSENSOR_STAB_US                                        \
  ((uint32_t)10U) /*!< Delay for internal voltage reference stabilization time \
                   */
...
#define LL_ADC_DELAY_DISABLE_CALIB_ADC_CYCLES                                \
  ((uint32_t)2U) /*!< Delay required between ADC disable and ADC calibration \
                    start */
 ...
 *         are disabled.
 *         Value "1" At least one ADC instance sharing the same ADC common
 * instance is enabled
 */
#define __LL_ADC_IS_ENABLED_ALL_COMMON_INSTANCE(__ADCXY_COMMON__) \
  LL_ADC_IsEnabled(ADC1)
 ...
 * @retval ADC conversion data equivalent voltage value (unit: mVolt)
 */
#define __LL_ADC_DIGITAL_SCALE(__ADC_RESOLUTION__) ((uint32_t)0xFFFU)
...
#define __LL_ADC_CONVERT_DATA_RESOLUTION(__DATA__, __ADC_RESOLUTION_CURRENT__, \
                                         __ADC_RESOLUTION_TARGET__)            \
  (((__DATA__) << ((__ADC_RESOLUTION_CURRENT__) >> (0U))) >>                   \
 ...
 *         preliminarily rescaled to an equivalent resolution of 12 bits.
 * @param  __TEMPSENSOR_TYP_AVGSLOPE__   Device datasheet data: Temperature
 * sensor slope typical value (unit: uV/DegCelsius). On STM32F37x, refer to
 * device datasheet parameter "Avg_Slope".
 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data: Temperature
 * sensor voltage typical value (at temperature and Vref+ defined in parameters
 * below) (unit: mV). On STM32F37x, refer to device datasheet parameter "V25".
 * @param  __TEMPSENSOR_CALX_TEMP__      Device datasheet data: Temperature at
 * which temperature sensor voltage (see parameter above) is corresponding
 * (unit: degC)
 * @param  __VREFANALOG_VOLTAGE__        Analog voltage reference (Vref+)
...
/**
  ...
  * @note   On this STM32 series, hardware prerequisite before starting a
  calibration: the ADC must have been in power-on state for at least two ADC
  clock cycles.
