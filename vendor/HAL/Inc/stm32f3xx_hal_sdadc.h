...
typedef enum {
  ...
  HAL_SDADC_STATE_REG_INJ =
      0x05U, /*!< SDADC regular and injected conversions in progress */
 ...
 */
typedef struct {
  uint32_t IdleLowPowerMode; /*!< Specifies if SDADC can enter in power down or
                                standby when idle. This parameter can be a value
                                of @ref SDADC_Idle_Low_Power_Mode */
  uint32_t FastConversionMode; /*!< Specifies if Fast conversion mode is enabled
  ...
  uint32_t ReferenceVoltage; /*!< Specifies the reference voltage.
                                  Note: This parameter is common to all SDADC
                                instances. This parameter can be a value of @ref
                                SDADC_Reference_Voltage */
} SDADC_InitTypeDef;
...
typedef struct __SDADC_HandleTypeDef {
  ...
  void (*ConvHalfCpltCallback)(
      struct __SDADC_HandleTypeDef
          *hadc); /*!< SDADC half regular conversion complete callback */
  void (*ConvCpltCallback)(
      struct __SDADC_HandleTypeDef
          *hadc); /*!< SDADC regular conversion complete callback */
  void (*InjectedConvHalfCpltCallback)(
      struct __SDADC_HandleTypeDef
          *hadc); /*!< SDADC half injected conversion complete callback */
  void (*InjectedConvCpltCallback)(
      struct __SDADC_HandleTypeDef
          *hadc); /*!< SDADC injected conversion complete callback */
  void (*CalibrationCpltCallback)(
      struct __SDADC_HandleTypeDef *hadc); /*!< SDADC calibration callback */
  void (*ErrorCallback)(
      struct __SDADC_HandleTypeDef *hadc); /*!< SDADC error callback */
  void (*MspInitCallback)(
      struct __SDADC_HandleTypeDef *hadc); /*!< SDADC Msp Init callback */
  void (*MspDeInitCallback)(
      struct __SDADC_HandleTypeDef *hadc); /*!< SDADC Msp DeInit callback */
...
typedef struct {
  uint32_t
      InputMode; /*!< Specifies the input mode (single ended, differential...)
  ...
  uint32_t CommonMode; /*!< Specifies the common mode setting (VSSA, VDDA,
                          VDDA/2U). This parameter can be any value of @ref
                          SDADC_CommonMode */
 ...
 */
typedef enum {
  HAL_SDADC_CONVERSION_HALF_CB_ID =
      0x00U, /*!< SDADC half regular conversion complete callback ID */
  HAL_SDADC_CONVERSION_COMPLETE_CB_ID =
      0x01U, /*!< SDADC regular conversion complete callback ID */
  HAL_SDADC_INJ_CONVERSION_HALF_CB_ID =
      0x02U, /*!< SDADC half injected conversion complete callback ID */
  HAL_SDADC_INJ_CONVERSION_COMPLETE_CB_ID =
      0x03U, /*!< SDADC injected conversion complete callback ID */
  HAL_SDADC_CALIBRATION_COMPLETE_CB_ID =
      0x04U,                        /*!< SDADC calibration callback ID */
 ...
 */
typedef void (*pSDADC_CallbackTypeDef)(
    SDADC_HandleTypeDef *hsdadc); /*!< pointer to a SDADC callback function */
 ...
 * @{
 */
#define SDADC_VREF_EXT                                                      \
  (0x00000000UL) /*!< The reference voltage is forced externally using VREF \
                    pin */
#define SDADC_VREF_VREFINT1                                                 \
  SDADC_CR1_REFV_0 /*!< The reference voltage is forced internally to 1.22V \
                      VREFINT */
#define SDADC_VREF_VREFINT2                                                \
  SDADC_CR1_REFV_1 /*!< The reference voltage is forced internally to 1.8V \
                      VREFINT */
#define SDADC_VREF_VDDA \
  SDADC_CR1_REFV /*!< The reference voltage is forced internally to VDDA */
/**
 * @}
 */
...
#define SDADC_CONF_INDEX_0 \
  (0x00000000UL) /*!< Configuration 0 Register selected */
#define SDADC_CONF_INDEX_1 \
  (0x00000001U) /*!< Configuration 1 Register selected */
#define SDADC_CONF_INDEX_2 \
  (0x00000002U) /*!< Configuration 2 Register selected */
/**
 * @}
 */
 ...
 * @{
 */
#define SDADC_INPUT_MODE_DIFF \
  (0x00000000UL) /*!< Conversions are executed in differential mode */
#define SDADC_INPUT_MODE_SE_OFFSET                                             \
  SDADC_CONF0R_SE0_0 /*!< Conversions are executed in single ended offset mode \
                      */
#define SDADC_INPUT_MODE_SE_ZERO_REFERENCE                                 \
  SDADC_CONF0R_SE0 /*!< Conversions are executed in single ended zero-volt \
                      reference mode */
/**
 * @}
 */
 ...
 * @{
 */
#define SDADC_COMMON_MODE_VSSA \
  (0x00000000UL) /*!< Select SDADC VSSA as common mode */
#define SDADC_COMMON_MODE_VDDA_2 \
  SDADC_CONF0R_COMMON0_0 /*!< Select SDADC VDDA/2 as common mode */
#define SDADC_COMMON_MODE_VDDA \
  SDADC_CONF0R_COMMON0_1 /*!< Select SDADC VDDA as common mode */
/**
 * @}
 */
 ...
 * @{
 */
#define SDADC_CALIBRATION_SEQ_1                                             \
  (0x00000000UL) /*!< One calibration sequence to calculate offset of conf0 \
                    (OFFSET0[11:0]) */
#define SDADC_CALIBRATION_SEQ_2                                              \
  SDADC_CR2_CALIBCNT_0 /*!< Two calibration sequences to calculate offset of \
                          conf0 and conf1 (OFFSET0[11:0] and OFFSET1[11:0]) */
#define SDADC_CALIBRATION_SEQ_3                                                \
  SDADC_CR2_CALIBCNT_1 /*!< Three calibration sequences to calculate offset of \
                          conf0, conf1 and conf2 (OFFSET0[11:0],               \
 ...
 * @{
 */
#define SDADC_CONTINUOUS_CONV_OFF \
  (0x00000000UL) /*!< Conversion are not continuous */
#define SDADC_CONTINUOUS_CONV_ON \
  (0x00000001UL) /*!< Conversion are continuous */
/**
 * @}
 */
...
#define SDADC_SYNCHRONOUS_TRIGGER \
  (0x00000001UL) /*!< Synchronous with SDADC1 (only for SDADC2 and SDADC3) */
 ...
 * @{
 */
#define SDADC_EXT_TRIG_TIM13_CC1 \
  (0x00000000UL) /*!< Trigger source for SDADC1 */
#define SDADC_EXT_TRIG_TIM14_CC1 \
  (0x00000100UL) /*!< Trigger source for SDADC1 */
#define SDADC_EXT_TRIG_TIM16_CC1 \
  (0x00000000UL) /*!< Trigger source for SDADC3 */
#define SDADC_EXT_TRIG_TIM17_CC1 \
  (0x00000000UL) /*!< Trigger source for SDADC2 */
#define SDADC_EXT_TRIG_TIM12_CC1 \
  (0x00000100UL) /*!< Trigger source for SDADC2 */
...
#define SDADC_EXT_TRIG_TIM19_CC3 \
  (0x00000500UL) /*!< Trigger source for SDADC2 */
#define SDADC_EXT_TRIG_TIM19_CC4 \
  (0x00000500UL) /*!< Trigger source for SDADC3 */
#define SDADC_EXT_TRIG_EXTI11 \
  (0x00000700UL) /*!< Trigger source for SDADC1, SDADC2 and SDADC3 */
#define SDADC_EXT_TRIG_EXTI15 \
  (0x00000600UL) /*!< Trigger source for SDADC1, SDADC2 and SDADC3 */
/**
 * @}
 */
 ...
 * @{
 */
#define SDADC_EXT_TRIG_RISING_EDGE \
  SDADC_CR2_JEXTEN_0 /*!< External rising edge */
#define SDADC_EXT_TRIG_FALLING_EDGE \
  SDADC_CR2_JEXTEN_1 /*!< External falling edge */
#define SDADC_EXT_TRIG_BOTH_EDGES \
  SDADC_CR2_JEXTEN /*!< External rising and falling edges */
/**
 * @}
 */
 ...
 * @{
 */
#define SDADC_MULTIMODE_SDADC1_SDADC2 \
  (0x00000000UL) /*!< Get conversion values for SDADC1 and SDADC2 */
#define SDADC_MULTIMODE_SDADC1_SDADC3 \
  (0x00000001U) /*!< Get conversion values for SDADC1 and SDADC3 */
/**
 * @}
 */
...
#define SDADC_ERROR_REGULAR_OVERRUN \
  (0x00000001UL) /*!< Overrun occurs during regular conversion */
#define SDADC_ERROR_INJECTED_OVERRUN \
  (0x00000002UL) /*!< Overrun occurs during injected conversion */
#define SDADC_ERROR_DMA (0x00000003UL) /*!< DMA error occurs */
#if (USE_HAL_SDADC_REGISTER_CALLBACKS == 1)
#define SDADC_ERROR_INVALID_CALLBACK \
  (0x00000004UL) /*!< Invalid Callback error */
#endif           /* USE_HAL_SDADC_REGISTER_CALLBACKS */
/**
 * @}
 */
 ...
 * @{
 */
#define SDADC_IT_EOCAL \
  SDADC_CR1_EOCALIE /*!< End of calibration interrupt enable */
#define SDADC_IT_JEOC \
  SDADC_CR1_JEOCIE /*!< Injected end of conversion interrupt enable */
#define SDADC_IT_JOVR \
  SDADC_CR1_JOVRIE /*!< Injected data overrun interrupt enable */
#define SDADC_IT_REOC \
  SDADC_CR1_REOCIE /*!< Regular end of conversion interrupt enable */
#define SDADC_IT_ROVR \
  SDADC_CR1_ROVRIE /*!< Regular data overrun interrupt enable */
/**
 * @}
 */
...
#define IS_SDADC_FAST_CONV_MODE(FAST) \
  (((FAST) == SDADC_FAST_CONV_DISABLE) || ((FAST) == SDADC_FAST_CONV_ENABLE))

#define IS_SDADC_SLOW_CLOCK_MODE(MODE) \
  (((MODE) == SDADC_SLOW_CLOCK_DISABLE) || ((MODE) == SDADC_SLOW_CLOCK_ENABLE))

#define IS_SDADC_VREF(VREF)                                         \
  (((VREF) == SDADC_VREF_EXT) || ((VREF) == SDADC_VREF_VREFINT1) || \
   ((VREF) == SDADC_VREF_VREFINT2) || ((VREF) == SDADC_VREF_VDDA))

#define IS_SDADC_CONF_INDEX(CONF)                                      \
  (((CONF) == SDADC_CONF_INDEX_0) || ((CONF) == SDADC_CONF_INDEX_1) || \
...
#define IS_SDADC_GAIN(GAIN)                                  \
  (((GAIN) == SDADC_GAIN_1) || ((GAIN) == SDADC_GAIN_2) ||   \
   ((GAIN) == SDADC_GAIN_4) || ((GAIN) == SDADC_GAIN_8) ||   \
   ((GAIN) == SDADC_GAIN_16) || ((GAIN) == SDADC_GAIN_32) || \
   ((GAIN) == SDADC_GAIN_1_2))

#define IS_SDADC_COMMON_MODE(MODE)       \
  (((MODE) == SDADC_COMMON_MODE_VSSA) || \
   ((MODE) == SDADC_COMMON_MODE_VDDA_2) || ((MODE) == SDADC_COMMON_MODE_VDDA))
...
#define IS_SDADC_REGULAR_CHANNEL(CHANNEL)                              \
  (((CHANNEL) == SDADC_CHANNEL_0) || ((CHANNEL) == SDADC_CHANNEL_1) || \
   ((CHANNEL) == SDADC_CHANNEL_2) || ((CHANNEL) == SDADC_CHANNEL_3) || \
   ((CHANNEL) == SDADC_CHANNEL_4) || ((CHANNEL) == SDADC_CHANNEL_5) || \
   ((CHANNEL) == SDADC_CHANNEL_6) || ((CHANNEL) == SDADC_CHANNEL_7) || \
   ((CHANNEL) == SDADC_CHANNEL_8))

/* Any or all of the 9 channels can be selected for injected conversion */
#define IS_SDADC_INJECTED_CHANNEL(CHANNEL) \
  (((CHANNEL) != 0U) && ((CHANNEL) <= 0x000F01FFU))
...
#define IS_SDADC_INJECTED_DELAY(DELAY) \
  (((DELAY) == SDADC_INJECTED_DELAY_NONE) || ((DELAY) == SDADC_INJECTED_DELAY))
...
/** @addtogroup SDADC_Exported_Functions_Group1 Initialization and
...
HAL_StatusTypeDef HAL_SDADC_RegisterCallback(
    SDADC_HandleTypeDef *sdhadc, HAL_SDADC_CallbackIDTypeDef CallbackID,
...
/** @addtogroup SDADC_Exported_Functions_Group3 Input and Output operation
 * functions
 * @{
 */
