...
#define HAL_REMAPDMA_TIM16_DMA1_CH6                                         \
  (0x00000800U) /*!< TIM16 DMA request remap                                \
                              1: Remap (TIM16_CH1 and TIM16_UP DMA requests \
                   mapped on DMA1 channel 6) */
...
#define HAL_REMAPDMA_DAC2_CH1_DMA1_CH5                                       \
  (0x00008000U) /*!< DAC2 channel1 DMA remap (STM32F303x4/6/8 devices only)  \
                              1: Remap (DAC2_CH1 DMA requests mapped on DMA1 \
                   channel 5) */
 ...
 * SYSCFG_FastModePlus_GPIO values. That you can find above these macros.
 */
