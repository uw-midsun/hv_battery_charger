...
typedef enum {
  ...
  HAL_TSC_STATE_READY = 0x01UL, /*!< TSC registers are initialized or
                                   acquisition is completed with success */
  HAL_TSC_STATE_BUSY =
      0x02UL, /*!< TSC initialization or acquisition is on-going */
  HAL_TSC_STATE_ERROR =
      0x03UL /*!< Acquisition is completed with max count error */
...
typedef enum {
  TSC_GROUP_ONGOING =
      0x00UL, /*!< Acquisition on group is on-going or not started */
...
typedef struct {
  ...
  FunctionalState
      SpreadSpectrum;               /*!< Spread spectrum activation
  ...
  FunctionalState
      MaxCountInterrupt; /*!< Max count interrupt activation
                              This parameter can be set to ENABLE or DISABLE. */
...
#if (USE_HAL_TSC_REGISTER_CALLBACKS == 1)
  void (*ConvCpltCallback)(struct __TSC_HandleTypeDef
                               *htsc); /*!< TSC Conversion complete callback  */
  void (*ErrorCallback)(
      struct __TSC_HandleTypeDef *htsc); /*!< TSC Error callback */

  void (*MspInitCallback)(
      struct __TSC_HandleTypeDef *htsc); /*!< TSC Msp Init callback */
  void (*MspDeInitCallback)(
      struct __TSC_HandleTypeDef *htsc); /*!< TSC Msp DeInit callback */
...
typedef enum {
  HAL_TSC_CONV_COMPLETE_CB_ID =
      0x00UL,                   /*!< TSC Conversion completed callback ID  */
 ...
 */
typedef void (*pTSC_CallbackTypeDef)(
    TSC_HandleTypeDef *htsc); /*!< pointer to an TSC callback function */
...
#if (USE_HAL_TSC_REGISTER_CALLBACKS == 1)
#define HAL_TSC_ERROR_INVALID_CALLBACK \
  0x00000001UL /*!< Invalid Callback error */
#endif         /* USE_HAL_TSC_REGISTER_CALLBACKS */
/**
 * @}
 */
...
#define TSC_CTPH_16CYCLES \
  (TSC_CR_CTPH_3 | TSC_CR_CTPH_2 | TSC_CR_CTPH_1 | TSC_CR_CTPH_0)
...
#define TSC_CTPL_16CYCLES \
  (TSC_CR_CTPL_3 | TSC_CR_CTPL_2 | TSC_CR_CTPL_1 | TSC_CR_CTPL_0)
...
#define TSC_PG_PRESC_DIV8 \
  (TSC_CR_PGPSC_1 | TSC_CR_PGPSC_0)       /*!< Pulse Generator HCLK Div8   */
#define TSC_PG_PRESC_DIV16 TSC_CR_PGPSC_2 /*!< Pulse Generator HCLK Div16  */
#define TSC_PG_PRESC_DIV32 \
  (TSC_CR_PGPSC_2 | TSC_CR_PGPSC_0) /*!< Pulse Generator HCLK Div32  */
#define TSC_PG_PRESC_DIV64 \
  (TSC_CR_PGPSC_2 | TSC_CR_PGPSC_1) /*!< Pulse Generator HCLK Div64  */
#define TSC_PG_PRESC_DIV128          \
  (TSC_CR_PGPSC_2 | TSC_CR_PGPSC_1 | \
   TSC_CR_PGPSC_0) /*!< Pulse Generator HCLK Div128 */
/**
 * @}
 */
 ...
 */
#define TSC_MCV_255 \
  0x00000000UL /*!< 255 maximum number of charge transfer pulses   */
#define TSC_MCV_511 \
  TSC_CR_MCV_0 /*!< 511 maximum number of charge transfer pulses   */
#define TSC_MCV_1023 \
  TSC_CR_MCV_1 /*!< 1023 maximum number of charge transfer pulses  */
#define TSC_MCV_2047 \
  (TSC_CR_MCV_1 |    \
   TSC_CR_MCV_0) /*!< 2047 maximum number of charge transfer pulses  */
#define TSC_MCV_4095 \
  TSC_CR_MCV_2 /*!< 4095 maximum number of charge transfer pulses  */
#define TSC_MCV_8191 \
  (TSC_CR_MCV_2 |    \
   TSC_CR_MCV_0) /*!< 8191 maximum number of charge transfer pulses  */
#define TSC_MCV_16383 \
  (TSC_CR_MCV_2 |     \
   TSC_CR_MCV_1) /*!< 16383 maximum number of charge transfer pulses */
/**
 * @}
 */
 ...
 * @{
 */
#define TSC_IODEF_OUT_PP_LOW \
  0x00000000UL /*!< I/Os are forced to output push-pull low */
#define TSC_IODEF_IN_FLOAT \
  TSC_CR_IODEF /*!< I/Os are in input floating              */
/**
 * @}
 */
...
#define TSC_SYNC_POLARITY_FALLING \
  0x00000000UL /*!< Falling edge only           */
#define TSC_SYNC_POLARITY_RISING \
  TSC_CR_SYNCPOL /*!< Rising edge and high level  */
/**
 * @}
 */
 ...
 * @retval None
 */
#define __HAL_TSC_DISABLE(__HANDLE__) \
  ((__HANDLE__)->Instance->CR &= (~TSC_CR_TSCE))
 ...
 * @retval None
 */
#define __HAL_TSC_START_ACQ(__HANDLE__) \
  ((__HANDLE__)->Instance->CR |= TSC_CR_START)
 ...
 * @retval None
 */
#define __HAL_TSC_STOP_ACQ(__HANDLE__) \
  ((__HANDLE__)->Instance->CR &= (~TSC_CR_START))
 ...
 * @retval None
 */
#define __HAL_TSC_SET_IODEF_OUTPPLOW(__HANDLE__) \
  ((__HANDLE__)->Instance->CR &= (~TSC_CR_IODEF))
 ...
 * @retval None
 */
#define __HAL_TSC_SET_IODEF_INFLOAT(__HANDLE__) \
  ((__HANDLE__)->Instance->CR |= TSC_CR_IODEF)
 ...
 * @retval None
 */
#define __HAL_TSC_SET_SYNC_POL_FALL(__HANDLE__) \
  ((__HANDLE__)->Instance->CR &= (~TSC_CR_SYNCPOL))
 ...
 * @retval None
 */
#define __HAL_TSC_SET_SYNC_POL_RISE_HIGH(__HANDLE__) \
  ((__HANDLE__)->Instance->CR |= TSC_CR_SYNCPOL)
 ...
 * @retval None
 */
#define __HAL_TSC_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
 ...
 * @retval None
 */
#define __HAL_TSC_DISABLE_IT(__HANDLE__, __INTERRUPT__) \
  ((__HANDLE__)->Instance->IER &= (~(__INTERRUPT__)))
 ...
 * @retval None
 */
#define __HAL_TSC_CLEAR_FLAG(__HANDLE__, __FLAG__) \
 ...
 * @retval None
 */
#define __HAL_TSC_ENABLE_HYSTERESIS(__HANDLE__, __GX_IOY_MASK__) \
 ...
 * @retval None
 */
#define __HAL_TSC_CLOSE_ANALOG_SWITCH(__HANDLE__, __GX_IOY_MASK__) \
  ((__HANDLE__)->Instance->IOASCR |= (__GX_IOY_MASK__))
 ...
 * @retval None
 */
#define __HAL_TSC_ENABLE_CHANNEL(__HANDLE__, __GX_IOY_MASK__) \
 ...
 * @retval None
 */
#define __HAL_TSC_ENABLE_SAMPLING(__HANDLE__, __GX_IOY_MASK__) \
 ...
 * @retval None
 */
#define __HAL_TSC_DISABLE_SAMPLING(__HANDLE__, __GX_IOY_MASK__) \
  ((__HANDLE__)->Instance->IOSCR &= (~(__GX_IOY_MASK__)))
 ...
 * @retval None
 */
#define __HAL_TSC_ENABLE_GROUP(__HANDLE__, __GX_MASK__) \
 ...
 * @retval None
 */
#define __HAL_TSC_DISABLE_GROUP(__HANDLE__, __GX_MASK__) \
  ((__HANDLE__)->Instance->IOGCSR &= (~(__GX_MASK__)))
...
#define IS_TSC_CTPH(__VALUE__)                                                 \
  (((__VALUE__) == TSC_CTPH_1CYCLE) || ((__VALUE__) == TSC_CTPH_2CYCLES) ||    \
   ((__VALUE__) == TSC_CTPH_3CYCLES) || ((__VALUE__) == TSC_CTPH_4CYCLES) ||   \
   ((__VALUE__) == TSC_CTPH_5CYCLES) || ((__VALUE__) == TSC_CTPH_6CYCLES) ||   \
   ((__VALUE__) == TSC_CTPH_7CYCLES) || ((__VALUE__) == TSC_CTPH_8CYCLES) ||   \
   ((__VALUE__) == TSC_CTPH_9CYCLES) || ((__VALUE__) == TSC_CTPH_10CYCLES) ||  \
   ((__VALUE__) == TSC_CTPH_11CYCLES) || ((__VALUE__) == TSC_CTPH_12CYCLES) || \
   ((__VALUE__) == TSC_CTPH_13CYCLES) || ((__VALUE__) == TSC_CTPH_14CYCLES) || \
   ((__VALUE__) == TSC_CTPH_15CYCLES) || ((__VALUE__) == TSC_CTPH_16CYCLES))

#define IS_TSC_CTPL(__VALUE__)                                                 \
  (((__VALUE__) == TSC_CTPL_1CYCLE) || ((__VALUE__) == TSC_CTPL_2CYCLES) ||    \
   ((__VALUE__) == TSC_CTPL_3CYCLES) || ((__VALUE__) == TSC_CTPL_4CYCLES) ||   \
   ((__VALUE__) == TSC_CTPL_5CYCLES) || ((__VALUE__) == TSC_CTPL_6CYCLES) ||   \
   ((__VALUE__) == TSC_CTPL_7CYCLES) || ((__VALUE__) == TSC_CTPL_8CYCLES) ||   \
   ((__VALUE__) == TSC_CTPL_9CYCLES) || ((__VALUE__) == TSC_CTPL_10CYCLES) ||  \
   ((__VALUE__) == TSC_CTPL_11CYCLES) || ((__VALUE__) == TSC_CTPL_12CYCLES) || \
   ((__VALUE__) == TSC_CTPL_13CYCLES) || ((__VALUE__) == TSC_CTPL_14CYCLES) || \
   ((__VALUE__) == TSC_CTPL_15CYCLES) || ((__VALUE__) == TSC_CTPL_16CYCLES))

#define IS_TSC_SS(__VALUE__)                    \
  (((FunctionalState)(__VALUE__) == DISABLE) || \
   ((FunctionalState)(__VALUE__) == ENABLE))

#define IS_TSC_SSD(__VALUE__) \
  (((__VALUE__) == 0UL) || (((__VALUE__) > 0UL) && ((__VALUE__) < 128UL)))

#define IS_TSC_SS_PRESC(__VALUE__) \
  (((__VALUE__) == TSC_SS_PRESC_DIV1) || ((__VALUE__) == TSC_SS_PRESC_DIV2))

#define IS_TSC_PG_PRESC(__VALUE__)                                             \
  (((__VALUE__) == TSC_PG_PRESC_DIV1) || ((__VALUE__) == TSC_PG_PRESC_DIV2) || \
   ((__VALUE__) == TSC_PG_PRESC_DIV4) || ((__VALUE__) == TSC_PG_PRESC_DIV8) || \
...
#define IS_TSC_PG_PRESC_VS_CTPL(__PGPSC__, __CTPL__)                          \
  ((((__PGPSC__) == TSC_PG_PRESC_DIV1) && ((__CTPL__) > TSC_CTPL_2CYCLES)) || \
   (((__PGPSC__) == TSC_PG_PRESC_DIV2) && ((__CTPL__) > TSC_CTPL_1CYCLE)) ||  \
   (((__PGPSC__) > TSC_PG_PRESC_DIV2) &&                                      \
    (((__CTPL__) == TSC_CTPL_1CYCLE) || ((__CTPL__) > TSC_CTPL_1CYCLE))))

#define IS_TSC_MCV(__VALUE__)                                        \
  (((__VALUE__) == TSC_MCV_255) || ((__VALUE__) == TSC_MCV_511) ||   \
   ((__VALUE__) == TSC_MCV_1023) || ((__VALUE__) == TSC_MCV_2047) || \
   ((__VALUE__) == TSC_MCV_4095) || ((__VALUE__) == TSC_MCV_8191) || \
   ((__VALUE__) == TSC_MCV_16383))

#define IS_TSC_IODEF(__VALUE__) \
  (((__VALUE__) == TSC_IODEF_OUT_PP_LOW) || ((__VALUE__) == TSC_IODEF_IN_FLOAT))

#define IS_TSC_SYNC_POL(__VALUE__)               \
  (((__VALUE__) == TSC_SYNC_POLARITY_FALLING) || \
   ((__VALUE__) == TSC_SYNC_POLARITY_RISING))

#define IS_TSC_ACQ_MODE(__VALUE__)         \
  (((__VALUE__) == TSC_ACQ_MODE_NORMAL) || \
   ((__VALUE__) == TSC_ACQ_MODE_SYNCHRO))
...
HAL_StatusTypeDef HAL_TSC_UnRegisterCallback(
    TSC_HandleTypeDef *htsc, HAL_TSC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_TSC_REGISTER_CALLBACKS */
/**
 * @}
 */
