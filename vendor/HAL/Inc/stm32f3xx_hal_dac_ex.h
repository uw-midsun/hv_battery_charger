...
#define DAC_TRIGGER_T6_TRGO                                              \
  ((uint32_t)DAC_CR_TEN1) /*!< TIM6 TRGO selected as external conversion \
                             trigger for DAC channel */
#define DAC_TRIGGER_T2_TRGO                                                \
  ((uint32_t)(DAC_CR_TSEL1_2 |                                             \
              DAC_CR_TEN1)) /*!< TIM2 TRGO selected as external conversion \
                               trigger for DAC channel */
#define DAC_TRIGGER_T15_TRGO                                               \
  ((uint32_t)(DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                            \
              DAC_CR_TEN1)) /*!< TIM5 TRGO selected as external conversion \
                               trigger for DAC channel */
...
#define DAC_TRIGGER_SOFTWARE                                                   \
  ((uint32_t)(DAC_CR_TSEL1 | DAC_CR_TEN1)) /*!< Conversion started by software \
                                              trigger for DAC channel */
...
#if defined(STM32F302xE) || defined(STM32F302xC) || defined(STM32F302x8)
...
#define IS_DAC_TRIGGER(TRIGGER)                                                \
  (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_T2_TRGO) ||    \
   ((TRIGGER) == DAC_TRIGGER_T3_TRGO) || ((TRIGGER) == DAC_TRIGGER_T4_TRGO) || \
   ((TRIGGER) == DAC_TRIGGER_T15_TRGO) ||                                      \
   ((TRIGGER) == DAC_TRIGGER_T6_TRGO) || ((TRIGGER) == DAC_TRIGGER_EXT_IT9) || \
...
#define DAC_TRIGGER_T5_TRGO                                                \
  ((uint32_t)(DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                            \
              DAC_CR_TEN1)) /*!< TIM5 TRGO selected as external conversion \
                               trigger for DAC channel (DAC1) */
#define DAC_TRIGGER_T18_TRGO                                                  \
  DAC_TRIGGER_T5_TRGO /*!< TIM18 TRGO selected as external conversion trigger \
                         for DAC channel (DAC2) */
#define DAC_TRIGGER_T6_TRGO                                              \
  ((uint32_t)DAC_CR_TEN1) /*!< TIM6 TRGO selected as external conversion \
                             trigger for DAC channel */
#define DAC_TRIGGER_T7_TRGO                                                \
...
#define IS_DAC_TRIGGER(TRIGGER)                                                \
  (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_T2_TRGO) ||    \
   ...
   ((TRIGGER) == DAC_TRIGGER_T7_TRGO) || ((TRIGGER) == DAC_TRIGGER_EXT_IT9) || \
   ((TRIGGER) == DAC_TRIGGER_SOFTWARE))
...
#define DAC_TRIGGER_HRTIM1_DACTRG3                                    \
  DAC_TRIGGER_HRTIM1_DACTRG2 /*!< HRTIM1 DACTRG3 selected as external \
                                conversion trigger for DAC channel (DAC2)*/
...
#if defined(STM32F302xE) || defined(STM32F302xC) || defined(STM32F301x8) || \
