...
typedef struct __I2S_HandleTypeDef {
  ...
  void (*IrqHandlerISR)(struct __I2S_HandleTypeDef
                            *hi2s); /*!< I2S function pointer on IrqHandler   */
...
typedef enum {
  ...
  HAL_I2S_TX_RX_HALF_COMPLETE_CB_ID =
      0x05U,                      /*!< I2S TxRx Half Completed callback ID  */
...
#define IS_I2S_CLOCKSOURCE(CLOCK) \
  (((CLOCK) == I2S_CLOCK_EXTERNAL) || ((CLOCK) == I2S_CLOCK_SYSCLK))
/**
 * @}
 */
