...
typedef struct {
  ...
  uint32_t PageAddress; /*!< PageAdress: Initial FLASH page address to erase
                           ...
                           number between Min_Data = FLASH_BASE and Max_Data =
                           FLASH_BANK1_END */
 ...
 * @{
 */
#define OB_SRAM_PARITY_SET                           \
  ((uint8_t)0x00U) /*!< SRAM parity check enable set \
                    */
...
#define OB_SDACD_VDD_MONITOR_SET              \
