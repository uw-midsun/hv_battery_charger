...
#define RCC_POSITION_HPRE \
  (uint32_t)POSITION_VAL( \
      RCC_CFGR_HPRE) /*!< field position in register RCC_CFGR */
#define RCC_POSITION_PPRE1 \
  (uint32_t)POSITION_VAL(  \
      RCC_CFGR_PPRE1) /*!< field position in register RCC_CFGR */
#define RCC_POSITION_PPRE2 \
  (uint32_t)POSITION_VAL(  \
      RCC_CFGR_PPRE2) /*!< field position in register RCC_CFGR */
#define RCC_POSITION_HSICAL \
  (uint32_t)POSITION_VAL(   \
      RCC_CR_HSICAL) /*!< field position in register RCC_CR */
#define RCC_POSITION_HSITRIM \
  (uint32_t)POSITION_VAL(    \
      RCC_CR_HSITRIM) /*!< field position in register RCC_CR */
#define RCC_POSITION_PLLMUL \
  (uint32_t)POSITION_VAL(   \
      RCC_CFGR_PLLMUL) /*!< field position in register RCC_CFGR */
#define RCC_POSITION_USART1SW \
  (uint32_t)0U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_USART2SW \
  (uint32_t)16U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_USART3SW \
  (uint32_t)18U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM1SW \
  (uint32_t)8U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM8SW \
  (uint32_t)9U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM15SW \
  (uint32_t)10U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM16SW \
  (uint32_t)11U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM17SW \
  (uint32_t)13U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM20SW \
  (uint32_t)15U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM2SW \
  (uint32_t)24U /*!< field position in register RCC_CFGR3 */
#define RCC_POSITION_TIM34SW \
  (uint32_t)25U /*!< field position in register RCC_CFGR3 */
...
#define LL_RCC_CSR_V18PWRRSTF \
  RCC_CSR_V18PWRRSTF /*!< Reset flag of the 1.8 V domain. */
...
#define LL_RCC_MCO1SOURCE_HSI \
  RCC_CFGR_MCOSEL_HSI /*!< HSI selection as MCO source */
#define LL_RCC_MCO1SOURCE_HSE \
  RCC_CFGR_MCOSEL_HSE /*!< HSE selection as MCO source */
#define LL_RCC_MCO1SOURCE_LSI \
  RCC_CFGR_MCOSEL_LSI /*!< LSI selection as MCO source */
#define LL_RCC_MCO1SOURCE_LSE \
  RCC_CFGR_MCOSEL_LSE /*!< LSE selection as MCO source */
...
#define LL_RCC_USART1_CLKSOURCE_PCLK1                                        \
  (uint32_t)((RCC_POSITION_USART1SW << 24U) |                                \
             RCC_CFGR3_USART1SW_PCLK1) /*!< PCLK1 clock used as USART1 clock \
                                          source */
#else
#define LL_RCC_USART1_CLKSOURCE_PCLK2                                        \
  (uint32_t)((RCC_POSITION_USART1SW << 24U) |                                \
             RCC_CFGR3_USART1SW_PCLK2) /*!< PCLK2 clock used as USART1 clock \
                                          source */
#endif                                 /*RCC_CFGR3_USART1SW_PCLK1*/
#define LL_RCC_USART1_CLKSOURCE_SYSCLK                                       \
  (uint32_t)((RCC_POSITION_USART1SW << 24U) |                                \
             RCC_CFGR3_USART1SW_SYSCLK) /*!< System clock selected as USART1 \
                                           clock source */
#define LL_RCC_USART1_CLKSOURCE_LSE                                           \
  (uint32_t)((RCC_POSITION_USART1SW << 24U) |                                 \
             RCC_CFGR3_USART1SW_LSE) /*!< LSE oscillator clock used as USART1 \
                                        clock source */
#define LL_RCC_USART1_CLKSOURCE_HSI                                           \
  (uint32_t)((RCC_POSITION_USART1SW << 24U) |                                 \
             RCC_CFGR3_USART1SW_HSI) /*!< HSI oscillator clock used as USART1 \
                                        clock source */
#if defined(RCC_CFGR3_USART2SW)
#define LL_RCC_USART2_CLKSOURCE_PCLK1                                       \
  (uint32_t)((RCC_POSITION_USART2SW << 24U) |                               \
             RCC_CFGR3_USART2SW_PCLK) /*!< PCLK1 clock used as USART2 clock \
                                         source */
#define LL_RCC_USART2_CLKSOURCE_SYSCLK                                       \
  (uint32_t)((RCC_POSITION_USART2SW << 24U) |                                \
             RCC_CFGR3_USART2SW_SYSCLK) /*!< System clock selected as USART2 \
                                           clock source */
#define LL_RCC_USART2_CLKSOURCE_LSE                                           \
  (uint32_t)((RCC_POSITION_USART2SW << 24U) |                                 \
             RCC_CFGR3_USART2SW_LSE) /*!< LSE oscillator clock used as USART2 \
                                        clock source */
#define LL_RCC_USART2_CLKSOURCE_HSI                                           \
  (uint32_t)((RCC_POSITION_USART2SW << 24U) |                                 \
             RCC_CFGR3_USART2SW_HSI) /*!< HSI oscillator clock used as USART2 \
                                        clock source */
#endif                               /* RCC_CFGR3_USART2SW */
#if defined(RCC_CFGR3_USART3SW)
#define LL_RCC_USART3_CLKSOURCE_PCLK1                                       \
  (uint32_t)((RCC_POSITION_USART3SW << 24U) |                               \
             RCC_CFGR3_USART3SW_PCLK) /*!< PCLK1 clock used as USART3 clock \
                                         source */
#define LL_RCC_USART3_CLKSOURCE_SYSCLK                                       \
  (uint32_t)((RCC_POSITION_USART3SW << 24U) |                                \
             RCC_CFGR3_USART3SW_SYSCLK) /*!< System clock selected as USART3 \
                                           clock source */
#define LL_RCC_USART3_CLKSOURCE_LSE                                           \
  (uint32_t)((RCC_POSITION_USART3SW << 24U) |                                 \
             RCC_CFGR3_USART3SW_LSE) /*!< LSE oscillator clock used as USART3 \
                                        clock source */
#define LL_RCC_USART3_CLKSOURCE_HSI                                           \
  (uint32_t)((RCC_POSITION_USART3SW << 24U) |                                 \
             RCC_CFGR3_USART3SW_HSI) /*!< HSI oscillator clock used as USART3 \
                                        clock source */
...
#define LL_RCC_UART4_CLKSOURCE_PCLK1                                      \
  (uint32_t)((RCC_CFGR3_UART4SW >> 8U) |                                  \
             RCC_CFGR3_UART4SW_PCLK) /*!< PCLK1 clock used as UART4 clock \
                                        source */
#define LL_RCC_UART4_CLKSOURCE_SYSCLK                                      \
  (uint32_t)((RCC_CFGR3_UART4SW >> 8U) |                                   \
             RCC_CFGR3_UART4SW_SYSCLK) /*!< System clock selected as UART4 \
                                          clock source */
#define LL_RCC_UART4_CLKSOURCE_LSE                                          \
  (uint32_t)((RCC_CFGR3_UART4SW >> 8U) |                                    \
             RCC_CFGR3_UART4SW_LSE) /*!< LSE oscillator clock used as UART4 \
                                       clock source */
#define LL_RCC_UART4_CLKSOURCE_HSI                                          \
  (uint32_t)((RCC_CFGR3_UART4SW >> 8U) |                                    \
             RCC_CFGR3_UART4SW_HSI) /*!< HSI oscillator clock used as UART4 \
                                       clock source */
#define LL_RCC_UART5_CLKSOURCE_PCLK1                                      \
  (uint32_t)((RCC_CFGR3_UART5SW >> 8U) |                                  \
             RCC_CFGR3_UART5SW_PCLK) /*!< PCLK1 clock used as UART5 clock \
                                        source */
#define LL_RCC_UART5_CLKSOURCE_SYSCLK                                      \
  (uint32_t)((RCC_CFGR3_UART5SW >> 8U) |                                   \
             RCC_CFGR3_UART5SW_SYSCLK) /*!< System clock selected as UART5 \
                                          clock source */
#define LL_RCC_UART5_CLKSOURCE_LSE                                          \
  (uint32_t)((RCC_CFGR3_UART5SW >> 8U) |                                    \
             RCC_CFGR3_UART5SW_LSE) /*!< LSE oscillator clock used as UART5 \
                                       clock source */
#define LL_RCC_UART5_CLKSOURCE_HSI                                          \
  (uint32_t)((RCC_CFGR3_UART5SW >> 8U) |                                    \
             RCC_CFGR3_UART5SW_HSI) /*!< HSI oscillator clock used as UART5 \
                                       clock source */
/**
 * @}
 */
...
#define LL_RCC_I2C1_CLKSOURCE_HSI                                         \
  (uint32_t)((RCC_CFGR3_I2C1SW << 24U) |                                  \
             RCC_CFGR3_I2C1SW_HSI) /*!< HSI oscillator clock used as I2C1 \
                                      clock source */
#define LL_RCC_I2C1_CLKSOURCE_SYSCLK                                           \
  (uint32_t)((RCC_CFGR3_I2C1SW << 24U) |                                       \
             RCC_CFGR3_I2C1SW_SYSCLK) /*!< System clock selected as I2C1 clock \
                                         source */
#if defined(RCC_CFGR3_I2C2SW)
#define LL_RCC_I2C2_CLKSOURCE_HSI                                         \
  (uint32_t)((RCC_CFGR3_I2C2SW << 24U) |                                  \
             RCC_CFGR3_I2C2SW_HSI) /*!< HSI oscillator clock used as I2C2 \
                                      clock source */
#define LL_RCC_I2C2_CLKSOURCE_SYSCLK                                           \
  (uint32_t)((RCC_CFGR3_I2C2SW << 24U) |                                       \
             RCC_CFGR3_I2C2SW_SYSCLK) /*!< System clock selected as I2C2 clock \
                                         source */
#endif                                /*RCC_CFGR3_I2C2SW*/
#if defined(RCC_CFGR3_I2C3SW)
#define LL_RCC_I2C3_CLKSOURCE_HSI                                         \
  (uint32_t)((RCC_CFGR3_I2C3SW << 24U) |                                  \
             RCC_CFGR3_I2C3SW_HSI) /*!< HSI oscillator clock used as I2C3 \
                                      clock source */
#define LL_RCC_I2C3_CLKSOURCE_SYSCLK                                           \
  (uint32_t)((RCC_CFGR3_I2C3SW << 24U) |                                       \
             RCC_CFGR3_I2C3SW_SYSCLK) /*!< System clock selected as I2C3 clock \
                                         source */
...
#define LL_RCC_I2S_CLKSOURCE_SYSCLK \
  RCC_CFGR_I2SSRC_SYSCLK /*!< System clock selected as I2S clock source */
#define LL_RCC_I2S_CLKSOURCE_PIN \
  RCC_CFGR_I2SSRC_EXT /*!< External clock selected as I2S clock source */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_TIM1_CLKSOURCE_PCLK2                                 \
  (uint32_t)(((RCC_POSITION_TIM1SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM1SW_PCLK2) /*!< PCLK2 used as TIM1 clock source */
#define LL_RCC_TIM1_CLKSOURCE_PLL                                   \
  (uint32_t)(((RCC_POSITION_TIM1SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM1SW_PLL) /*!< PLL clock used as TIM1 clock source */
#if defined(RCC_CFGR3_TIM8SW)
#define LL_RCC_TIM8_CLKSOURCE_PCLK2                                 \
  (uint32_t)(((RCC_POSITION_TIM8SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM8SW_PCLK2) /*!< PCLK2 used as TIM8 clock source */
#define LL_RCC_TIM8_CLKSOURCE_PLL                                   \
  (uint32_t)(((RCC_POSITION_TIM8SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM8SW_PLL) /*!< PLL clock used as TIM8 clock source */
#endif                             /*RCC_CFGR3_TIM8SW*/
#if defined(RCC_CFGR3_TIM15SW)
#define LL_RCC_TIM15_CLKSOURCE_PCLK2                                 \
  (uint32_t)(((RCC_POSITION_TIM15SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM15SW_PCLK2) /*!< PCLK2 used as TIM15 clock source */
#define LL_RCC_TIM15_CLKSOURCE_PLL                                            \
  (uint32_t)(((RCC_POSITION_TIM15SW - RCC_POSITION_TIM1SW) << 27U) |          \
             RCC_CFGR3_TIM15SW_PLL) /*!< PLL clock used as TIM15 clock source \
                                     */
#endif                              /*RCC_CFGR3_TIM15SW*/
#if defined(RCC_CFGR3_TIM16SW)
#define LL_RCC_TIM16_CLKSOURCE_PCLK2                                 \
  (uint32_t)(((RCC_POSITION_TIM16SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM16SW_PCLK2) /*!< PCLK2 used as TIM16 clock source */
#define LL_RCC_TIM16_CLKSOURCE_PLL                                            \
  (uint32_t)(((RCC_POSITION_TIM16SW - RCC_POSITION_TIM1SW) << 27U) |          \
             RCC_CFGR3_TIM16SW_PLL) /*!< PLL clock used as TIM16 clock source \
                                     */
#endif                              /*RCC_CFGR3_TIM16SW*/
#if defined(RCC_CFGR3_TIM17SW)
#define LL_RCC_TIM17_CLKSOURCE_PCLK2                                 \
  (uint32_t)(((RCC_POSITION_TIM17SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM17SW_PCLK2) /*!< PCLK2 used as TIM17 clock source */
#define LL_RCC_TIM17_CLKSOURCE_PLL                                            \
  (uint32_t)(((RCC_POSITION_TIM17SW - RCC_POSITION_TIM1SW) << 27U) |          \
             RCC_CFGR3_TIM17SW_PLL) /*!< PLL clock used as TIM17 clock source \
                                     */
#endif                              /*RCC_CFGR3_TIM17SW*/
#if defined(RCC_CFGR3_TIM20SW)
#define LL_RCC_TIM20_CLKSOURCE_PCLK2                                 \
  (uint32_t)(((RCC_POSITION_TIM20SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM20SW_PCLK2) /*!< PCLK2 used as TIM20 clock source */
#define LL_RCC_TIM20_CLKSOURCE_PLL                                            \
  (uint32_t)(((RCC_POSITION_TIM20SW - RCC_POSITION_TIM1SW) << 27U) |          \
             RCC_CFGR3_TIM20SW_PLL) /*!< PLL clock used as TIM20 clock source \
                                     */
#endif                              /*RCC_CFGR3_TIM20SW*/
#if defined(RCC_CFGR3_TIM2SW)
#define LL_RCC_TIM2_CLKSOURCE_PCLK1                                 \
  (uint32_t)(((RCC_POSITION_TIM2SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM2SW_PCLK1) /*!< PCLK1 used as TIM2 clock source */
#define LL_RCC_TIM2_CLKSOURCE_PLL                                   \
  (uint32_t)(((RCC_POSITION_TIM2SW - RCC_POSITION_TIM1SW) << 27U) | \
             RCC_CFGR3_TIM2SW_PLL) /*!< PLL clock used as TIM2 clock source */
#endif                             /*RCC_CFGR3_TIM2SW*/
#if defined(RCC_CFGR3_TIM34SW)
#define LL_RCC_TIM34_CLKSOURCE_PCLK1                                         \
  (uint32_t)(((RCC_POSITION_TIM34SW - RCC_POSITION_TIM1SW) << 27U) |         \
             RCC_CFGR3_TIM34SW_PCLK1) /*!< PCLK1 used as TIM3/4 clock source \
                                       */
#define LL_RCC_TIM34_CLKSOURCE_PLL                                             \
  (uint32_t)(((RCC_POSITION_TIM34SW - RCC_POSITION_TIM1SW) << 27U) |           \
             RCC_CFGR3_TIM34SW_PLL) /*!< PLL clock used as TIM3/4 clock source \
                                     */
...
#if defined(HRTIM1)
/** @defgroup RCC_LL_EC_HRTIM1_CLKSOURCE Peripheral HRTIM1 clock source
 * selection
 * @{
 */
#define LL_RCC_HRTIM1_CLKSOURCE_PCLK2 \
  RCC_CFGR3_HRTIM1SW_PCLK2 /*!< PCLK2 used as  HRTIM1 clock source */
#define LL_RCC_HRTIM1_CLKSOURCE_PLL \
  RCC_CFGR3_HRTIM1SW_PLL /*!< PLL clock used as  HRTIM1 clock source */
/**
 * @}
 */
...
#define LL_RCC_CEC_CLKSOURCE_HSI_DIV244                                     \
  RCC_CFGR3_CECSW_HSI_DIV244 /*!< HSI clock divided by 244 selected as HDMI \
...
#define LL_RCC_USB_CLKSOURCE_PLL \
  RCC_CFGR_USBPRE_DIV1 /*!< USB prescaler is PLL clock divided by 1 */
...
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_2 \
  RCC_CFGR_ADCPRE_DIV2 /*!< ADC prescaler PCLK divided by 2 */
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_4 \
  RCC_CFGR_ADCPRE_DIV4 /*!< ADC prescaler PCLK divided by 4 */
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_6 \
  RCC_CFGR_ADCPRE_DIV6 /*!< ADC prescaler PCLK divided by 6 */
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_8 \
  RCC_CFGR_ADCPRE_DIV8 /*!< ADC prescaler PCLK divided by 8 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_ADC1_CLKSRC_HCLK \
  RCC_CFGR2_ADC1PRES_NO /*!< ADC1 clock disabled, ADC1 can use AHB clock */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_1 \
  RCC_CFGR2_ADC1PRES_DIV1 /*!< ADC1 PLL clock divided by 1 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_2 \
  RCC_CFGR2_ADC1PRES_DIV2 /*!< ADC1 PLL clock divided by 2 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_4 \
  RCC_CFGR2_ADC1PRES_DIV4 /*!< ADC1 PLL clock divided by 4 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_6 \
  RCC_CFGR2_ADC1PRES_DIV6 /*!< ADC1 PLL clock divided by 6 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_8 \
  RCC_CFGR2_ADC1PRES_DIV8 /*!< ADC1 PLL clock divided by 8 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_10 \
  RCC_CFGR2_ADC1PRES_DIV10 /*!< ADC1 PLL clock divided by 10 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_12 \
  RCC_CFGR2_ADC1PRES_DIV12 /*!< ADC1 PLL clock divided by 12 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_16 \
  RCC_CFGR2_ADC1PRES_DIV16 /*!< ADC1 PLL clock divided by 16 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_32 \
  RCC_CFGR2_ADC1PRES_DIV32 /*!< ADC1 PLL clock divided by 32 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_64 \
  RCC_CFGR2_ADC1PRES_DIV64 /*!< ADC1 PLL clock divided by 64 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_128 \
  RCC_CFGR2_ADC1PRES_DIV128 /*!< ADC1 PLL clock divided by 128 */
#define LL_RCC_ADC1_CLKSRC_PLL_DIV_256 \
  RCC_CFGR2_ADC1PRES_DIV256 /*!< ADC1 PLL clock divided by 256 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_ADC12_CLKSRC_HCLK                                             \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) |                                   \
             RCC_CFGR2_ADCPRE12_NO) /*!< ADC12 clock disabled, ADC12 can use \
                                       AHB clock */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_1      \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV1) /*!< ADC12 PLL clock divided by 1 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_2      \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV2) /*!< ADC12 PLL clock divided by 2 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_4      \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV4) /*!< ADC12 PLL clock divided by 4 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_6      \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV6) /*!< ADC12 PLL clock divided by 6 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_8      \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV8) /*!< ADC12 PLL clock divided by 8 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_10     \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV10) /*!< ADC12 PLL clock divided by 10 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_12     \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV12) /*!< ADC12 PLL clock divided by 12 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_16     \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV16) /*!< ADC12 PLL clock divided by 16 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_32     \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV32) /*!< ADC12 PLL clock divided by 32 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_64     \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV64) /*!< ADC12 PLL clock divided by 64 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_128    \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV128) /*!< ADC12 PLL clock divided by 128 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_256    \
  (uint32_t)((RCC_CFGR2_ADCPRE12 << 16U) | \
             RCC_CFGR2_ADCPRE12_DIV256) /*!< ADC12 PLL clock divided by 256 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_ADC34_CLKSRC_HCLK                                             \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) |                                   \
             RCC_CFGR2_ADCPRE34_NO) /*!< ADC34 clock disabled, ADC34 can use \
                                       AHB clock */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_1      \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV1) /*!< ADC34 PLL clock divided by 1 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_2      \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV2) /*!< ADC34 PLL clock divided by 2 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_4      \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV4) /*!< ADC34 PLL clock divided by 4 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_6      \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV6) /*!< ADC34 PLL clock divided by 6 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_8      \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV8) /*!< ADC34 PLL clock divided by 8 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_10     \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV10) /*!< ADC34 PLL clock divided by 10 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_12     \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV12) /*!< ADC34 PLL clock divided by 12 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_16     \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV16) /*!< ADC34 PLL clock divided by 16 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_32     \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV32) /*!< ADC34 PLL clock divided by 32 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_64     \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV64) /*!< ADC34 PLL clock divided by 64 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_128    \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV128) /*!< ADC34 PLL clock divided by 128 */
#define LL_RCC_ADC34_CLKSRC_PLL_DIV_256    \
  (uint32_t)((RCC_CFGR2_ADCPRE34 << 16U) | \
             RCC_CFGR2_ADCPRE34_DIV256) /*!< ADC34 PLL clock divided by 256 */
/**
 * @}
 */
 ...
 */
#define LL_RCC_ADC12_CLKSRC_HCLK \
  RCC_CFGR2_ADCPRE12_NO /*!< ADC12 clock disabled, ADC12 can use AHB clock */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_1 \
  RCC_CFGR2_ADCPRE12_DIV1 /*!< ADC12 PLL clock divided by 1 */
#define LL_RCC_ADC12_CLKSRC_PLL_DIV_2 \
  RCC_CFGR2_ADCPRE12_DIV2 /*!< ADC12 PLL clock divided by 2 */
...
/** @defgroup RCC_LL_EC_SDADC_CLKSOURCE_SYSCLK Peripheral SDADC clock source
 * selection
 * @{
 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_1 \
  RCC_CFGR_SDPRE_DIV1 /*!< SDADC CLK not divided */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_2 \
  RCC_CFGR_SDPRE_DIV2 /*!< SDADC CLK divided by 2 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_4 \
  RCC_CFGR_SDPRE_DIV4 /*!< SDADC CLK divided by 4 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_6 \
  RCC_CFGR_SDPRE_DIV6 /*!< SDADC CLK divided by 6 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_8 \
  RCC_CFGR_SDPRE_DIV8 /*!< SDADC CLK divided by 8 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_10 \
  RCC_CFGR_SDPRE_DIV10 /*!< SDADC CLK divided by 10 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_12 \
  RCC_CFGR_SDPRE_DIV12 /*!< SDADC CLK divided by 12 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_14 \
  RCC_CFGR_SDPRE_DIV14 /*!< SDADC CLK divided by 14 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_16 \
  RCC_CFGR_SDPRE_DIV16 /*!< SDADC CLK divided by 16 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_20 \
  RCC_CFGR_SDPRE_DIV20 /*!< SDADC CLK divided by 20 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_24 \
  RCC_CFGR_SDPRE_DIV24 /*!< SDADC CLK divided by 24 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_28 \
  RCC_CFGR_SDPRE_DIV28 /*!< SDADC CLK divided by 28 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_32 \
  RCC_CFGR_SDPRE_DIV32 /*!< SDADC CLK divided by 32 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_36 \
  RCC_CFGR_SDPRE_DIV36 /*!< SDADC CLK divided by 36 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_40 \
  RCC_CFGR_SDPRE_DIV40 /*!< SDADC CLK divided by 40 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_44 \
  RCC_CFGR_SDPRE_DIV44 /*!< SDADC CLK divided by 44 */
#define LL_RCC_SDADC_CLKSRC_SYS_DIV_48 \
  RCC_CFGR_SDPRE_DIV48 /*!< SDADC CLK divided by 48 */
/**
 * @}
 */
...
#define LL_RCC_UART4_CLKSOURCE \
  RCC_CFGR3_UART4SW /*!< UART4 Clock source selection */
#define LL_RCC_UART5_CLKSOURCE \
  RCC_CFGR3_UART5SW /*!< UART5 Clock source selection */
/**
 * @}
 */
...
#define LL_RCC_TIM1_CLKSOURCE \
  (RCC_POSITION_TIM1SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM1 Clock source selection */
#if defined(RCC_CFGR3_TIM2SW)
#define LL_RCC_TIM2_CLKSOURCE \
  (RCC_POSITION_TIM2SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM2 Clock source selection */
#endif                  /*RCC_CFGR3_TIM2SW*/
#if defined(RCC_CFGR3_TIM8SW)
#define LL_RCC_TIM8_CLKSOURCE \
  (RCC_POSITION_TIM8SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM8 Clock source selection */
#endif                  /*RCC_CFGR3_TIM8SW*/
#if defined(RCC_CFGR3_TIM15SW)
#define LL_RCC_TIM15_CLKSOURCE \
  (RCC_POSITION_TIM15SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM15 Clock source selection */
#endif                  /*RCC_CFGR3_TIM15SW*/
#if defined(RCC_CFGR3_TIM16SW)
#define LL_RCC_TIM16_CLKSOURCE \
  (RCC_POSITION_TIM16SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM16 Clock source selection */
#endif                  /*RCC_CFGR3_TIM16SW*/
#if defined(RCC_CFGR3_TIM17SW)
#define LL_RCC_TIM17_CLKSOURCE \
  (RCC_POSITION_TIM17SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM17 Clock source selection */
#endif                  /*RCC_CFGR3_TIM17SW*/
#if defined(RCC_CFGR3_TIM20SW)
#define LL_RCC_TIM20_CLKSOURCE \
  (RCC_POSITION_TIM20SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM20 Clock source selection */
#endif                  /*RCC_CFGR3_TIM20SW*/
#if defined(RCC_CFGR3_TIM34SW)
#define LL_RCC_TIM34_CLKSOURCE \
  (RCC_POSITION_TIM34SW -      \
   RCC_POSITION_TIM1SW) /*!< TIM3/4 Clock source selection */
#endif                  /*RCC_CFGR3_TIM34SW*/
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_HRTIM1_CLKSOURCE \
  RCC_CFGR3_HRTIM1SW /*!< HRTIM1 Clock source selection */
/**
 * @}
 */
...
#define LL_RCC_ADC1_CLKSOURCE \
  RCC_CFGR2_ADC1PRES /*!< ADC1 Clock source selection */
#else
#define LL_RCC_ADC12_CLKSOURCE \
  RCC_CFGR2_ADCPRE12 /*!< ADC12 Clock source selection */
#if defined(RCC_CFGR2_ADCPRE34)
#define LL_RCC_ADC34_CLKSOURCE \
  RCC_CFGR2_ADCPRE34 /*!< ADC34 Clock source selection */
 ...
 * @{
 */
#define LL_RCC_SDADC_CLKSOURCE \
  RCC_CFGR_SDPRE /*!< SDADC Clock source selection */
/**
 * @}
 */
...
#define LL_RCC_PLLSOURCE_HSE                                                   \
  RCC_CFGR_PLLSRC_HSE_PREDIV /*!< HSE/PREDIV clock selected as PLL entry clock \
                                source */
#if defined(RCC_PLLSRC_PREDIV1_SUPPORT)
#define LL_RCC_PLLSOURCE_HSI                                                   \
  RCC_CFGR_PLLSRC_HSI_PREDIV /*!< HSI/PREDIV clock selected as PLL entry clock \
                                source */
#else
...
#define LL_RCC_PLLSOURCE_HSE_DIV_10                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV10) /*!< HSE/10 clock selected as PLL entry clock \
                              source */
#define LL_RCC_PLLSOURCE_HSE_DIV_11                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV11) /*!< HSE/11 clock selected as PLL entry clock \
                              source */
#define LL_RCC_PLLSOURCE_HSE_DIV_12                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV12) /*!< HSE/12 clock selected as PLL entry clock \
                              source */
#define LL_RCC_PLLSOURCE_HSE_DIV_13                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV13) /*!< HSE/13 clock selected as PLL entry clock \
                              source */
#define LL_RCC_PLLSOURCE_HSE_DIV_14                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV14) /*!< HSE/14 clock selected as PLL entry clock \
                              source */
#define LL_RCC_PLLSOURCE_HSE_DIV_15                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV15) /*!< HSE/15 clock selected as PLL entry clock \
                              source */
#define LL_RCC_PLLSOURCE_HSE_DIV_16                                      \
  (RCC_CFGR_PLLSRC_HSE_PREDIV |                                          \
   RCC_CFGR2_PREDIV_DIV16) /*!< HSE/16 clock selected as PLL entry clock \
                              source */
 ...
 * LL_RCC_PLL_GetMultiplicator() , @ref LL_RCC_PLL_GetPrediv());
 ...
 * @param  __INPUTFREQ__ PLL Input frequency (based on HSE div Prediv / HSI div
 * 2)
 * @param  __PLLMUL__ This parameter can be one of the following values:
 *         @arg @ref LL_RCC_PLL_MUL_2
 *         @arg @ref LL_RCC_PLL_MUL_3
...
__STATIC_INLINE void LL_RCC_SetUARTClockSource(uint32_t UARTxSource) {
  MODIFY_REG(RCC->CFGR3, ((UARTxSource & 0x0000FFFFU) << 8U),
             (UARTxSource & (RCC_CFGR3_UART4SW | RCC_CFGR3_UART5SW)));
}
#endif /* RCC_CFGR3_UART4SW || RCC_CFGR3_UART5SW */
...
__STATIC_INLINE void LL_RCC_SetI2CClockSource(uint32_t I2CxSource) {
  MODIFY_REG(RCC->CFGR3, ((I2CxSource & 0xFF000000U) >> 24U),
             (I2CxSource & 0x00FFFFFFU));
}
...
__STATIC_INLINE void LL_RCC_SetTIMClockSource(uint32_t TIMxSource) {
  MODIFY_REG(RCC->CFGR3, (RCC_CFGR3_TIM1SW << (TIMxSource >> 27U)),
             (TIMxSource & 0x03FFFFFFU));
}
#endif /* RCC_CFGR3_TIMSW */
...
__STATIC_INLINE uint32_t LL_RCC_GetTIMClockSource(uint32_t TIMx) {
  return (uint32_t)(READ_BIT(RCC->CFGR3, (RCC_CFGR3_TIM1SW << TIMx)) |
                    (TIMx << 27U));
}
#endif /* RCC_CFGR3_TIMSW */
...
#if (defined(RCC_CFGR_ADCPRE) || defined(RCC_CFGR2_ADC1PRES) || \
     defined(RCC_CFGR2_ADCPRE12) || defined(RCC_CFGR2_ADCPRE34))
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource);
#endif /*RCC_CFGR_ADCPRE || RCC_CFGR2_ADC1PRES || RCC_CFGR2_ADCPRE12 || \
          RCC_CFGR2_ADCPRE34 */
#if defined(RCC_CFGR_SDPRE)
