...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef* hadc) {
  ...
  if (HAL_IS_BIT_CLR(hadc->State, HAL_ADC_STATE_ERROR_INTERNAL) &&
    ...
    if ((ADC_IS_ENABLE(hadc) == RESET) &&
      ...
      MODIFY_REG(tmpADC_Common->CCR, ADC_CCR_CKMODE, hadc->Init.ClockPrescaler);
    }
    ...
    if (hadc->Init.DiscontinuousConvMode == ENABLE) {
      if (hadc->Init.ContinuousConvMode == DISABLE) {
        ...
        SET_BIT(tmpCFGR, ADC_CFGR_DISCEN | ADC_CFGR_DISCONTINUOUS_NUM(
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef* hadc) {
  ...
  if (tmp_hal_status == HAL_OK) {
    ...
    if ((ADC_IS_ENABLE(hadc) == RESET) &&
      ...
      */
      CLEAR_BIT(tmpADC_Common->CCR, ADC_CCR_CKMODE | ADC_CCR_VBATEN |
                                        ADC_CCR_TSEN | ADC_CCR_VREFEN |
  ...
  if (tmp_hal_status == HAL_OK) {
    ...
    CLEAR_BIT(
        ...
        (ADC_CR1_AWDEN | ADC_CR1_JAWDEN | ADC_CR1_DISCNUM | ADC_CR1_JDISCEN |
         ADC_CR1_DISCEN | ADC_CR1_JAUTO | ADC_CR1_AWDSGL | ADC_CR1_SCAN |
    ...
    /* Reset register SQR1 */
    CLEAR_BIT(hadc->Instance->SQR1, ADC_SQR1_L | ADC_SQR1_SQ16 | ADC_SQR1_SQ15 |
    ...
    /* Reset register SQR2 */
    CLEAR_BIT(hadc->Instance->SQR2, ADC_SQR2_SQ12 | ADC_SQR2_SQ11 |
                                        ADC_SQR2_SQ10 | ADC_SQR2_SQ9 |
                                        ADC_SQR2_SQ8 | ADC_SQR2_SQ7);

    /* Reset register SQR3 */
    CLEAR_BIT(hadc->Instance->SQR3, ADC_SQR3_SQ6 | ADC_SQR3_SQ5 | ADC_SQR3_SQ4 |
                                        ADC_SQR3_SQ3 | ADC_SQR3_SQ2 |
                                        ADC_SQR3_SQ1);

    /* Reset register JSQR */
    CLEAR_BIT(hadc->Instance->JSQR, ADC_JSQR_JL | ADC_JSQR_JSQ4 |
                                        ADC_JSQR_JSQ3 | ADC_JSQR_JSQ2 |
                                        ADC_JSQR_JSQ1);
...
void HAL_ADC_IRQHandler(ADC_HandleTypeDef* hadc) {
  uint32_t overrun_error =
      0U; /* flag set if overrun occurrence has to be considered as an error */
  ADC_Common_TypeDef* tmpADC_Common;
  uint32_t tmp_cfgr = 0x0U;
...
HAL_StatusTypeDef HAL_ADCEx_Calibration_SetValue(ADC_HandleTypeDef* hadc,
  ...
  if ((ADC_IS_ENABLE(hadc) != RESET) &&
    ...
    if (SingleDiff == ADC_DIFFERENTIAL_ENDED) {
      MODIFY_REG(hadc->Instance->CALFACT, ADC_CALFACT_CALFACT_D,
                 ADC_CALFACT_DIFF_SET(CalibrationFactor));
    } else {
      MODIFY_REG(hadc->Instance->CALFACT, ADC_CALFACT_CALFACT_S,
                 CalibrationFactor);
    }
  } else {
    /* Update ADC state machine to error */
...
HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef* hadc,
  ...
  if (ADC_IS_CONVERSION_ONGOING_REGULAR(hadc) == RESET) {
    ...
    /* For Rank 1 to 4U */
    if (sConfig->Rank < 5U) {
      MODIFY_REG(hadc->Instance->SQR1, ADC_SQR1_RK(ADC_SQR2_SQ5, sConfig->Rank),
                 ADC_SQR1_RK(sConfig->Channel, sConfig->Rank));
    }
    /* For Rank 5 to 9U */
    else if (sConfig->Rank < 10U) {
      MODIFY_REG(hadc->Instance->SQR2, ADC_SQR2_RK(ADC_SQR2_SQ5, sConfig->Rank),
      ...
      switch (sConfig->OffsetNumber) {
        case ADC_OFFSET_1:
          ...
          MODIFY_REG(hadc->Instance->OFR1,
                     ...
                     ADC_OFR1_OFFSET1_EN | ADC_OFR_CHANNEL(sConfig->Channel) |
                         tmpOffsetShifted);
          break;
        ...
        case ADC_OFFSET_2:
          ...
          MODIFY_REG(hadc->Instance->OFR2,
                     ...
                     ADC_OFR2_OFFSET2_EN | ADC_OFR_CHANNEL(sConfig->Channel) |
                         tmpOffsetShifted);
          break;
        ...
        case ADC_OFFSET_3:
          ...
          MODIFY_REG(hadc->Instance->OFR3,
                     ...
                     ADC_OFR3_OFFSET3_EN | ADC_OFR_CHANNEL(sConfig->Channel) |
                         tmpOffsetShifted);
          break;
        ...
        case ADC_OFFSET_4:
          ...
          MODIFY_REG(hadc->Instance->OFR4,
                     ...
                     ADC_OFR4_OFFSET4_EN | ADC_OFR_CHANNEL(sConfig->Channel) |
                         tmpOffsetShifted);
          break;
...
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(
  ...
  if ((hadc->Init.ScanConvMode == ADC_SCAN_DISABLE) ||
    ...
    if (hadc->InjectionConfig.ChannelCount == 0U) {
      ...
      if (sConfigInjected->ExternalTrigInjecConv !=
          ADC_INJECTED_SOFTWARE_START) {
        SET_BIT(hadc->InjectionConfig.ContextQueue,
                (sConfigInjected->InjectedNbrOfConversion - 1U) |
  ...
  if (ADC_IS_CONVERSION_ONGOING_REGULAR_INJECTED(hadc) == RESET) {
    ...
    if (sConfigInjected->ExternalTrigInjecConv == ADC_INJECTED_SOFTWARE_START) {
      MODIFY_REG(hadc->Instance->CFGR, ADC_CFGR_JAUTO,
                 ADC_CFGR_INJECT_AUTO_CONVERSION(
                     (uint32_t)sConfigInjected->AutoInjectedConv));
    }
    ...
    } else /* For channels 1 to 9U */
    {
      MODIFY_REG(hadc->Instance->SMPR1,
                 ...
                 ADC_SMPR1(sConfigInjected->InjectedSamplingTime,
                           sConfigInjected->InjectedChannel));
    }
    ...
    switch (sConfigInjected->InjectedOffsetNumber) {
      case ADC_OFFSET_1:
        /* Configure offset register 1U */
        MODIFY_REG(hadc->Instance->OFR1, ADC_OFR1_OFFSET1_CH | ADC_OFR1_OFFSET1,
                   ADC_OFR1_OFFSET1_EN |
      ...
      case ADC_OFFSET_2:
        /* Configure offset register 2U */
        MODIFY_REG(hadc->Instance->OFR2, ADC_OFR2_OFFSET2_CH | ADC_OFR2_OFFSET2,
                   ADC_OFR2_OFFSET2_EN |
                       ADC_OFR_CHANNEL(sConfigInjected->InjectedChannel) |
                       tmpOffsetShifted);
        break;
      ...
      case ADC_OFFSET_3:
        /* Configure offset register 3U */
        MODIFY_REG(hadc->Instance->OFR3, ADC_OFR3_OFFSET3_CH | ADC_OFR3_OFFSET3,
                   ADC_OFR3_OFFSET3_EN |
                       ADC_OFR_CHANNEL(sConfigInjected->InjectedChannel) |
                       tmpOffsetShifted);
        break;
      ...
      case ADC_OFFSET_4:
        /* Configure offset register 4U */
        MODIFY_REG(hadc->Instance->OFR4, ADC_OFR4_OFFSET4_CH | ADC_OFR4_OFFSET4,
                   ADC_OFR4_OFFSET4_EN |
                       ADC_OFR_CHANNEL(sConfigInjected->InjectedChannel) |
                       tmpOffsetShifted);
        break;
