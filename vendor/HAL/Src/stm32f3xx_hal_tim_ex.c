...
/**
  ...
  *           @arg TIM_TIM1_ADC2_AWD3:     TIM1_ETR is connected to ADC2 AWD3
  @endif
  @if STM32F303xE
  *         For TIM8, the parameter is a combination of 2 fields (field1 |
  field2):
  *
  *                   field1 can have the following values:
  *           @arg TIM_TIM8_ADC2_NONE:     TIM1_ETR is not connected to any AWD
  (analog watchdog)
  ...
  *
  *                   field2 can have the following values:
  *           @arg TIM_TIM8_ADC3_NONE :    TIM1_ETR is not connected to any AWD
  (analog watchdog)
  ...
  *           @arg TIM_TIM16_MCO:     TIM16 TI1 is connected to MCO
  @endif
  @if STM32F303xE
  *         For TIM20, the parameter is a combination of 2 fields (field1 |
  field2):
  *
  *                   field1 can have the following values:
  *           @arg TIM_TIM20_ADC3_NONE:     TIM1_ETR is not connected to any AWD
  (analog watchdog)
  ...
  *
  *                   field2 can have the following values:
  *           @arg TIM_TIM20_ADC4_NONE :    TIM1_ETR is not connected to any AWD
  (analog watchdog)
