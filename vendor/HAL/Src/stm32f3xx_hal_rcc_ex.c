 ...
 * clocks (ADC, CEC, I2C, I2S, SDADC, HRTIM, TIM, USART, RTC and USB).
 *
 ...
 * values.
 *
 * @note   When the TIMx clock source is APB clock, so the TIMx clock is APB
 * clock or APB clock x 2 depending on the APB prescaler. When the TIMx clock
 * source is PLL clock, so the TIMx clock is PLL clock x 2.
 *
 * @retval HAL status
 */
 ...
 * clocks (ADC, CEC, I2C, I2S, SDADC, HRTIM, TIM, USART, RTC and USB clocks).
 * @retval None
 */
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk) {
  ...
  static const uint16_t adc_pll_prediv_table[16U] = {
      1U,  2U,  4U,   6U,   8U,   10U,  12U,  16U,
      32U, 64U, 128U, 256U, 256U, 256U, 256U, 256U};
#endif /* RCC_CFGR2_ADC1PRES || RCC_CFGR2_ADCPRE12 || RCC_CFGR2_ADCPRE34 */
#if defined(RCC_CFGR_SDPRE)
  static const uint8_t sdadc_prescaler_table[16U] = {
  ...
  switch (PeriphClk) {
    ...
    case RCC_PERIPHCLK_UART4: {
      ...
      else if ((srcclk == RCC_UART4CLKSOURCE_HSI) &&
               (HAL_IS_BIT_SET(RCC->CR, RCC_CR_HSIRDY))) {
        frequency = HSI_VALUE;
      }
      ...
      else if ((srcclk == RCC_UART4CLKSOURCE_LSE) &&
               (HAL_IS_BIT_SET(RCC->BDCR, RCC_BDCR_LSERDY))) {
        frequency = LSE_VALUE;
      }
      break;
    ...
    case RCC_PERIPHCLK_UART5: {
      ...
      else if ((srcclk == RCC_UART5CLKSOURCE_HSI) &&
               (HAL_IS_BIT_SET(RCC->CR, RCC_CR_HSIRDY))) {
        frequency = HSI_VALUE;
      }
      ...
      else if ((srcclk == RCC_UART5CLKSOURCE_LSE) &&
               (HAL_IS_BIT_SET(RCC->BDCR, RCC_BDCR_LSERDY))) {
        frequency = LSE_VALUE;
      }
      break;
    ...
    case RCC_PERIPHCLK_ADC1: {
      ...
      /* PLL clock has been selected */
        ...
        if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
          ...
          frequency =
              RCC_GetPLLCLKFreq() /
              adc_pll_prediv_table[(srcclk >> RCC_CFGR2_ADC1PRES_Pos) & 0xFU];
        }
      }
#else  /* RCC_CFGR_ADCPRE */
      /* ADC1 is set to PLCK2 frequency divided by 2U/4U/6U/8U */
      frequency = HAL_RCC_GetPCLK2Freq() /
                  (((srcclk >> RCC_CFGR_ADCPRE_Pos) + 1U) * 2U);
    ...
    case RCC_PERIPHCLK_ADC12: {
      ...
      /* PLL clock has been selected */
        ...
        if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
          ...
          frequency =
              RCC_GetPLLCLKFreq() /
              adc_pll_prediv_table[(srcclk >> RCC_CFGR2_ADCPRE12_Pos) & 0xF];
        }
      }
      break;
    }
    ...
    case RCC_PERIPHCLK_ADC34: {
      ...
      /* PLL clock has been selected */
        ...
        if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
          ...
          frequency =
              RCC_GetPLLCLKFreq() /
              adc_pll_prediv_table[(srcclk >> RCC_CFGR2_ADCPRE34_Pos) & 0xF];
        }
      }
      break;
    }
    ...
    case RCC_PERIPHCLK_SDADC: {
      ...
      frequency = SystemCoreClock /
                  sdadc_prescaler_table[(srcclk >> RCC_CFGR_SDPRE_Pos) & 0xF];
      break;
    }
#endif /* RCC_CFGR_SDPRE */
