...
/** @defgroup DACEx_Exported_Functions_Group2 DACEx Input and Output operation
functions
...
HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef* hdac,
  ...
  /* Configure for the selected DAC channel: buffer output or switch output,
   * trigger */
