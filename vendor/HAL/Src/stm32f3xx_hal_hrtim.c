 ...
 * @{
 */
static void HRTIM_MasterBase_Config(
    HRTIM_HandleTypeDef *hhrtim, const HRTIM_TimeBaseCfgTypeDef *pTimeBaseCfg);
...
static DMA_HandleTypeDef *HRTIM_GetDMAHandleFromTimerIdx(
    const HRTIM_HandleTypeDef *hhrtim, uint32_t TimerIdx);
 ...
 * @retval None
 */
static void HRTIM_MasterWaveform_Config(
    HRTIM_HandleTypeDef *hhrtim, const HRTIM_TimerCfgTypeDef *pTimerCfg) {
  uint32_t hrtim_mcr;
  uint32_t hrtim_bmcr;
