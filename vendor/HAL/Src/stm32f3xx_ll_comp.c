...
/*       compatibility with other STM32 families.                             */
    ...
    defined(LL_COMP_INPUT_PLUS_DAC1_CH1_COMP1)
...
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__) \
  (((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) ||               \
   ...
   ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_DAC1_CH1_COMP1))
    ...
    defined(LL_COMP_INPUT_PLUS_DAC1_CH1_COMP2)
/* Note: On devices where bit COMP_CSR_COMPxNONINSEL is available,            */
/*       feature LL_COMP_INPUT_PLUS_DAC1_CH1_COMP1 is also available.         */
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__) \
  (((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) ||               \
       ...
       : (((__COMP_INSTANCE__) == COMP2)                                      \
              ? (((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM1_IC1_COMP2) || \
                 ...
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM1_OCCLR_COMP2) ||                         \
...
#define IS_LL_COMP_OUTPUT_SELECTION(__COMP_INSTANCE__, __OUTPUT_SELECTION__)  \
  ((((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_NONE) ||                        \
    ...
    ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM1_BKIN2))                    \
       ...
       : (((__COMP_INSTANCE__) == COMP2)                                      \
              ? (((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM3_OCCLR_COMP2_4) ||                       \
                 ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM1_IC1_COMP2) || \
                 ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM2_IC4_COMP2) || \
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM1_OCCLR_COMP2) ||                         \
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM2_OCCLR_COMP2) ||                         \
                 ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM3_IC1_COMP2))   \
              : (((__COMP_INSTANCE__) == COMP4)                               \
                     ? (((__OUTPUT_SELECTION__) ==                            \
                         LL_COMP_OUTPUT_TIM3_OCCLR_COMP2_4) ||                \
                        ((__OUTPUT_SELECTION__) ==                            \
                         LL_COMP_OUTPUT_TIM3_IC3_COMP4) ||                    \
                        ((__OUTPUT_SELECTION__) ==                            \
                         LL_COMP_OUTPUT_TIM15_IC2_COMP4) ||                   \
                        ((__OUTPUT_SELECTION__) ==                            \
                         LL_COMP_OUTPUT_TIM15_OCCLR_COMP4))                   \
  ...
  ((((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_NONE) ||                        \
    ...
    ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM1_BKIN2))                    \
       ...
       : ((((__COMP_INSTANCE__) == COMP1) || ((__COMP_INSTANCE__) == COMP2))  \
              ? (((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4) ||                     \
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM1_IC1_COMP1_2) ||                         \
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM2_IC4_COMP1_2) ||                         \
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2) ||                       \
                 ((__OUTPUT_SELECTION__) ==                                   \
                  LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2) ||                       \
...
#define IS_LL_COMP_OUTPUT_SELECTION(__COMP_INSTANCE__, __OUTPUT_SELECTION__)            \
  ((((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_NONE) ||                                  \
    ...
    ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM1_TIM8_BKIN2))                         \
       ...
       : ((((__COMP_INSTANCE__) == COMP1) || ((__COMP_INSTANCE__) == COMP2))            \
              ? (((__OUTPUT_SELECTION__) ==                                             \
                  LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2_3_7) ||                             \
                 ((__OUTPUT_SELECTION__) ==                                             \
                  LL_COMP_OUTPUT_TIM2_OCCLR_COMP1_2_3) ||                               \
                 ((__OUTPUT_SELECTION__) ==                                             \
                  LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4_5) ||                             \
                 ((__OUTPUT_SELECTION__) ==                                             \
                  LL_COMP_OUTPUT_TIM1_IC1_COMP1_2) ||                                   \
                 ((__OUTPUT_SELECTION__) ==                                             \
                  LL_COMP_OUTPUT_TIM2_IC4_COMP1_2) ||                                   \
              ...
              : (((__COMP_INSTANCE__) == COMP3)                                         \
                     ? (((__OUTPUT_SELECTION__) ==                                      \
                        ...
                        ((__OUTPUT_SELECTION__) ==                                      \
                         LL_COMP_OUTPUT_TIM4_IC1_COMP3) ||                              \
                        ((__OUTPUT_SELECTION__) ==                                      \
                         LL_COMP_OUTPUT_TIM15_IC1_COMP3) ||                             \
                     ...
                     : (((__COMP_INSTANCE__) == COMP4)                                  \
                            ...
                            : (((__COMP_INSTANCE__) == COMP5)                           \
                                   ? (((__OUTPUT_SELECTION__) ==                        \
                                       LL_COMP_OUTPUT_TIM3_OCCLR_COMP1_2_4_5) ||        \
                                      ((__OUTPUT_SELECTION__) ==                        \
                                       LL_COMP_OUTPUT_TIM8_OCCLR_COMP4_5_6_7) ||        \
                                      ((__OUTPUT_SELECTION__) ==                        \
                                       LL_COMP_OUTPUT_TIM2_IC1_COMP5) ||                \
                                      ((__OUTPUT_SELECTION__) ==                        \
                                       LL_COMP_OUTPUT_TIM4_IC3_COMP5) ||                \
                                      ((__OUTPUT_SELECTION__) ==                        \
                                       LL_COMP_OUTPUT_TIM17_IC1_COMP5) ||               \
                                      ((__OUTPUT_SELECTION__) ==                        \
                                   ...
                                   : (((__COMP_INSTANCE__) == COMP6)                    \
                                          ...
                                          : (((__OUTPUT_SELECTION__) ==                 \
                                             ...
                                             ((__OUTPUT_SELECTION__) ==                 \
                                              LL_COMP_OUTPUT_TIM8_OCCLR_COMP4_5_6_7) || \
                                             ((__OUTPUT_SELECTION__) ==                 \
                                              LL_COMP_OUTPUT_TIM1_IC2_COMP7) ||         \
                                             ((__OUTPUT_SELECTION__) ==                 \
                                              LL_COMP_OUTPUT_TIM2_IC3_COMP7) ||         \
                                             ((__OUTPUT_SELECTION__) ==                 \
                                              LL_COMP_OUTPUT_TIM17_OCCLR_COMP7) ||      \
                                             ((__OUTPUT_SELECTION__) ==                 \
                                              LL_COMP_OUTPUT_TIM17_BKIN))))))))
    ...
    ((__OUTPUT_SELECTION__) == LL_COMP_OUTPUT_TIM1_TIM8_TIM20_BKIN2))                   \
       ...
       : ((((__COMP_INSTANCE__) == COMP1) || ((__COMP_INSTANCE__) == COMP2))            \
              ? (((__OUTPUT_SELECTION__) ==                                             \
                 ...
                 (((__OUTPUT_SELECTION__) ==                                            \
                   LL_COMP_OUTPUT_TIM20_OCCLR_COMP2) &&                                 \
                  ((__COMP_INSTANCE__) == COMP2)))                                      \
              : (((__COMP_INSTANCE__) == COMP3)                                         \
                     ? (((__OUTPUT_SELECTION__) ==                                      \
                         LL_COMP_OUTPUT_TIM1_OCCLR_COMP1_2_3_7) ||                      \
...
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__COMP_INSTANCE__,                 \
  ...
  (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE)                \
       ...
       : ((((__COMP_INSTANCE__) == COMP1) || ((__COMP_INSTANCE__) == COMP2)) \
              ? (((__OUTPUT_BLANKING_SOURCE__) ==                            \
                  LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1_2) ||                   \
                 ((__OUTPUT_BLANKING_SOURCE__) ==                            \
                  LL_COMP_BLANKINGSRC_TIM2_OC3_COMP1_2) ||                   \
                 ((__OUTPUT_BLANKING_SOURCE__) ==                            \
                  LL_COMP_BLANKINGSRC_TIM3_OC3_COMP1_2))                     \
              : (((__COMP_INSTANCE__) == COMP4)                              \
                     ? (((__OUTPUT_BLANKING_SOURCE__) ==                     \
                         LL_COMP_BLANKINGSRC_TIM3_OC4_COMP4) ||              \
                        ((__OUTPUT_BLANKING_SOURCE__) ==                     \
...
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__COMP_INSTANCE__,                               \
  ...
  (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE)                              \
       ...
       : ((((__COMP_INSTANCE__) == COMP1) || ((__COMP_INSTANCE__) == COMP2))               \
              ...
              : (((__COMP_INSTANCE__) == COMP3)                                            \
                     ? (((__OUTPUT_BLANKING_SOURCE__) ==                                   \
                         LL_COMP_BLANKINGSRC_TIM2_OC4_COMP3_6))                            \
                     : (((__COMP_INSTANCE__) == COMP4)                                     \
                            ? (((__OUTPUT_BLANKING_SOURCE__) ==                            \
                                LL_COMP_BLANKINGSRC_TIM8_OC5_COMP4_5_6_7) ||               \
                               ((__OUTPUT_BLANKING_SOURCE__) ==                            \
                                LL_COMP_BLANKINGSRC_TIM3_OC4_COMP4) ||                     \
                               ((__OUTPUT_BLANKING_SOURCE__) ==                            \
                                LL_COMP_BLANKINGSRC_TIM15_OC1_COMP4))                      \
                                   ...
                                   : (((__COMP_INSTANCE__) == COMP6)                       \
                                          ? (((__OUTPUT_BLANKING_SOURCE__) ==              \
                                             ...
                                             ((__OUTPUT_BLANKING_SOURCE__) ==              \
                                              LL_COMP_BLANKINGSRC_TIM2_OC4_COMP3_6) ||     \
                                             ((__OUTPUT_BLANKING_SOURCE__) ==              \
                                              LL_COMP_BLANKINGSRC_TIM15_OC2_COMP6_7))      \
                                          : (((__OUTPUT_BLANKING_SOURCE__) ==              \
                                              LL_COMP_BLANKINGSRC_TIM8_OC5_COMP4_5_6_7) || \
                                             ((__OUTPUT_BLANKING_SOURCE__) ==              \
                                              LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1_2_7) ||   \
...
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx,
  ...
  assert_param(
      IS_LL_COMP_OUTPUT_SELECTION(COMPx, COMP_InitStruct->OutputSelection));
...
ErrorStatus LL_COMP_DeInit(COMP_TypeDef *COMPx) {
  ...
  if (LL_COMP_IsLocked(COMPx) == 0U) {
    ...
    if (COMPx == COMP1) {
      CLEAR_BIT(COMP->CSR,
                (COMP_CSR_COMP1MODE | COMP_CSR_COMP1INSEL | COMP_CSR_COMP1SW1 |
                 COMP_CSR_COMP1OUTSEL | COMP_CSR_COMP1HYST | COMP_CSR_COMP1POL |
                 COMP_CSR_COMP1EN)
                    << __COMP_BITOFFSET_INSTANCE(COMPx));
    } else {
      CLEAR_BIT(COMP->CSR, (COMP_CSR_COMP1MODE | COMP_CSR_COMP1INSEL |
                            COMP_CSR_COMP1OUTSEL | COMP_CSR_COMP1HYST |
                            COMP_CSR_COMP1POL | COMP_CSR_COMP1EN)
                               << __COMP_BITOFFSET_INSTANCE(COMPx));
    }
    ...
    if (COMPx == COMP1) {
      MODIFY_REG(
          ...
          (COMP_InitStruct->PowerMode | COMP_InitStruct->InputPlus |
           ...
           COMP_InitStruct->OutputSelection | COMP_InitStruct->OutputPolarity)
              << __COMP_BITOFFSET_INSTANCE(COMPx));
    } else {
      MODIFY_REG(
          COMP->CSR,
          (COMP_CSR_COMP1MODE | COMP_CSR_COMP1INSEL | COMP_CSR_COMP1OUTSEL |
           COMP_CSR_COMP1HYST | COMP_CSR_COMP1POL)
              << __COMP_BITOFFSET_INSTANCE(COMPx),
          (COMP_InitStruct->PowerMode | COMP_InitStruct->InputPlus |
           COMP_InitStruct->InputMinus | COMP_InitStruct->InputHysteresis |
           COMP_InitStruct->OutputSelection | COMP_InitStruct->OutputPolarity)
